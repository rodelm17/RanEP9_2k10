...
BOOL CPageEdit1::DataShow ()
{
	...
	SetWin_Combo_Sel( this, IDC_COMBO_VIP_LEVEL, COMMENT::CHAR_VIP[m_pDummySkill->m_sLEARN.emVIPLevel].c_str() );

	SetWin_Num_int( this, IDC_EDIT_REQSKILL_REBORN, m_pDummySkill->m_sLEARN.dwRebornReq );

	SetWin_Check( this, IDC_CHECK_HIDDEN_WEAP, m_pDummySkill->m_sLEARN.bHiddenWeapon );
	SetWin_Num_int( this, IDC_EDIT_HIDDEN_WEAP_MID, m_pDummySkill->m_sLEARN.sHiddenWeapon.wMainID );
	SetWin_Num_int( this, IDC_EDIT_HIDDEN_WEAP_SID, m_pDummySkill->m_sLEARN.sHiddenWeapon.wSubID );
	...
	SetWin_Num_int( this, IDC_EDIT_SUB_SKILL_MID, m_pDummySkill->m_sEXT_DATA.idMultiTargetSkill.wMainID );
	SetWin_Num_int( this, IDC_EDIT_SUB_SKILL_SID, m_pDummySkill->m_sEXT_DATA.idMultiTargetSkill.wSubID );
	SetWin_Num_int( this, IDC_EDIT_SUB_SKILL_FRAME, m_pDummySkill->m_sEXT_DATA.nMultiTatgetEffectFrame );

	SetWin_Check ( this, IDC_CHECK_NO_RANGE_CHECK, m_pDummySkill->m_sBASIC.dwSkillFlag&SKILL::SKILL_BASIC_FLAG_NO_RANGE_CHECK );
	SetWin_Check ( this, IDC_CHECK_RUNNING_CAST, m_pDummySkill->m_sBASIC.dwSkillFlag&SKILL::SKILL_BASIC_SB_RUNNING_CAST );
	...
	//unknown data
	SetWin_Num_int( this, IDC_EDIT_EX_DATA_1, m_pDummySkill->m_sBASIC.unknown_var_3 );
	SetWin_Num_int( this, IDC_EDIT_EX_DATA_2, m_pDummySkill->m_sAPPLY.dwUnknownData );
	SetWin_Num_int( this, IDC_EDIT_EX_DATA_3, m_pDummySkill->m_sBASIC.unknown_var_1 );
	SetWin_Num_int( this, IDC_EDIT_EX_DATA_4, m_pDummySkill->m_sBASIC.unknown_var_2 );

	SetWin_Num_int( this, IDC_EDIT_EXT_DATA_UNKNOWN_VAR_0, m_pDummySkill->m_sEXT_DATA.unknown_var0 );
	SetWin_Num_int( this, IDC_EDIT_EXT_DATA_UNKNOWN_VAR_1, m_pDummySkill->m_sEXT_DATA.unknown_var1 );

	SetWin_Num_int( this, IDC_EDIT_LEARN_UNKNOWN_VAR_0, m_pDummySkill->m_sLEARN.unknown_var_0 );
	SetWin_Num_int( this, IDC_EDIT_LEARN_UNKNOWN_VAR_1_MID, m_pDummySkill->m_sLEARN.unknown_var_1.wSubID );
	SetWin_Num_int( this, IDC_EDIT_LEARN_UNKNOWN_VAR_1_SID, m_pDummySkill->m_sLEARN.unknown_var_1.wSubID );
	SetWin_Num_int( this, IDC_EDIT_LEARN_UNKNOWN_VAR_2, m_pDummySkill->m_sLEARN.unknown_var_2 );
...
BOOL CPageEdit1::DataSave ()
{
	...
	m_pDummySkill->m_sLEARN.emVIPLevel = static_cast<EMVIP_LEVEL> ( GetWin_Combo_Sel( this, IDC_COMBO_VIP_LEVEL ) );

	m_pDummySkill->m_sLEARN.dwRebornReq = GetWin_Num_int( this, IDC_EDIT_REQSKILL_REBORN );


	m_pDummySkill->m_sLEARN.bHiddenWeapon = ( GetWin_Check( this, IDC_CHECK_HIDDEN_WEAP ) == TRUE );
	m_pDummySkill->m_sLEARN.sHiddenWeapon.wMainID = GetWin_Num_int( this, IDC_EDIT_HIDDEN_WEAP_MID );
	m_pDummySkill->m_sLEARN.sHiddenWeapon.wSubID = GetWin_Num_int( this, IDC_EDIT_HIDDEN_WEAP_SID );
	...
	/*multi skill Juver, 2018/09/04 */
	m_pDummySkill->m_sEXT_DATA.idMultiTargetSkill.wMainID = GetWin_Num_int( this, IDC_EDIT_SUB_SKILL_MID );
	m_pDummySkill->m_sEXT_DATA.idMultiTargetSkill.wSubID = GetWin_Num_int( this, IDC_EDIT_SUB_SKILL_SID );
	m_pDummySkill->m_sEXT_DATA.nMultiTatgetEffectFrame = GetWin_Num_int( this, IDC_EDIT_SUB_SKILL_FRAME );

	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_NO_RANGE_CHECK ),m_pDummySkill->m_sBASIC.dwSkillFlag, SKILL::SKILL_BASIC_FLAG_NO_RANGE_CHECK );
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_RUNNING_CAST ),m_pDummySkill->m_sBASIC.dwSkillFlag, SKILL::SKILL_BASIC_SB_RUNNING_CAST );
	...
	//unknown data
	m_pDummySkill->m_sBASIC.unknown_var_3 = GetWin_Num_int( this, IDC_EDIT_EX_DATA_1 );
	m_pDummySkill->m_sAPPLY.dwUnknownData = GetWin_Num_int( this, IDC_EDIT_EX_DATA_2 );
	m_pDummySkill->m_sBASIC.unknown_var_1 = GetWin_Num_int( this, IDC_EDIT_EX_DATA_3 )? true:false;
	m_pDummySkill->m_sBASIC.unknown_var_2 = GetWin_Num_int( this, IDC_EDIT_EX_DATA_4 )? true:false;
	
	m_pDummySkill->m_sEXT_DATA.unknown_var0 = GetWin_Num_int( this, IDC_EDIT_EXT_DATA_UNKNOWN_VAR_0 );
	m_pDummySkill->m_sEXT_DATA.unknown_var1 = GetWin_Num_int( this, IDC_EDIT_EXT_DATA_UNKNOWN_VAR_1 );

	m_pDummySkill->m_sLEARN.unknown_var_0 = GetWin_Num_int( this, IDC_EDIT_LEARN_UNKNOWN_VAR_0 );
	m_pDummySkill->m_sLEARN.unknown_var_1.wSubID = GetWin_Num_int( this, IDC_EDIT_LEARN_UNKNOWN_VAR_1_MID );
	m_pDummySkill->m_sLEARN.unknown_var_1.wSubID = GetWin_Num_int( this, IDC_EDIT_LEARN_UNKNOWN_VAR_1_SID );
	m_pDummySkill->m_sLEARN.unknown_var_2 = GetWin_Num_int( this, IDC_EDIT_LEARN_UNKNOWN_VAR_2 );
