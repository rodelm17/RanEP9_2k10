...
char		DxEffCharBonePosEff::NAME[MAX_PATH]	= "DxEffCharBonePosEff"; 
...
void DxEffCharBonePosEff::ResetLocalPos()
{
	m_vLocalPos.x = 0.0f;
	m_vLocalPos.y = 0.0f;
	m_vLocalPos.z = 0.0f;
...
HRESULT	DxEffCharBonePosEff::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharBonePosEff::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT	DxEffCharBonePosEff::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharBonePosEff::R2LoadFile", SFile.GetFileName(), dwVer );
