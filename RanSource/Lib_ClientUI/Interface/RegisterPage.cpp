...
CRegisterPage::CRegisterPage ()
	...
	, m_pLineBoxReferral(NULL)
	, m_pStaticRefferal(NULL)
	, m_pTextReferral(NULL)
{
...
void CRegisterPage::CreateSubControl ()
{
	...
	pBasicLineBox = new CBasicLineBox;
	pBasicLineBox->CreateSub ( this, "BASIC_LINE_BOX_QUEST_LIST", UI_FLAG_XSIZE | UI_FLAG_YSIZE );
	pBasicLineBox->CreateBaseBoxQuestList ( "RAN_REGISTER_PAGE_LINE_FULLNAME" );
	RegisterControl ( pBasicLineBox );
	...
	m_pLineBoxReferral = new CBasicLineBox;
	m_pLineBoxReferral->CreateSub ( this, "BASIC_LINE_BOX_QUEST_LIST", UI_FLAG_XSIZE | UI_FLAG_YSIZE );
	m_pLineBoxReferral->CreateBaseBoxQuestList ( "RAN_REGISTER_PAGE_LINE_REFERRAL" );
	RegisterControl ( m_pLineBoxReferral );
	m_pLineBoxReferral->SetVisibleSingle( RPARAM::emRegisterReferral != EMREFERRAL_REGISTER_TYPE_NONE );
	...
	pStaticText = new CBasicTextBox;
	pStaticText->CreateSub ( this, "RAN_REGISTER_PAGE_STATIC_FULLNAME" );
	pStaticText->SetFont ( pFont9 );
	pStaticText->SetTextAlign ( TEXT_ALIGN_LEFT );	
	pStaticText->AddText( ID2GAMEWORD ( "RAN_REGISTER_WINDOW", 15 ), NS_UITEXTCOLOR::WHITE );
	RegisterControl ( pStaticText );
	...
	m_pStaticRefferal = new CBasicTextBox;
	m_pStaticRefferal->CreateSub ( this, "RAN_REGISTER_PAGE_STATIC_REFERRAL" );
	m_pStaticRefferal->SetFont ( pFont9 );
	m_pStaticRefferal->SetTextAlign ( TEXT_ALIGN_LEFT );	

	if ( RPARAM::emRegisterReferral == EMREFERRAL_REGISTER_TYPE_OPTIONAL )
		m_pStaticRefferal->AddText( ID2GAMEWORD ( "RAN_REGISTER_WINDOW", 17 ), NS_UITEXTCOLOR::WHITE );
	else
		m_pStaticRefferal->AddText( ID2GAMEWORD ( "RAN_REGISTER_WINDOW", 16 ), NS_UITEXTCOLOR::WHITE );

	RegisterControl ( m_pStaticRefferal );
	m_pStaticRefferal->SetVisibleSingle( RPARAM::emRegisterReferral != EMREFERRAL_REGISTER_TYPE_NONE );
	...
	m_pEditBoxMan->CreateEditBox ( LOBBY_REGISTER_EDIT_USER, "RAN_REGISTER_PAGE_TEXT_USER", "RAN_REGISTER_PAGE_CARRAT", TRUE, UINT_MAX, pFont9, RPARAM::register_user_max );
	m_pEditBoxMan->CreateEditBox ( LOBBY_REGISTER_EDIT_PASS, "RAN_REGISTER_PAGE_TEXT_PASSWORD", "RAN_REGISTER_PAGE_CARRAT", TRUE, UINT_MAX, pFont9, RPARAM::register_pass_max );
	m_pEditBoxMan->CreateEditBox ( LOBBY_REGISTER_EDIT_PASS2, "RAN_REGISTER_PAGE_TEXT_PASSWORD2", "RAN_REGISTER_PAGE_CARRAT", TRUE, UINT_MAX, pFont9, RPARAM::register_pass_max );
	m_pEditBoxMan->CreateEditBox ( LOBBY_REGISTER_EDIT_PIN, "RAN_REGISTER_PAGE_TEXT_PIN", "RAN_REGISTER_PAGE_CARRAT", TRUE, UINT_MAX, pFont9, RPARAM::register_pass2_max );
	m_pEditBoxMan->CreateEditBox ( LOBBY_REGISTER_EDIT_PIN2, "RAN_REGISTER_PAGE_TEXT_PIN2", "RAN_REGISTER_PAGE_CARRAT", TRUE, UINT_MAX, pFont9, RPARAM::register_pass2_max );
	m_pEditBoxMan->CreateEditBox ( LOBBY_REGISTER_EDIT_MAIL, "RAN_REGISTER_PAGE_TEXT_MAIL", "RAN_REGISTER_PAGE_CARRAT", TRUE, UINT_MAX, pFont9, RPARAM::register_mail_max );
	m_pEditBoxMan->CreateEditBox ( LOBBY_REGISTER_EDIT_FULLNAME, "RAN_REGISTER_PAGE_TEXT_FULLNAME", "RAN_REGISTER_PAGE_CARRAT", TRUE, UINT_MAX, pFont9, RPARAM::register_fullname_max );
	m_pEditBoxMan->CreateEditBox ( LOBBY_REGISTER_EDIT_SA, "RAN_REGISTER_PAGE_TEXT_SA", "RAN_REGISTER_PAGE_CARRAT", TRUE, UINT_MAX, pFont9, RPARAM::register_sa_max );
	m_pEditBoxMan->CreateEditBox ( LOBBY_REGISTER_EDIT_SA2, "RAN_REGISTER_PAGE_TEXT_SA2", "RAN_REGISTER_PAGE_CARRAT", TRUE, UINT_MAX, pFont9, RPARAM::register_sa_max );
	m_pEditBoxMan->CreateEditBox ( LOBBY_REGISTER_EDIT_CAPTCHA, "RAN_REGISTER_PAGE_TEXT_CAPTCHA", "RAN_REGISTER_PAGE_CARRAT", TRUE, UINT_MAX, pFont9, RPARAM::register_captcha_max );
	m_pEditBoxMan->CreateEditBox ( LOBBY_REGISTER_EDIT_REFERRAL, "RAN_REGISTER_PAGE_TEXT_REFERRAL", "RAN_REGISTER_PAGE_CARRAT", TRUE, UINT_MAX, pFont9, RPARAM::register_user_max );
	...
	m_pEditBoxMan->SetVisibleEdit( LOBBY_REGISTER_EDIT_REFERRAL, RPARAM::emRegisterReferral != EMREFERRAL_REGISTER_TYPE_NONE );
...
void CRegisterPage::ResetAll ()
{
	...
	m_pEditBoxMan->ClearEdit ( LOBBY_REGISTER_EDIT_FULLNAME );
	...
	m_pEditBoxMan->ClearEdit ( LOBBY_REGISTER_EDIT_REFERRAL );
...
void CRegisterPage::DoRegister()
{
	...
	std::string strfullname = m_pEditBoxMan->GetEditString( LOBBY_REGISTER_EDIT_FULLNAME );
	...
	if ( struser.size() < RPARAM::register_user_min || struser.size() > RPARAM::register_user_max )
	{
		CString text = _HLIB::cstringformat( ID2GAMEINTEXT( "RAN_REGISTER_FB_USER_SIZE" ), RPARAM::register_user_min, RPARAM::register_user_max );
		m_pTextStatus->SetText( text.GetString(), NS_UITEXTCOLOR::RED );
		return;
	}
	...
	if ( strpass.size() < RPARAM::register_pass_min || strpass.size() > RPARAM::register_pass_max )
	{
		CString text = _HLIB::cstringformat( ID2GAMEINTEXT( "RAN_REGISTER_FB_PASS_SIZE" ), RPARAM::register_pass_min, RPARAM::register_pass_max );
		m_pTextStatus->SetText( text.GetString(), NS_UITEXTCOLOR::RED );
		return;
	}
	...
	if ( strpin.size() < RPARAM::register_pass2_min || strpin.size() > RPARAM::register_pass2_max )
	{
		CString text = _HLIB::cstringformat( ID2GAMEINTEXT( "RAN_REGISTER_FB_PASS2_SIZE" ), RPARAM::register_pass2_min, RPARAM::register_pass2_max );
		m_pTextStatus->SetText( text.GetString(), NS_UITEXTCOLOR::RED );
		return;
	}
	...
	if ( strmail.size() < RPARAM::register_mail_min || strmail.size() > RPARAM::register_mail_max )
	{
		CString text = _HLIB::cstringformat( ID2GAMEINTEXT( "RAN_REGISTER_FB_MAIL_SIZE" ), RPARAM::register_mail_min, RPARAM::register_mail_max );
		m_pTextStatus->SetText( text.GetString(), NS_UITEXTCOLOR::RED );
		return;
	}
	...
	{
		m_pTextStatus->SetText( ID2GAMEINTEXT( "RAN_REGISTER_FB_FULLNAME_EMPTY" ), NS_UITEXTCOLOR::RED );
		return;
	}

	if ( strfullname.size() < RPARAM::register_fullname_min || strfullname.size() > RPARAM::register_fullname_max )
	{
		CString text = _HLIB::cstringformat( ID2GAMEINTEXT( "RAN_REGISTER_FB_FULLNAME_SIZE" ), RPARAM::register_fullname_min, RPARAM::register_fullname_max );
		m_pTextStatus->SetText( text.GetString(), NS_UITEXTCOLOR::RED );
		return;
	}
	...
	if ( strsa.size() < RPARAM::register_sa_min || strsa.size() > RPARAM::register_sa_max )
	{
		CString text = _HLIB::cstringformat( ID2GAMEINTEXT( "RAN_REGISTER_FB_SA_SIZE" ), RPARAM::register_sa_min, RPARAM::register_sa_max );
		m_pTextStatus->SetText( text.GetString(), NS_UITEXTCOLOR::RED );
		return;
	}
	...
	if ( strcaptcha.size() < RPARAM::register_captcha_min || strcaptcha.size() > RPARAM::register_captcha_max )
	{
		CString text = _HLIB::cstringformat( ID2GAMEINTEXT( "RAN_REGISTER_FB_CAPTCHA_SIZE" ), RPARAM::register_captcha_min, RPARAM::register_captcha_max );
		m_pTextStatus->SetText( text.GetString(), NS_UITEXTCOLOR::RED );
		return;
	}
	...
	if ( struser.find_first_not_of( "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789" ) != std::string::npos )
	{
		m_pTextStatus->SetText( ID2GAMEINTEXT( "RAN_REGISTER_FB_USER_STRING" ), NS_UITEXTCOLOR::RED );
		return ;
	}
	...
	if ( !CheckString_Special3 ( strfullname.c_str() ) )
	{
		m_pTextStatus->SetText( ID2GAMEINTEXT( "RAN_REGISTER_FB_FULLNAME_STRING" ), NS_UITEXTCOLOR::RED );
		return ;
	}

	if ( RPARAM::emRegisterReferral != EMREFERRAL_REGISTER_TYPE_NONE )
	{
		std::string strReferral = m_pEditBoxMan->GetEditString( LOBBY_REGISTER_EDIT_REFERRAL );

		//referral is required
		//check if empty
		if ( RPARAM::emRegisterReferral == EMREFERRAL_REGISTER_TYPE_REQUIRED )
		{
			if ( strReferral.empty() )
			{
				m_pTextStatus->SetText( ID2GAMEINTEXT( "RAN_REGISTER_FB_REFERRAL_EMPTY" ), NS_UITEXTCOLOR::RED );
				return;
			}
		}

		//if not empty then check for string validity
		if ( strReferral.empty() == false )
		{
			if ( strReferral.find_first_not_of( "0123456789" ) != std::string::npos )
			{
				m_pTextStatus->SetText( ID2GAMEINTEXT( "RAN_REGISTER_FB_REFERRAL_STRING" ), NS_UITEXTCOLOR::RED );
				return;
			}
		}
	}
	...
	if ( pNetClient && pNetClient->IsOnline() )
	{
		...
		std::string strreg_fullname = m_pEditBoxMan->GetEditString( LOBBY_REGISTER_EDIT_FULLNAME );
		std::string strreg_sa = m_pEditBoxMan->GetEditString( LOBBY_REGISTER_EDIT_SA );

		DWORD dwReferralUserNum = 0;
		if ( RPARAM::emRegisterReferral != EMREFERRAL_REGISTER_TYPE_NONE )
		{
			std::string strRegReferral = m_pEditBoxMan->GetEditString( LOBBY_REGISTER_EDIT_REFERRAL );

			if ( strRegReferral.empty() == false )
				dwReferralUserNum = boost::lexical_cast<DWORD>(strRegReferral);
		}
		...
		std::transform ( strreg_fullname.begin(), strreg_fullname.end(), strreg_fullname.begin(), tolower );

		int nServerGroup, nServerChannel;
		COuterInterface::GetInstance().GetConnectServerInfo( nServerGroup, nServerChannel );

		pNetClient->RegisterAction( 
			strreg_user.c_str(), 
			strreg_pass.c_str(), 
			strreg_pass2.c_str(),
			strreg_mail.c_str(), 
			strreg_fullname.c_str(), 
			strreg_sa.c_str(), 
			dwReferralUserNum, 
			nServerChannel );
	}
...
BOOL CRegisterPage::CheckString_Special3( CString strTemp )
{	
	strTemp = strTemp.Trim();
	if( STRUTIL::CheckString_Special3( strTemp ) )	return FALSE;
	return TRUE;
}
