...
void GLAnySummon::MsgSkillFact( NET_MSG_GENERIC* nmg )
{
	...
	GLOGICEX::VARIATION ( m_dwNowHP, m_pSummonCrowData->m_sBasic.m_dwHP, pNetMsg->nVAR_HP );
	GLOGICEX::VARIATION ( m_wNowMP, m_pSummonCrowData->m_sBasic.m_wMP, pNetMsg->nVAR_MP );
	GLOGICEX::VARIATION ( m_wNowSP, m_pSummonCrowData->m_sBasic.m_wSP, pNetMsg->nVAR_SP );
