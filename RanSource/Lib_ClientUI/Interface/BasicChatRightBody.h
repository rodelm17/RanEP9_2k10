...
#include "./BasicTextBox.h"/* Chat Color, Mhundz 02/22/25 */
...
private:
	...
	void	AddStringToNORMAL ( CBasicTextBox::STEXTCHAT strTemp, D3DCOLOR dwColor, SITEMLINK* pItemLink );
	void	AddStringToNORMAL ( CString strTemp, D3DCOLOR dwColor,bool bBool = false , SITEMLINK* pItemLink = NULL );
...
public:
	...
	/*item link, Juver, 2017/07/31 */
	/* Chat Color, Mhundz 02/22/25 */
	void	AddStringToChatEx ( CString strTemp, WORD wType, SITEMLINK* pItemLink, bool bStaff = false );
...
private:
	...
	/*item link, Juver, 2017/07/31 */
	/* Chat Color, Mhundz 02/22/25 */
	void	ADD_CHAT_PAGE_TEXTBOX ( CBasicTextBox::STEXTCHAT& strTemp, const D3DCOLOR& dwColor, CBasicTextBoxEx* pTextBox, CBasicScrollBarEx* pScrollBar, 
		SITEMLINK* pItemLink  ); 
...
public:
	...
	void	CheckShowMaxRVItemLink( CString strText, SITEMLINK sItemLink );
