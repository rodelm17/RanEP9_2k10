...
HRESULT	DxEffCharTexDiff::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharTexDiff::R2LoadFile", SFile.GetFileName(), dwVer );
