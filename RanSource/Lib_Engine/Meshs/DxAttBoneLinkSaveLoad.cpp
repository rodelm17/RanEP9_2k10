...
BOOL DxAttBoneLink::SaveFile ( const char* szFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	SFile.SetEncodeType( EMRCRYPT_BYTE_TYPE_2021_ATT_BONE_LINK_V1 );
...
BOOL DxAttBoneLink::LOAD_Ver_0203( basestream &SFile )
{
	DWORD dwData(0);
...
BOOL DxAttBoneLink::LOAD_Ver_0202( basestream &SFile )
{
	DWORD dwData(0);
	SFile >> dwData;	m_emPieceStrike = (EMPIECECHAR) dwData;
	SFile >> dwData;	m_emPieceType = (EMPIECECHAR) dwData;
...
{
	DWORD dwData(0);
	SFile >> dwData;	m_emPieceStrike = PIECE_0201_TO_PIECE( (EMPIECECHAR_0201)dwData );
	SFile >> dwData;	m_emPieceType = PIECE_0201_TO_PIECE( (EMPIECECHAR_0201)dwData );
	SFile >> dwData;	m_emWeaponWhereBack = (EMPEACEZONEWEAPON) dwData;
...
BOOL DxAttBoneLink::LoadFile ( const char* szFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread )
{
	...
	if ( dwVer >= ENCODE_VER_BYTE_CRYPT_2021_ATT_LINK_V1 )
		SFile.SetEncodeType( EMRCRYPT_BYTE_TYPE_2021_ATT_BONE_LINK_V1 );
