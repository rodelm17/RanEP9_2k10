...
class GLCrow : public GLCROWLOGIC_SERVER, public GLACTOR
{
public:
	enum EMCONTROL
	{
...
public:
	...
	void	TyrannyDamageUpdate();
	/*woe Arc Development 08-06-2024*/
	void WoeResetTower();
	void WoeDamageCheck(WORD wClubID);
...
public:
	...
	virtual DWORD GetBonusExp () const				{ return DWORD(m_pCrowData->m_sBasic.m_dwBonusExp*GLCONST_CHAR::GETEXP_SCALE()); };
