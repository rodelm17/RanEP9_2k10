...
class CModernDialogueWindow : public CUIWindowEx
{
private:
...
public:
	CModernDialogueWindow ();
	virtual	~CModernDialogueWindow ();
...
public:
	BOOL	SetDialogueData ( STARGETID sCrowID, GLCHARLOGIC_CLIENT *pCHAR );
