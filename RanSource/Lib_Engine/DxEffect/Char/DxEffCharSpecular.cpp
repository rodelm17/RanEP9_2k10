...
char		DxEffCharSpecular::NAME[MAX_PATH]	= "DxEffCharSpecular";
...
HRESULT	DxEffCharSpecular::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharSpecular::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT	DxEffCharSpecular::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharSpecular::R2LoadFile", SFile.GetFileName(), dwVer );
