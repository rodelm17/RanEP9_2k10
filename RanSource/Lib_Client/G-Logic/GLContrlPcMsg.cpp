...
GLCHARAG_DATA& GLCHARAG_DATA::operator= ( const GLCHARAG_DATA &cData )
{
	...
	m_bUserFlagVerified = cData.m_bUserFlagVerified;	

	/* user flag restricted, Juver, 2020/04/20 */
	m_bUserFlagRestricted = cData.m_bUserFlagRestricted;

	/* HWID watchlist, Juver, 2020/05/05 */
	m_bUserFlagHWIDWatchlist = cData.m_bUserFlagHWIDWatchlist;
	...
	m_mapAwardTitle			= cData.m_mapAwardTitle;
