/*!
 * \file ItemRandomOptionRebuildInventoryPage.h
 *
 * \author Juver
 * \date July 2018
 *
...
class CItemRandomOptionRebuildInventoryPage : public CUIGroup	
{
private:
...
public:
	CItemRandomOptionRebuildInventoryPage();
	virtual	~CItemRandomOptionRebuildInventoryPage();
