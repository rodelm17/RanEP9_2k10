...
char		DxEffCharBlur::NAME[MAX_PATH]	= "DxEffCharBlur";
...
HRESULT	DxEffCharBlur::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	else if ( dwVer == 0x105 )
	{
		//	Note : 이팩트의 Property 를 저장.
		//
		EFFCHAR_PROPERTY_BLUR_105	sProperty;
		SFile.ReadBuffer ( &sProperty, sizeof(EFFCHAR_PROPERTY_BLUR_105) );

		m_Property.m_dwFlag			= sProperty.m_dwFlag;
		m_Property.m_nBlend			= sProperty.m_nBlend;
		m_Property.m_fFullLifeTemp	= sProperty.m_fFullLifeTemp;
		m_Property.m_vColorUPTemp	= sProperty.m_vColorUPTemp;
		m_Property.m_vColorDOWNTemp	= sProperty.m_vColorDOWNTemp;
		m_Property.m_SetAniMType	= sProperty.m_SetAniMType;
		m_Property.m_SetAniSType	= sProperty.m_SetAniSType;
		
		StringCchCopy( m_Property.m_szTexture, TEXTURE_LENGTH, sProperty.m_szTexture ); 
		StringCchCopy( m_Property.m_szTraceUP, STRACE_NSIZE, sProperty.m_szTraceUP);
		StringCchCopy( m_Property.m_szTraceDOWN, STRACE_NSIZE, sProperty.m_szTraceDOWN);
	...
	else if ( dwVer == 0x104 )
	{
		//	Note : 이팩트의 Property 를 저장.
		//
		EFFCHAR_PROPERTY_BLUR_104	sProperty;
		SFile.ReadBuffer ( &sProperty, sizeof(EFFCHAR_PROPERTY_BLUR_104) );
	...
	else if ( dwVer == 0x103 )
	{
		//	Note : 이팩트의 Property 를 저장.
		//
		EFFCHAR_PROPERTY_BLUR_103	sProperty;
		SFile.ReadBuffer ( &sProperty, sizeof(EFFCHAR_PROPERTY_BLUR_103) );
	...
	else if ( dwVer == 0x102 )
	{
		//	Note : 이팩트의 Property 를 저장.
		//
		EFFCHAR_PROPERTY_BLUR_102	sProperty;
		SFile.ReadBuffer ( &sProperty, sizeof(EFFCHAR_PROPERTY_BLUR_102) );
		...
		StringCchCopy( m_Property.m_szTraceUP, STRACE_NSIZE, szIMAGE[sProperty.m_dwTraceIndexUP]);
		StringCchCopy( m_Property.m_szTraceDOWN, STRACE_NSIZE, szIMAGE[sProperty.m_dwTraceIndexDOWN]);
		StringCchCopy( m_Property.m_szTexture, TEXTURE_LENGTH, sProperty.m_szTexture ); 
	...
	else if ( dwVer == 0x101 )
	{
		//	Note : 이팩트의 Property 를 저장.
		//
		EFFCHAR_PROPERTY_BLUR_101	sProperty;
		SFile.ReadBuffer ( &sProperty, sizeof(EFFCHAR_PROPERTY_BLUR_101) );
	...
	else if ( dwVer == 0x100 )
	{
		//	Note : 이팩트의 Property 를 저장.
		//
		EFFCHAR_PROPERTY_BLUR_100	sProperty;
		SFile.ReadBuffer ( &sProperty, sizeof(EFFCHAR_PROPERTY_BLUR_100) );
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharBlur::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT	DxEffCharBlur::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;		
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharBlur::R2LoadFile", SFile.GetFileName(), dwVer );
