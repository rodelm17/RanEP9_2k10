/*!
 * \file EP7ExchangeItemInventoryPage.h
 *
 * \author Juver
 * \date 2022/04/28
 *
...
#ifndef EP7EXCHANGEITEMINVENTORYPAGE_H_INCLUDED__
#define EP7EXCHANGEITEMINVENTORYPAGE_H_INCLUDED__
...
class CEP7ExchangeItenInventoryPage : public CUIGroup	
{
private:
...
public:
	CEP7ExchangeItenInventoryPage();
	virtual	~CEP7ExchangeItenInventoryPage();
...
#endif // EP7EXCHANGEITEMINVENTORYPAGE_H_INCLUDED__
