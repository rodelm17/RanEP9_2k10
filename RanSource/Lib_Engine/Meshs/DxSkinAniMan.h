...
namespace COMMENT
{
	extern std::string ANI_MAINTYPE_CHAR[AN_TYPE_SIZE];
	extern std::string ANI_MAINTYPE_ABL[AN_TYPE_SIZE];
	extern std::string ANI_MAINTYPE_VEHICLE[AN_TYPE_SIZE];

	extern std::string ANI_SUBTYPE_WEAPON[AN_SUB_00_SIZE];
	extern std::string ANI_SUBTYPE_SKILL[AN_SUB_00_SIZE];
	extern std::string ANI_SUBTYPE_VEHICLE[AN_SUB_00_SIZE];
