...
private:
	enum
	{
		...
		CLUB_CALL_BUTTON,		/*ecall function Arc Development 08-16-2024*/
	};
...
protected:
	...
	GLCLUBMEMBER m_sClubMember;	/*ecall function Arc Development 08-16-2024*/
...
private:
	...
	CBasicTextButton* m_pCallButton;	/*ecall function Arc Development 08-16-2024*/
...
private:
	...
	DWORD dwLastCallTime;    // Tracks the last call time
    static const DWORD dwCooldownDuration;
};