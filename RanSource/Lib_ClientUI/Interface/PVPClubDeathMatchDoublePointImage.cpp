...
CPVPClubDeathMatchDoublePointImage::CPVPClubDeathMatchDoublePointImage () :
    m_bPLAY ( false )
{
}
...
void CPVPClubDeathMatchDoublePointImage::CreateSubControl ( CString strKeyword )
{
...
void	CPVPClubDeathMatchDoublePointImage::START()
{
	RESET ();
	m_bPLAY = true;
}

void	CPVPClubDeathMatchDoublePointImage::RESET()
{
	m_fPlayedTime = 0.0f;
...
void CPVPClubDeathMatchDoublePointImage::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
