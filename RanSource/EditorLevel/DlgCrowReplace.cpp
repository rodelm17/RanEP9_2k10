...
void CDlgCrowReplace::OnBnClickedButtonCrowFrom()
{
	...
	if ( dlg.DoModal() == IDOK )
	{
		...
		if( pCROW )
		{
			SetWin_Num_int( this, IDC_EDIT_CROW_MID_FROM, pCROW->m_sBasic.sNativeID.wMainID );
			SetWin_Num_int( this, IDC_EDIT_CROW_SID_FROM, pCROW->m_sBasic.sNativeID.wSubID );
		}
	}
}
...
void CDlgCrowReplace::OnBnClickedButtonCrowTo()
{
	...
	if ( dlg.DoModal() == IDOK )
	{
		...
		if( pCROW )
		{
			SetWin_Num_int( this, IDC_EDIT_CROW_MID_TO, pCROW->m_sBasic.sNativeID.wMainID );
			SetWin_Num_int( this, IDC_EDIT_CROW_SID_TO, pCROW->m_sBasic.sNativeID.wSubID );
		}
	}
}
