...
CPVPTyrannyRankingsDisplayResuSlotSelf::CPVPTyrannyRankingsDisplayResuSlotSelf ()
: m_pTextRank(NULL)
, m_pTextName(NULL)
...
void CPVPTyrannyRankingsDisplayResuSlotSelf::CreateSubControl ()
{
...
void CPVPTyrannyRankingsDisplayResuSlotSelf::ResetData()
{
...
HRESULT CPVPTyrannyRankingsDisplayResuSlotSelf::Render(LPDIRECT3DDEVICEQ pd3dDevice)
{
...
void CPVPTyrannyRankingsDisplayResuSlotSelf::SetData( int nRank, std::string strName, DWORD dwCharID, int nChaClass, WORD wKill, WORD wDeath , WORD wResu, WORD wSchool )
{
	ResetData();
