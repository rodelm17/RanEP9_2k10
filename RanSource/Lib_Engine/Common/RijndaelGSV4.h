...
#ifndef __RIJNDAEL_GSV4_H__
#define __RIJNDAEL_GSV4_H__
...
#define RANSEDIT_VERSION_GS_V4 0x0004

class CRijndaelGSV4 : public IMethod
{
public:
	//Key Lengths
	...
	enum { VERSION = RANSEDIT_VERSION_GS_V4 };
