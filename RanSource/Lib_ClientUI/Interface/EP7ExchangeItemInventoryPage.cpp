...
const INT CEP7ExchangeItenInventoryPage::nSTARTLINE = 0;	
const INT CEP7ExchangeItenInventoryPage::nOUTOFRANGE = -1;

CEP7ExchangeItenInventoryPage::CEP7ExchangeItenInventoryPage()
...
void CEP7ExchangeItenInventoryPage::CreateSubControl()
{
	CString strSlotKeyword[ nMAX_ONE_VIEW_SLOT ] =
	{
		"EP7_EXCHANGE_ITEM_INVENTORYSLOT_ITEM_SLOT0",
		"EP7_EXCHANGE_ITEM_INVENTORYSLOT_ITEM_SLOT1",
		"EP7_EXCHANGE_ITEM_INVENTORYSLOT_ITEM_SLOT2",
		"EP7_EXCHANGE_ITEM_INVENTORYSLOT_ITEM_SLOT3",
		"EP7_EXCHANGE_ITEM_INVENTORYSLOT_ITEM_SLOT4",
		"EP7_EXCHANGE_ITEM_INVENTORYSLOT_ITEM_SLOT5",
		"EP7_EXCHANGE_ITEM_INVENTORYSLOT_ITEM_SLOT6",
		"EP7_EXCHANGE_ITEM_INVENTORYSLOT_ITEM_SLOT7",
		"EP7_EXCHANGE_ITEM_INVENTORYSLOT_ITEM_SLOT8",
		"EP7_EXCHANGE_ITEM_INVENTORYSLOT_ITEM_SLOT9",
...
CItemSlotEx* CEP7ExchangeItenInventoryPage::CreateItemSlot( CString strKeyword, UIGUID ControlID )
{
...
CUIControl*	CEP7ExchangeItenInventoryPage::CreateControl( const TCHAR* szControl )
{
...
void CEP7ExchangeItenInventoryPage::Update( INT x, INT y, BYTE LB, BYTE MB, BYTE RB, INT nScroll, FLOAT fElapsedTime, BOOL bFirstControl )
{
...
void CEP7ExchangeItenInventoryPage::TranslateUIMessage( UIGUID ControlID, DWORD dwMsg )
{
...
void CEP7ExchangeItenInventoryPage::ResetItemSlotRender ( int nStart, int nEnd )
{
	if ( nEnd < 0 )			return;
...
void CEP7ExchangeItenInventoryPage::SetItemSlotRender ( int nStart, int nEnd )
{
	if ( nEnd < 0 ) return ;
	if ( nStart > nEnd ) return ;
...
void CEP7ExchangeItenInventoryPage::SetItemIndex( INT nPosX, INT nPosY )
{
	m_nPosX = nPosX;
	m_nPosY = nPosY;
}

void CEP7ExchangeItenInventoryPage::GetItemIndex( INT* pnPosX, INT* pnPosY )
{
	*pnPosX = m_nPosX;
	*pnPosY = m_nPosY;
}

void CEP7ExchangeItenInventoryPage::LoadItemPage( GLInventory &ItemData )
{
...
void CEP7ExchangeItenInventoryPage::LoadItem( SINVENITEM& ref_InvenItem )
{	
...
void CEP7ExchangeItenInventoryPage::UnLoadItemPage()
{
...
void CEP7ExchangeItenInventoryPage::UnLoadItem( INT nPosX, INT nPosY )
{
	m_pItemSlotArray[ nPosY ]->ResetItemImage( nPosX );
}

void CEP7ExchangeItenInventoryPage::ResetAllFlipItem()
{
	for( WORD y=0; y<EM_INVENSIZE_Y; ++y )
		for( WORD x=0; x<EM_INVENSIZE_X; ++x )
...
void CEP7ExchangeItenInventoryPage::UpdateFlipItem( GLInventory& ref_Inventory )
{
	ResetAllFlipItem();
...
void CEP7ExchangeItenInventoryPage::UpdateFlipItem( SINVEN_POS& ref_GarbageItem )
{
...
void CEP7ExchangeItenInventoryPage::UpdateBLOCK()
{
...
SINVENITEM& CEP7ExchangeItenInventoryPage::GetItem( INT nPosX, INT nPosY )
{
	return m_pItemSlotArray[ nPosY ]->GetItemImage( nPosX );
}

void CEP7ExchangeItenInventoryPage::SetOneViewSlot( const INT& nMAX_ONE_VIEW )
{
