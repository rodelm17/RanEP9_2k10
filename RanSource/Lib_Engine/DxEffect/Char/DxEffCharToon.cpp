...
char		DxEffCharToon::NAME[MAX_PATH]	= "DxEffCharToon";
...
HRESULT	DxEffCharToon::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharToon::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT	DxEffCharToon::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharToon::R2LoadFile", SFile.GetFileName(), dwVer );
