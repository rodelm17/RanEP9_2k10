...
namespace STRUTIL
{
	...
	// Example: "have a nice day" or <get out of here>
	void RegisterMatchingDelimiters( char open, char close, bool keep_delimiters = false );
	...
	public:
		...
		typedef std::vector< delimiters_entry > delimiters_t;
