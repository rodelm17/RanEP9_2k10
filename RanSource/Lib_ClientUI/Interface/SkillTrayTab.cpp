...
void CSkillTrayTab::CreateSubControl()
{
	...
	m_pBasicQuickSkillSlot->CreateSub ( this, "BASIC_QUICK_SKILL_SLOT", UI_FLAG_DEFAULT, BASIC_QUICK_SKILL_BASE_SLOT );
	...
	pTextButton->AlignToControl( "QUICK_SKILL_TRAY_TAB_BUTTON" );
	...
	m_pButtonClose->CreateSub( this, "QUICK_SKILL_TRAY_CLOSE_BUTTON", UI_FLAG_DEFAULT, QUICK_SKILL_TRAY_CLOSE_BUTTON );
	m_pButtonClose->CreateFlip( "QUICK_SKILL_TRAY_CLOSE_BUTTON_F", CBasicButton::MOUSEIN_FLIP );
	m_pButtonClose->SetUseGlobalAction ( TRUE );	
	RegisterControl( m_pButtonClose );

	m_pButtonRotate = new CBasicButton;
	m_pButtonRotate->CreateSub( this, "QUICK_SKILL_TRAY_TURN_BUTTON", UI_FLAG_DEFAULT, QUICK_SKILL_TRAY_ROTATE_BUTTON );
	m_pButtonRotate->CreateFlip( "QUICK_SKILL_TRAY_TURN_BUTTON_F", CBasicButton::MOUSEIN_FLIP );
	m_pButtonRotate->SetUseGlobalAction ( TRUE );	
	RegisterControl( m_pButtonRotate );

	m_pButtonLock = new CBasicButton;
	m_pButtonLock->CreateSub( this, "QUICK_SKILL_TRAY_LOCK_BUTTON_OPEN_LOCK", UI_FLAG_DEFAULT, QUICK_SKILL_TRAY_LOCK_BUTTON );
	m_pButtonLock->CreateFlip( "QUICK_SKILL_TRAY_LOCK_BUTTON_OPEN_LOCK_F", CBasicButton::MOUSEIN_FLIP );
	...
	m_pButtonUnlock->CreateSub( this, "QUICK_SKILL_TRAY_LOCK_BUTTON_OPEN_UNLOCK", UI_FLAG_DEFAULT, QUICK_SKILL_TRAY_UNLOCK_BUTTON );
	m_pButtonUnlock->CreateFlip( "QUICK_SKILL_TRAY_LOCK_BUTTON_OPEN_UNLOCK_F", CBasicButton::MOUSEIN_FLIP );
	...
	m_pButtonSetting->CreateSub( this, "QUICK_SKILL_TRAY_SETTING_BUTTON", UI_FLAG_DEFAULT, QUICK_SKILL_TRAY_SETTING_BUTTON );
	m_pButtonSetting->CreateFlip( "QUICK_SKILL_TRAY_SETTING_BUTTON_F", CBasicButton::MOUSEIN_FLIP );
	m_pButtonSetting->SetUseGlobalAction ( TRUE );	
	RegisterControl( m_pButtonSetting );

	CUIControl* pControl = new CUIControl;
	pControl->CreateSub ( this, "QUICK_SKILL_TRAY_GAP_0", UI_FLAG_XSIZE | UI_FLAG_YSIZE  );
	pControl->SetVisibleSingle ( TRUE );
	RegisterControl ( pControl );

	pControl = new CUIControl;
	pControl->CreateSub ( this, "QUICK_SKILL_TRAY_GAP_1", UI_FLAG_XSIZE | UI_FLAG_YSIZE  );
	pControl->SetVisibleSingle ( TRUE );
	RegisterControl ( pControl );
}
