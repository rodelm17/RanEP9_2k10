	...
	case NET_MSG_GCTRL_CAPTURE_THE_FLAG_A2FC_STATE_REGISTER:
		{
			...
			CInnerInterface::GetInstance().PVPCompetitionButtonAlarm( EMCOMPETITION_NOTIFY_TYPE_CAPTURE_THE_FLAG_REGISTER );
	...
	case NET_MSG_GCTRL_CAPTURE_THE_FLAG_A2C_BATTLEINFO_PC:
		{
			...
			m_dwContributionReq = pnetmsg->dwContributionReq;
	...
	case NET_MSG_GCTRL_CAPTURE_THE_FLAG_A2C_REGISTER_FB:
		{
			...
			case CAPTURE_THE_FLAG_REGISTER_FB_DEVICE_INFO_ERROR:
				CInnerInterface::GetInstance().PrintMsgText( NS_UITEXTCOLOR::DISABLE, ID2GAMEINTEXT("CAPTURE_THE_FLAG_REGISTER_FB_DEVICE_INFO_ERROR") );
				break;

				/* PVPCaptureTheFlag hash check, Juver, 2021/07/18 */
			case CAPTURE_THE_FLAG_REGISTER_FB_DEVICE_REGISTERED:
				CInnerInterface::GetInstance().PrintMsgText( NS_UITEXTCOLOR::DISABLE, ID2GAMEINTEXT("CAPTURE_THE_FLAG_REGISTER_FB_DEVICE_REGISTERED") );
				break;
