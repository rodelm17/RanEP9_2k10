...
public:
	...
	/*ABL system, Juver, 2017/06/02 */
	BOOL SetAttBone( DxAttBone *pAttBone, LPDIRECT3DDEVICEQ pd3dDevice, D3DXVECTOR3 *pDir=NULL, float fTarDir=0.0f );
	BOOL SetAttBone( DxAttBoneRender *pAttBone, LPDIRECT3DDEVICEQ pd3dDevice, D3DXVECTOR3 *pDir=NULL, float fTarDir=0.0f );
	BOOL SetAttBoneData ( DxAttBoneData *pAttBoneData, LPDIRECT3DDEVICEQ pd3dDevice );

	/*vehicle system, Juver, 2017/08/06 */
	BOOL SetVehicle( DxVehicle *pVehicle, LPDIRECT3DDEVICEQ pd3dDevice, D3DXVECTOR3 *pDir=NULL, float fTarDir=0.0f );
	BOOL SetVehicleData ( DxVehicleData *pVehicleData, LPDIRECT3DDEVICEQ pd3dDevice );
...
public:
	...
	/*ABL system, Juver, 2017/06/02 */
	BOOL PutEffect ( DxAttBone *pAttBone, const char* szEffFile, D3DXVECTOR3 *pDir, float fTarDir=0.0f );
	BOOL PutPassiveEffect ( DxAttBone *pAttBone, const char* szEffFile, D3DXVECTOR3 *pDir, float fTarDir=0.0f );
	void OutEffect ( DxAttBone *pAttBone, std::string strEffFile );

	BOOL PutEffect ( DxAttBoneRender *pAttBone, const char* szEffFile, D3DXVECTOR3 *pDir, float fTarDir=0.0f );
	BOOL PutPassiveEffect ( DxAttBoneRender *pAttBone, const char* szEffFile, D3DXVECTOR3 *pDir, float fTarDir=0.0f );
	void OutEffect ( DxAttBoneRender *pAttBone, std::string strEffFile );

	/*vehicle system, Juver, 2017/08/06 */
	BOOL PutEffect ( DxVehicle *pVehicle, const char* szEffFile, D3DXVECTOR3 *pDir, float fTarDir=0.0f );
	BOOL PutPassiveEffect ( DxVehicle *pVehicle, const char* szEffFile, D3DXVECTOR3 *pDir, float fTarDir=0.0f );
	void OutEffect ( DxVehicle *pVehicle, std::string strEffFile );
