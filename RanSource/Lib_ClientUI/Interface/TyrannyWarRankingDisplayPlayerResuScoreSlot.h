...
class CCTyrannyWarRankingDisplayPlayerResuScoreSlot : public CUIGroup
{
	enum
	{
		DUMMY = NO_ID + 1,
...
public:
	CCTyrannyWarRankingDisplayPlayerResuScoreSlot ();
	virtual	~CCTyrannyWarRankingDisplayPlayerResuScoreSlot ();
