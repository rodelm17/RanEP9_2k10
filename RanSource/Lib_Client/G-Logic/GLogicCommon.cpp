...
EMANI_SUBTYPE CHECK_ANISUB ( SITEM* pRHAND, SITEM* pLHAND, bool transform_skin )
{
	...
	/*skill transform, Juver, 2018/09/09 */
	if ( transform_skin )	return emANISUBTYPE;
	...
	case ITEMATT_EXTREME_GLOVE:
		emANISUBTYPE = AN_SUB_EXTREME_FIST;
		break;
...
{
	EMANI_SUBTYPE emANISUBTYPE = CHECK_ANISUB ( pRHAND, pLHAND, transform_skin );

	bool bBROOM(false);
	if ( pRHAND )	bBROOM = pRHAND->sSuitOp.IsBROOM();

	/*skill transform, Juver, 2018/09/09 */
	if ( bBROOM && !transform_skin )
...
EMANI_MAINTYPE CHECK_VEHICLE_MAIN( SNATIVEID sVehicleID )
{
	...
	else if ( pItem->sVehicle.emVehicleType == VEHICLE_TYPE_BIKE_V2 )
	{
		switch ( pItem->sVehicle.emVehicleSubType )
		{
		case VEHICLE_SUBTYPE_00:	return	AN_BIKE_V2_01;
		case VEHICLE_SUBTYPE_01:	return	AN_BIKE_V2_02;
		case VEHICLE_SUBTYPE_02:	return	AN_BIKE_V2_03;
		case VEHICLE_SUBTYPE_03:	return	AN_BIKE_V2_04;
		case VEHICLE_SUBTYPE_04:	return	AN_BIKE_V2_05;
		case VEHICLE_SUBTYPE_05:	return	AN_BIKE_V2_06;
		case VEHICLE_SUBTYPE_06:	return	AN_BIKE_V2_07;
		case VEHICLE_SUBTYPE_07:	return	AN_BIKE_V2_08;
		case VEHICLE_SUBTYPE_08:	return	AN_BIKE_V2_09;
		case VEHICLE_SUBTYPE_09:	return	AN_BIKE_V2_10;
