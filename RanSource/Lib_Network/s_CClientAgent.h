...
public :
	...
	*/
	...
	bool    GetUserAccountPageInit(DWORD dwClient);
	void    SetUserAccountPageInit(DWORD dwClient, bool bSet );
	bool    GetUserAccountPageWait(DWORD dwClient);
	void    SetUserAccountPageWait(DWORD dwClient, bool bSet );

	/* login device check, Juver, 2020/11/06 */
	bool    GetUserLoginDeviceCheck(DWORD dwClient);
	void    SetUserLoginDeviceCheck(DWORD dwClient, bool bSet );

	bool    GetUserLoginDeviceCheckVerifyRequestInit(DWORD dwClient);
	void    SetUserLoginDeviceCheckVerifyRequestInit(DWORD dwClient, bool bSet );
	bool    GetUserLoginDeviceCheckVerifyRequestWait(DWORD dwClient);
	void    SetUserLoginDeviceCheckVerifyRequestWait(DWORD dwClient, bool bSet );
};
