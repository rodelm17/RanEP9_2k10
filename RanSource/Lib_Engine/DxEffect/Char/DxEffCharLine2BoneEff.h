...
#include "../../DxCommon/DxSequenceUV.h"
...
struct EFFCHAR_PROPERTY_LINE2BONEEFF_0100
{
	DWORD		m_dwFlag;
	...
	EFFCHAR_PROPERTY_LINE2BONEEFF_0100()
	{
		...
		SecureZeroMemory( m_szTexture2, sizeof(char)*BONELISTEFF_TEXNAME_SIZE );
	}
};

struct EFFCHAR_PROPERTY_LINE2BONEEFF_0101
{
	DWORD		m_dwFlag;
	DWORD		m_dwOtherColor;
	DWORD		m_dwParticlePec;	// 초당 나오는 파티클 갯수
	...
	EFFCHAR_PROPERTY_LINE2BONEEFF_0101()
	{
		SecureZeroMemory( m_szTexture, sizeof(char)*BONELISTEFF_TEXNAME_SIZE );
		SecureZeroMemory( m_szTexture2, sizeof(char)*BONELISTEFF_TEXNAME_SIZE );
	}
...
struct EFFCHAR_PROPERTY_LINE2BONEEFF_0102
{
	DWORD		m_dwFlag;
	DWORD		m_dwOtherColor;
	DWORD		m_dwParticlePec;	// 초당 나오는 파티클 갯수
	...
	EFFCHAR_PROPERTY_LINE2BONEEFF_0102()
	{
		SecureZeroMemory( m_szTexture, sizeof(char)*BONELISTEFF_TEXNAME_SIZE );
		SecureZeroMemory( m_szTexture2, sizeof(char)*BONELISTEFF_TEXNAME_SIZE );
	}
...
struct EFFCHAR_PROPERTY_LINE2BONEEFF : public EFFCHAR_PROPERTY
{
	...
	void Assign( EFFCHAR_PROPERTY_LINE2BONEEFF_0101 &sOldProperty );
	void Assign( EFFCHAR_PROPERTY_LINE2BONEEFF_0102 &sOldProperty );
};
//
//struct DXCUSTOMBONE
//{
