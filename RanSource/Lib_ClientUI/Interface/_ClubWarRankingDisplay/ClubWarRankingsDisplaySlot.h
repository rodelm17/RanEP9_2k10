...
class CClubWarRankingsDisplaySlot : public CUIGroup
{
private:
	enum
	{
...
public:
	CClubWarRankingsDisplaySlot ();
	virtual	~CClubWarRankingsDisplaySlot ();
...
public:
	void	ResetData();
	void	SetData( SCLUBWAR_RANK sClubWarRank, int nRank, std::string strName, DWORD dwCharID, int nChaClass,
