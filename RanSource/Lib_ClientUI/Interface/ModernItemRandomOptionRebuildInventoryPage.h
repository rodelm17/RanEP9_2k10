/*!
 * \file ModernItemRandomOptionRebuildInventoryPage.h
 *
 * \author Juver
 * \date July 2018
 *
...
class CModernItemRandomOptionRebuildInventoryPage : public CUIGroup	
{
private:
...
public:
	CModernItemRandomOptionRebuildInventoryPage();
	virtual	~CModernItemRandomOptionRebuildInventoryPage();
