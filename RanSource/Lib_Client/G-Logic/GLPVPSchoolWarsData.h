...
struct SCHOOLWARS_CROW_SCORE
{ 
	SNATIVEID	crow;
	WORD		score_total;
	WORD		score_each;

	SCHOOLWARS_CROW_SCORE()
		: crow(false)
		, score_total(0)
		, score_each(0)
	{
...
struct SCHOOLWARS_PLAYER_HASH_DATA
{
	DWORD dwCharID;
	std::string strHash;

	SCHOOLWARS_PLAYER_HASH_DATA()
		: dwCharID(SCHOOLWARS_PLAYER_NULL)
		, strHash("")
	{
	}
...
typedef std::map<DWORD,SCHOOLWARS_CROW_SCORE>			SCHOOLWARS_CROW_SCORE_MAP;
typedef SCHOOLWARS_CROW_SCORE_MAP::iterator				SCHOOLWARS_CROW_SCORE_MAP_ITER;

/* PVPSchoolWars hash check, Juver, 2021/07/17 */
typedef std::vector<SCHOOLWARS_PLAYER_HASH_DATA>			SCHOOLWARS_PLAYER_HASH_DATA_VEC;
typedef std::map<std::string, SCHOOLWARS_PLAYER_HASH_DATA>	SCHOOLWARS_PLAYER_HASH_DATA_MAP;
typedef SCHOOLWARS_PLAYER_HASH_DATA_MAP::iterator			SCHOOLWARS_PLAYER_HASH_DATA_MAP_ITER;
