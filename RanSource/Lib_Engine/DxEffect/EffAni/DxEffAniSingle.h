...
protected:
	...
	/*ABL system, Juver, 2017/05/29 */
	BOOL	SetPosition ( DxAttBone* pAttBone, LPD3DXMATRIX& matBone );
	BOOL	SetPosition ( DxAttBoneRender* pAttBone, LPD3DXMATRIX& matBone );

	/*vehicle system, Juver, 2017/08/03 */
	BOOL	SetPosition ( DxVehicle* pVehicle, LPD3DXMATRIX& matBone );
