...
protected:
	...
	QUESTGEN	m_mapStartMapReach;			/*quest auto start in map, Juver, 2018/07/16 */
...
public:
	...
	GLQuestMan::QUESTGEN_RANGE* FindStartFromMapReach( SNATIVEID nidMAP );	/*quest auto start in map, Juver, 2018/07/16 */
