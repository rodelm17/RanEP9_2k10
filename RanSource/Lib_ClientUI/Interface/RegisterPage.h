...
class CRegisterPage : public CUIOuterWindow
{
	enum
	{
		...
		LOBBY_REGISTER_EDIT_FULLNAME,
		LOBBY_REGISTER_EDIT_SA,
		LOBBY_REGISTER_EDIT_SA2,
		LOBBY_REGISTER_EDIT_REFERRAL,
...
public:
	...
	CBasicLineBox*		m_pLineBoxReferral;
	CBasicTextBox*		m_pStaticRefferal;
	CBasicTextBox*		m_pTextReferral;
...
public:
	...
	BOOL	CheckString_Special3( CString strTemp );
