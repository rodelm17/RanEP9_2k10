...
namespace SKILL
{
	...
	struct SEXT_DATA_108
	{
		...
		DWORD				unknown_var0;							//official unknown data
	...
	struct SEXT_DATA
	{
		...
		DWORD				unknown_var0;		//official unknown data
		DWORD				unknown_var1;		//official unknown data
		...
		SEXT_DATA (void) :
			...
			unknown_var0(7), //default val from official
			unknown_var1(0)
		{
		}
		...
		void Assign ( const SEXT_DATA_112 &OldData );
