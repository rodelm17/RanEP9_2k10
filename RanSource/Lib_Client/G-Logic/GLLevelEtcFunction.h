...
struct SLEVEL_ETC_FUNC
{
	...
	void LOAD_0106 ( basestream &SFile, DWORD dwSIZE );
	...
	void LOAD_0203 ( basestream &SFile, DWORD dwSIZE );
	void LOAD_0204 ( basestream &SFile, DWORD dwSIZE );
	void LOAD_0205 ( basestream &SFile, DWORD dwSIZE );
};
