...
void  CBasicLineBox::CreateBaseBoxQuestList1 ( char* szBoxControl )
{
	CreateBodyImage ( "BASIC_LINE_BOX_BODY_QUEST_LIST1" );
	CreateLineImage ( "BASIC_LINE_BOX_LEFT_QUEST_LIST1", "BASIC_LINE_BOX_RIGHT_QUEST_LIST1", "BASIC_LINE_BOX_TOP_QUEST_LIST1", "BASIC_LINE_BOX_BOTTOM_QUEST_LIST1" );	
	ResizeControl ( szBoxControl );
}
...
void CBasicLineBox::CreateBaseBoxModernMiniPartyExpedition ( char* szBoxControl )
{
	//CreateBodyImage ( "MODERN_MINI_PARTY_EXPEDITION_INFO_SLOT_LINE_BOX" );
	CreateLineImage ( "MODERN_MINI_PARTY_EXPEDITION_INFO_SLOT_LINE_BOX_LEFT", 
		"MODERN_MINI_PARTY_EXPEDITION_INFO_SLOT_LINE_BOX_RIGHT", 
		"MODERN_MINI_PARTY_EXPEDITION_INFO_SLOT_LINE_BOX_TOP", 
		"MODERN_MINI_PARTY_EXPEDITION_INFO_SLOT_LINE_BOX_BOTTOM" );
	ResizeControl ( szBoxControl );
}
