...
void DxTexEffRotate::Render( LPDIRECT3DDEVICEQ pd3dDevice, const DWORD dwVert, const DWORD dwFaces, VERTEXNORCOLORTEX_850* pVertSrc )
{
...
void DxTexEffRotate::LoadPSF( LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile )
{
	...
	{
		CDebugSet::ErrorVersion( "DxTexEffRotate::LoadPSF", SFile.GetFileName(), dwVer );
