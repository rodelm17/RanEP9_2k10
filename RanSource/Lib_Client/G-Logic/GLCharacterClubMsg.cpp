	...
	case NET_MSG_GCTRL_CLUB_AUTHORITY_REQ_FB:
		{
			...
			case EMCLUB_AUTHORITY_REQ_FB_CDM_TIME:
				CInnerInterface::GetInstance().PrintMsgTextDlg ( NS_UITEXTCOLOR::NEGATIVE, ID2GAMEINTEXT("EMCLUB_AUTHORITY_REQ_FB_CDM_TIME") );
				break;
			}
		}
		break;
