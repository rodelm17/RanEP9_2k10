...
const INT CChaosMachineInvenPage::nSTARTLINE = 0;	
const INT CChaosMachineInvenPage::nOUTOFRANGE = -1;

CChaosMachineInvenPage::CChaosMachineInvenPage()
	: m_pScrollBar( NULL )
...
void CChaosMachineInvenPage::CreateSubControl()
{
	CString strSlotKeyword[ nMAX_ONE_VIEW_SLOT ] =
	{
		"CHAOS_MACHINE_INVENSLOT_ITEM_SLOT0",
		"CHAOS_MACHINE_INVENSLOT_ITEM_SLOT1",
		"CHAOS_MACHINE_INVENSLOT_ITEM_SLOT2",
		"CHAOS_MACHINE_INVENSLOT_ITEM_SLOT3",
		"CHAOS_MACHINE_INVENSLOT_ITEM_SLOT4",
		"CHAOS_MACHINE_INVENSLOT_ITEM_SLOT5",
		"CHAOS_MACHINE_INVENSLOT_ITEM_SLOT6",
		"CHAOS_MACHINE_INVENSLOT_ITEM_SLOT7",
		"CHAOS_MACHINE_INVENSLOT_ITEM_SLOT8",
		"CHAOS_MACHINE_INVENSLOT_ITEM_SLOT9",
	};
...

	{
		...
		m_pScrollBar->CreateBaseScrollBar( "CHAOS_MACHINE_INVEN_PAGE_SCROLL" );
...
CItemSlotEx* CChaosMachineInvenPage::CreateItemSlot( CString strKeyword, UIGUID ControlID )
{
...
CUIControl*	CChaosMachineInvenPage::CreateControl( const TCHAR* szControl )
{
...
void CChaosMachineInvenPage::Update( INT x, INT y, BYTE LB, BYTE MB, BYTE RB, INT nScroll, FLOAT fElapsedTime, BOOL bFirstControl )
{
...
void CChaosMachineInvenPage::TranslateUIMessage( UIGUID ControlID, DWORD dwMsg )
{
...
void CChaosMachineInvenPage::ResetAllItemSlotRender( INT nTotal )
{
	if( nTotal < 0 )
		return;
...
void CChaosMachineInvenPage::SetItemSlotRender( INT nStartIndex, INT nTotal )
{
	if( nTotal < 0 )
		return;
...
void CChaosMachineInvenPage::SetItemIndex( INT nPosX, INT nPosY )
{
	m_nPosX = nPosX;
	m_nPosY = nPosY;
}

void CChaosMachineInvenPage::GetItemIndex( INT* pnPosX, INT* pnPosY )
{
	*pnPosX = m_nPosX;
	*pnPosY = m_nPosY;
}

void CChaosMachineInvenPage::LoadItemPage( GLInventory &ItemData )
{
...
void CChaosMachineInvenPage::LoadItem( SINVENITEM& ref_InvenItem )
{	
...
void CChaosMachineInvenPage::UnLoadItemPage()
{
...
void CChaosMachineInvenPage::UnLoadItem( INT nPosX, INT nPosY )
{
	m_pItemSlotArray[ nPosY ]->ResetItemImage( nPosX );
}

void CChaosMachineInvenPage::ResetAllFlipItem()
{
	for( WORD y=0; y<EM_INVENSIZE_Y; ++y )
		for( WORD x=0; x<EM_INVENSIZE_X; ++x )
...
void CChaosMachineInvenPage::UpdateFlipItem( GLInventory& ref_Inventory )
{
	ResetAllFlipItem();
...
void CChaosMachineInvenPage::UpdateFlipItem( SINVEN_POS& ref_GarbageItem )
{
...
void CChaosMachineInvenPage::UpdateBLOCK()
{
...
SINVENITEM& CChaosMachineInvenPage::GetItem( INT nPosX, INT nPosY )
{
	return m_pItemSlotArray[ nPosY ]->GetItemImage( nPosX );
}

void CChaosMachineInvenPage::SetOneViewSlot( const INT& nMAX_ONE_VIEW )
{
