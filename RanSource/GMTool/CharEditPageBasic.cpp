...
void CCharEditPageBasic::DataDefault()
{
	...
	SetWin_Num_uint( this, IDC_CHAREDIT_BASIC_EDIT_CHA_WAR_CHIPS, 0 );
	SetWin_Num_uint( this, IDC_CHAREDIT_BASIC_EDIT_CHA_GAME_POINTS, 0 );

	/* reborn system, Juver, 2021/09/17 */
	SetWin_Num_int( this, IDC_CHAREDIT_BASIC_EDIT_CHA_REBORN, 0 );

	/* play time system, Juver, 2021/01/26 */
	SetWin_Num_LONGLONG( this, IDC_CHAREDIT_BASIC_EDIT_CHA_PLAYTIME, 0 );
	SetWin_Num_LONGLONG( this, IDC_CHAREDIT_BASIC_EDIT_CHA_PLAYPOINT, 0 );
}
...
void CCharEditPageBasic::DataShow()
{
	...
	/*contribution point, Juver, 2017/08/23 */
	SetWin_Num_uint( this, IDC_CHAREDIT_BASIC_EDIT_CHA_CONTRIBUTION, m_pData->m_dwContributionPoint );

	/*activity point, Juver, 2017/08/23 */
	SetWin_Num_uint( this, IDC_CHAREDIT_BASIC_EDIT_CHA_ACTIVITY, m_pData->m_dwActivityPoint );
	...
	SetWin_Num_uint( this, IDC_CHAREDIT_BASIC_EDIT_CHA_WAR_CHIPS, m_pData->m_dwWarChips );
	SetWin_Num_uint( this, IDC_CHAREDIT_BASIC_EDIT_CHA_GAME_POINTS, m_pData->m_dwGamePoints );

	/* play time system, Juver, 2021/01/26 */
	SetWin_Num_LONGLONG( this, IDC_CHAREDIT_BASIC_EDIT_CHA_PLAYTIME, m_pData->m_llPlayTime );
	SetWin_Num_LONGLONG( this, IDC_CHAREDIT_BASIC_EDIT_CHA_PLAYPOINT, m_pData->m_llPlayPoint );

	/* reborn system, Juver, 2021/09/17 */
	SetWin_Num_int( this, IDC_CHAREDIT_BASIC_EDIT_CHA_REBORN, m_pData->m_dwReborn );
}
...
BOOL CCharEditPageBasic::DataSave()
{
	...
	/*contribution point, Juver, 2017/08/23 */
	DWORD dwContributionPoint = GetWin_Num_uint( this, IDC_CHAREDIT_BASIC_EDIT_CHA_CONTRIBUTION );

	/*activity point, Juver, 2017/08/23 */
	DWORD dwActivityPoint = GetWin_Num_uint( this, IDC_CHAREDIT_BASIC_EDIT_CHA_ACTIVITY );
	...
	DWORD dwWarChips = GetWin_Num_uint( this, IDC_CHAREDIT_BASIC_EDIT_CHA_WAR_CHIPS );
	DWORD dwGamePoints = GetWin_Num_uint( this, IDC_CHAREDIT_BASIC_EDIT_CHA_GAME_POINTS );

	/* play time system, Juver, 2021/01/26 */
	LONGLONG llChaPlayTime = GetWin_Num_LONGLONG( this, IDC_CHAREDIT_BASIC_EDIT_CHA_PLAYTIME );
	LONGLONG llChaPlayPoint = GetWin_Num_LONGLONG( this, IDC_CHAREDIT_BASIC_EDIT_CHA_PLAYPOINT );

	/* reborn system, Juver, 2021/09/17 */
	WORD wCharReborn = GetWin_Num_int( this, IDC_CHAREDIT_BASIC_EDIT_CHA_REBORN );
	...
	/*contribution point, Juver, 2017/08/23 */
	m_pData->m_dwContributionPoint = dwContributionPoint; 
...
//	m_pData->m_dwPKDeath = dwPKDeath;
	...
	m_pData->m_dwWarChips = dwWarChips;
	m_pData->m_dwGamePoints = dwGamePoints;

	/* play time system, Juver, 2021/01/26 */
	m_pData->m_llPlayTime = llChaPlayTime;
	m_pData->m_llPlayPoint = llChaPlayPoint;

	/* reborn system, Juver, 2021/09/17 */
	m_pData->m_dwReborn = wCharReborn;

	SMAPNODE* pNode = GMTOOL_GLOBAL::gmtoolMapList.FindMapNode( m_pData->m_sStartMapID );
	if ( !pNode )
	{
		m_pData->m_sStartMapID = GLCONST_CHAR::nidSTARTMAP[m_pData->m_wSchool];
		m_pData->m_dwStartGate = GLCONST_CHAR::dwSTARTGATE[m_pData->m_wSchool];
		m_pData->m_vStartPos   = D3DXVECTOR3(0.0f,0.0f,0.0f);
	}
