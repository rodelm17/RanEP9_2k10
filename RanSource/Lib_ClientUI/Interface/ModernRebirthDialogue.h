...
class CModernRebirthDialogue : public CUIWindowEx
{
...
public:
	CModernRebirthDialogue ();
	virtual	~CModernRebirthDialogue ();
...
private:
	CBasicTextBox*		m_pTextBoxQuestion;
	CBasicTextBox*		m_pTextBoxInformation;
...
private:
	...
	bool	m_bDONE_ACTION;
	bool	m_bAutoRebirth;
	bool	m_bForce_Revive;	/*force revive, Juver, 2018/07/09 */
