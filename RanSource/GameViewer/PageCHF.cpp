...
void CPageCHF::OnBnClickedButtonPieceCps()
{
	...
	CFileDialog dlgInput( true, "*.*", DxSkinPieceContainer::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, szFilterInput, this );
...
void CPageCHF::OnBnClickedButtonAbf()
{
	...
	CFileDialog dlg ( TRUE, ".ABL", DxAttBoneLinkContainer::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, szFilter, this );
...
void CPageCHF::OnBnClickedButtonPieceEffskinChf()
{
	...
	CFileDialog dlg ( TRUE, ".effskin", DxEffSelfEffectMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, szFilter, this );
...
void CPageCHF::OnBnClickedButtonPieceVcf()
{
	...
	CFileDialog dlg ( TRUE, ".VCF", DxVehicleDataContainer::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, szFilter, this );
