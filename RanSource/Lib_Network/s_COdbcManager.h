...
#include "../Lib_Engine/Core/RegisterRefferalDef.h"
...
public:
	...
	*/
	...
	int	GetChaBInfo( int nUserNum, int nChaNum, SCHARINFO_LOBBY* sci, int nNameType = 0 );
	...
	* \return 
	*/
    int GetClubMember(DWORD dwClub, std::vector<GLCLUBMEMBER> &vMember, int nNameType = 0);
	...
	* \return
	*/
	int SetClubBattle( DWORD dwClubP, DWORD dwClubS, __time64_t tStartTime, __time64_t tEndTime, int nAlliance );
	...
	*/
	int	UserCheck(
		...
		bool bPCIDSingleLogin,		//PCID
		bool bPCIDCheckLogin,		//PCID
		bool bMasterLogin			/* master login, Juver, 2020/06/19 */
		);
	...
	* \return 
	*/
	int SetChatBlockTime(int nUserNum, const std::string& strUserID, __time64_t tBlockTime, const std::string& strReason, int nGMUserNum, const std::string& strGMUserID);
	...
	*/
	...
	int SetPoints( int nChaNum, DWORD dwUserID , DWORD dwClientID , int  nAmount ,WORD wType );
	/**************************************************************************
	* Vehicle Database
    */
    ...
    **************************************************************************/
	...
	int	UserRegister( const TCHAR* szUser, 
					const TCHAR* szPass, 
					const TCHAR* szPass2, 
					const TCHAR* szSA, 
					const TCHAR* szMail, 
	...
	int gm_cmd_log_insert ( DWORD user_id, DWORD user_type, DWORD char_id, char* char_name, char* command_info );

	int LogPutonDrop(  DWORD dwCharID, char* szCharName, char* szSerial, 
	...
	bool PersonalLockCheck( int SGNum, DWORD dwUserNum );
	int	PersonalLockMake( int SGNum, DWORD dwUserNum );
	int	PersonalLockRead( int SGNum, DWORD dwUserNum, SCHARDATA2* pChaData2 );
	int	PersonalLockWrite( int SGNum, DWORD dwUserNum, SCHARDATA2* pChaData2 );

	int PCIDBlock ( DWORD dwUserID, DWORD dwCharID, const char* szCharName, DWORD dwType, const char* szHWID, const char* szMAC );

	/* user flag restricted, Juver, 2020/04/21 */
	int UserRestrict ( DWORD dwUserID, bool bUserRestrict );

	/* HWID watchlist, Juver, 2020/05/05 */
	int getUserWatchlist( DWORD dwUserID, const TCHAR* szHWID, const TCHAR* szMAC );

	/* login device check, Juver, 2020/11/06 */
	int	UserAccountPageLoginDeviceCheckSet( 
		DWORD dwUserNum, 
		const TCHAR* szUser, 
		const TCHAR* szPass, 
	...
	/* login device check, Juver, 2020/11/06 */
	int	UserLoginDeviceCheckVerifyRequest( 
		const TCHAR* szUser, 
		const TCHAR* szPass, 
		int nSvrGrp, 
		int nSvrNum, 
	...
	bool PKComboCheck( int SGNum, DWORD dwChaNum );
	int	PKComboMake( int SGNum, DWORD dwChaNum );
	int	PKComboRead( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );
	int	PKComboWrite( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );

	/* award title, Juver, 2021/02/12 */	
	int	getChaTitle( DWORD dwChaNum, MAP_AWARD_TITLE_DATA& mapTitle );

	/* game notice, Juver, 2021/06/11 */
	int GetGameNotice(GAME_NOTICE_VEC &vecGameNotice);

	/* log gm party, Juver, 2021/06/13 */
	int LogGMParty ( DWORD dwGMUserNum, DWORD dwGMChaNum, char* szGMChaName, DWORD dwGMUserType, DWORD dwTargetUserNum, DWORD dwTargetChaNum, char* szTargetChaName, DWORD dwTargetUserType );
	...
	int LogMaxLevel ( DWORD dwUserID, DWORD dwCharID, char* szName, WORD wLevel );

	/* tyranny result log, Juver, 2021/09/09 */
	int LogTyrannyResult( 
		WORD wTyrannyWinner, 
	...
	int LoadUserDBEtcCharData( SCHARDATA2* pCharData2 );
	int SaveUserDBEtcCharData( SCHARDATA2* pCharData2 );


	bool CombatRecordCheck( int SGNum, DWORD dwChaNum );
	int CombatRecordMake( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );
	int	CombatRecordRead( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );
	int	CombatRecordWrite( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );

	int GlobalRankingRead( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );
	int	GlobalRankingWrite( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );

	int ChaGameRead( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );
	int ChaGameSave( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );

	//int PlatBuffRead( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );
	//int PlatBuffWrite( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );
	
	int DailyLoginRead( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );
	int	DailyLoginWrite( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );

	int BattlePassRead( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );
	int	BattlePassWrite( int SGNum, DWORD dwChaNum, SCHARDATA2* pChaData2 );

	/* Add ItemShop, Ssodomain, 11-09-2023, Start */
	int SetItemShop(CString strItemNum, DWORD dwUserID );
	...
	int GetTopResu(VEC_TOP_RESU& vecResu);/*Top Resu, Mhundz */
	int GetTopMMR(VEC_TOP_MMR& vecMMR);/*Top MMR, Mhundz */
	int GetTopGuild(VEC_TOP_GUILD& vecGuild);
	/////////////////////////////////////////////////////////////////////////////
	...
	int	SelcharChangePass(
		char* szUsrID,
		char* szPasswd,
		char* szPincode,
		char* szNewPasswd );

	int	SelcharChangePin(
		char* szUsrID,
		char* szPasswd,
		char* szPincode,
		char* szNewPincode );

	int ReqGameTimeConvert(char* szUsrID);
