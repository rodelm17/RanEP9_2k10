...
CClubWarRankingDisplaySlot::CClubWarRankingDisplaySlot ()
...
void CClubWarRankingDisplaySlot::CreateSubControl ()
{
	...
	m_pLineBox->CreateBaseBoxQuestList ( "CLUBWAR_RANKING_LINEBOX_GUILD_WHITE_SELF_SLOT" );
	...
	m_pLineBoxWhite->CreateBaseBoxWhiteBlankBody ( "CLUBWAR_RANKING_LINEBOX_GUILD_WHITE_SLOTRANK" );
	...
	m_pLineBoxRankWhite->CreateBaseBoxWhiteBlankBody ( "CLUBWAR_RANKING_LINEBOX_GUILD_WHITE_RANKNUMBER" );
	...
	m_pLineBoxCharacterDetailsWhite->CreateBaseBoxWhiteBlankBody ( "CLUBWAR_RANKING_LINEBOX_GUILD_WHITE_CHARACTER_DETAILS" );
	...
	m_pLineBoxCharacterNameWhite->CreateBaseBoxWhiteBlankBody ( "CLUBWAR_RANKING_LINEBOX_GUILD_WHITE_CHARACTER_CHARACTER_NAME" );
	...
	m_pClubRankTextSlot->CreateSub ( this, "CLUBWAR_RANKING_TEXT_BASE_RANK_GUILD_SLOT" );
	...
	m_pClubNameTextSlot->CreateSub ( this, "CLUBWAR_RANKING_TEXT_BASE_GUILD_NAME_SLOT" );
	...
	m_pClubScoreTextSlotKill->CreateSub ( this, "CLUBWAR_RANKING_TEXT_BASE_GUILD_KILLSCORE_RESULT" );
	...
	m_pClubScoreTextSlotDeath->CreateSub ( this, "CLUBWAR_RANKING_TEXT_BASE_GUILD_DEATHSCORE_RESULT" );
	...
	m_pKillIcon->CreateSub ( this, "CLUBWAR_RANKING_GUILD_SLOT_IMAGES_KILL", UI_FLAG_XSIZE | UI_FLAG_YSIZE );
	m_pKillIcon->SetVisibleSingle ( FALSE );
	RegisterControl ( m_pKillIcon );

	m_pDeathIcon = new CUIControl;
	m_pDeathIcon->CreateSub ( this, "CLUBWAR_RANKING_GUILD_SLOT_IMAGES_DEATH", UI_FLAG_XSIZE | UI_FLAG_YSIZE );
	m_pDeathIcon->SetVisibleSingle ( FALSE );
	RegisterControl ( m_pDeathIcon );

	m_pGuildImage = new CUIControl;
	m_pGuildImage->CreateSub(this, "CLUBWAR_RANKING_GUILD_CLUB_MARK", UI_FLAG_DEFAULT, GUILD_DUMMY);
...
CUIControl* CClubWarRankingDisplaySlot::CreateControl ( const char* szControl )
{
...
void CClubWarRankingDisplaySlot::TranslateUIMessage( UIGUID cID, DWORD dwMsg )
{
	CUIGroup::TranslateUIMessage( cID, dwMsg );
}

void CClubWarRankingDisplaySlot::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
	if ( !IsVisible () ) return ;
...
HRESULT CClubWarRankingDisplaySlot::InitDeviceObjects(LPDIRECT3DDEVICEQ pd3dDevice)
{
	GASSERT(pd3dDevice);
...
HRESULT CClubWarRankingDisplaySlot::Render(LPDIRECT3DDEVICEQ pd3dDevice)
{
	GASSERT( pd3dDevice );
...
void CClubWarRankingDisplaySlot::ResetData()
{
...
void CClubWarRankingDisplaySlot::SetData( int nRank, std::string strClub, WORD wKill, WORD wDeath, WORD wGuNum, WORD wGuMarkVer )
{
	ResetData();
