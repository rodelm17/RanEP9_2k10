...
const INT CModernItemRandomOptionRebuildInventoryPage::nSTARTLINE = 0;	
const INT CModernItemRandomOptionRebuildInventoryPage::nOUTOFRANGE = -1;

CModernItemRandomOptionRebuildInventoryPage::CModernItemRandomOptionRebuildInventoryPage()
...
void CModernItemRandomOptionRebuildInventoryPage::CreateSubControl()
{
	CString strSlotKeyword[ nMAX_ONE_VIEW_SLOT ] =
	{
		"MODERN_ITEM_RANDOM_OPTION_REBUILD_INVENTORY_WINDOW_ITEM_SLOT0",
		"MODERN_ITEM_RANDOM_OPTION_REBUILD_INVENTORY_WINDOW_ITEM_SLOT1",
		"MODERN_ITEM_RANDOM_OPTION_REBUILD_INVENTORY_WINDOW_ITEM_SLOT2",
		"MODERN_ITEM_RANDOM_OPTION_REBUILD_INVENTORY_WINDOW_ITEM_SLOT3",
		"MODERN_ITEM_RANDOM_OPTION_REBUILD_INVENTORY_WINDOW_ITEM_SLOT4",
		"MODERN_ITEM_RANDOM_OPTION_REBUILD_INVENTORY_WINDOW_ITEM_SLOT5",
		"MODERN_ITEM_RANDOM_OPTION_REBUILD_INVENTORY_WINDOW_ITEM_SLOT6",
		"MODERN_ITEM_RANDOM_OPTION_REBUILD_INVENTORY_WINDOW_ITEM_SLOT7",
		"MODERN_ITEM_RANDOM_OPTION_REBUILD_INVENTORY_WINDOW_ITEM_SLOT8",
		"MODERN_ITEM_RANDOM_OPTION_REBUILD_INVENTORY_WINDOW_ITEM_SLOT9",
...
CItemSlotEx* CModernItemRandomOptionRebuildInventoryPage::CreateItemSlot( CString strKeyword, UIGUID ControlID )
{
...
CUIControl*	CModernItemRandomOptionRebuildInventoryPage::CreateControl( const TCHAR* szControl )
{
...
void CModernItemRandomOptionRebuildInventoryPage::Update( INT x, INT y, BYTE LB, BYTE MB, BYTE RB, INT nScroll, FLOAT fElapsedTime, BOOL bFirstControl )
{
...
void CModernItemRandomOptionRebuildInventoryPage::TranslateUIMessage( UIGUID ControlID, DWORD dwMsg )
{
...
void CModernItemRandomOptionRebuildInventoryPage::ResetItemSlotRender ( int nStart, int nEnd )
{
	if ( nEnd < 0 )			return;
...
void CModernItemRandomOptionRebuildInventoryPage::SetItemSlotRender( int nStart, int nEnd )
{
	if ( nEnd < 0 ) return ;
	if ( nStart > nEnd ) return ;
...
void CModernItemRandomOptionRebuildInventoryPage::SetItemIndex( INT nPosX, INT nPosY )
{
	m_nPosX = nPosX;
	m_nPosY = nPosY;
}

void CModernItemRandomOptionRebuildInventoryPage::GetItemIndex( INT* pnPosX, INT* pnPosY )
{
	*pnPosX = m_nPosX;
	*pnPosY = m_nPosY;
}

void CModernItemRandomOptionRebuildInventoryPage::LoadItemPage( GLInventory &ItemData )
{
...
void CModernItemRandomOptionRebuildInventoryPage::LoadItem( SINVENITEM& ref_InvenItem )
{	
...
void CModernItemRandomOptionRebuildInventoryPage::UnLoadItemPage()
{
...
void CModernItemRandomOptionRebuildInventoryPage::UnLoadItem( INT nPosX, INT nPosY )
{
	m_pItemSlotArray[ nPosY ]->ResetItemImage( nPosX );
}

void CModernItemRandomOptionRebuildInventoryPage::ResetAllFlipItem()
{
	for( WORD y=0; y<EM_INVENSIZE_Y; ++y )
		for( WORD x=0; x<EM_INVENSIZE_X; ++x )
...
void CModernItemRandomOptionRebuildInventoryPage::UpdateFlipItem( GLInventory& ref_Inventory )
{
	ResetAllFlipItem();
...
void CModernItemRandomOptionRebuildInventoryPage::UpdateFlipItem( SINVEN_POS& ref_GarbageItem )
{
...
void CModernItemRandomOptionRebuildInventoryPage::UpdateBLOCK()
{
...
SINVENITEM& CModernItemRandomOptionRebuildInventoryPage::GetItem( INT nPosX, INT nPosY )
{
	return m_pItemSlotArray[ nPosY ]->GetItemImage( nPosX );
}

void CModernItemRandomOptionRebuildInventoryPage::SetOneViewSlot( const INT& nMAX_ONE_VIEW )
{
