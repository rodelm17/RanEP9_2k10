...
CClubWarRankingsDisplayResuSlot::CClubWarRankingsDisplayResuSlot ()
: m_pTextRank(NULL)
, m_pTextName(NULL)
...
void CClubWarRankingsDisplayResuSlot::CreateSubControl ()
{
...
void CClubWarRankingsDisplayResuSlot::ResetData()
{
	m_sClubWarRank	= SCLUBWAR_RANK_RESU();
...
HRESULT CClubWarRankingsDisplayResuSlot::Render(LPDIRECT3DDEVICEQ pd3dDevice)
{
...
void CClubWarRankingsDisplayResuSlot::SetData( SCLUBWAR_RANK_RESU sClubWarRank, int nRank, std::string strName, DWORD dwCharID, int nClass,
