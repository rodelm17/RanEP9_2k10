...
void CPageEdit1::OnBnClickedButtonSelfbody()
{
	...
	CFileDialog dlg( TRUE, ".effskin", DxEffcharDataMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, szFilter, this);
...
void CPageEdit1::OnBnClickedButtonShapeinven()
{
	...
	CFileDialog dlg(TRUE, ".x", TextureManager::GetTexturePath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, szFilter, this);
...
void CPageEdit1::OnBnClickedButtonShapefield()
{
	...
	CFileDialog dlg( TRUE, ".x", DxSimpleMeshMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, szFilter, this);
