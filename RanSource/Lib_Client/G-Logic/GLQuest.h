...
enum EMQUESTFLAGS
{
	...
	EMQF_DAILY		= 0x0010,		// daily quest authorization?
...
public:
	...
	DWORD			m_dwGiftContributionPoints;
	...
	GLQUEST_ATTENDANCE_OPTION	m_AttendanceOption;
	bool			m_dummy_var1;
	bool			m_dummy_var2;
...
public:
	...
	bool IsDaily()			{ return (m_dwFlags&EMQF_DAILY)!=NULL;	}		//	is it a daily quest?
...
protected:
	...
	bool LOAD_0020 ( basestream &SFile );
	bool LOAD_0021 ( basestream &SFile );
	bool LOAD_0022 ( basestream &SFile );
...
{
public:
	enum { VERSION = 0x0200, INVEN_SIZEX=8, INVEN_SIZEY=1 };
...
public:
	...
	__time64_t			m_tEndTime;		//	quest end time
...
public:
	...
	BOOL LOAD_200 ( CByteStream &ByteStream );
