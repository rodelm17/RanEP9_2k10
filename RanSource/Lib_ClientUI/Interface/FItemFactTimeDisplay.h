...
class	CFITemFactTimeDisplay : public CUIGroup
{
private:
	enum
	{
...
public:
	CFITemFactTimeDisplay ();
	virtual	~CFITemFactTimeDisplay ();
...
private:
	...
	bool	GET_PLAY_SKILLFACT ( const DWORD& dwSkillID, SFITEMFACT& sFITEMFACT );
...
private:
	CUIControl*		m_pSkillUnitDummy[FITEMFACT_SIZE];
};