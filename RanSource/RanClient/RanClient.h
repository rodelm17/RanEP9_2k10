...
// RanClient.h : main header file for the PROJECT_NAME application
//
...
// CRanClientApp:
// See RanClient.cpp for the implementation of this class
//

class CRanClientApp : public CWinApp
{
public:
	CRanClientApp();

protected:
	CRanClientWnd*	m_pWnd;
	BOOL		m_bIsActive;    
