...
#include "../Lib_Client/G-Logic/GLVEHICLE.h"
...
BOOL CPageEdit1::DataShow ()
{
	...
	SetWin_Check ( this, IDC_CHECK_FLAG_LOCKER, m_pDummyItem->sBasicOp.dwFlags&ITEM_LOCKER );
	SetWin_Check ( this, IDC_CHECK_FLAG_COLOR_CHANGE, m_pDummyItem->sBasicOp.dwFlags&ITEM_COLOR_CHANGE );
	SetWin_Check ( this, IDC_CHECK_FLAG_BOX_WRAPPING, m_pDummyItem->sBasicOp.dwFlags&ITEM_BOX_WRAPPING );
	SetWin_Check ( this, IDC_CHECK_FLAG_DISMANTLE, m_pDummyItem->sBasicOp.dwFlags&ITEM_DISMANTLE );
	SetWin_Check ( this, IDC_CHECK_FLAG_PET_WRAPPING, m_pDummyItem->sBasicOp.dwFlags&ITEM_PET_WRAPPING );

	SetWin_Check ( this, IDC_CHECK_FLAG_EX_01, m_pDummyItem->sBasicOp.dwFlags&ITEM_RESERVE_01 );
	SetWin_Check ( this, IDC_CHECK_FLAG_EX_02, m_pDummyItem->sBasicOp.dwFlags&ITEM_RESERVE_02 );
	SetWin_Check ( this, IDC_CHECK_FLAG_EX_03, m_pDummyItem->sBasicOp.dwFlags&ITEM_RESERVE_03 );

	SetWin_Check ( this, IDC_CHECK_FLAG_CLUB_LOCKER, m_pDummyItem->sBasicOp.dwFlags&ITEM_CLUB_LOCKER );
	...
	SetWin_Check ( this, IDC_CHECK_VEHICLE_USE_COLOR, m_pDummyItem->sVehicle.bUseColor );
	...
	SetWin_Check ( this, IDC_CHECK_USE_REBUILD, m_pDummyItem->sBasicOp.bUseRebuild );

	/*wrapper bypass, Juver, 2019/02/20 */
	SetWin_Check ( this, IDC_CHECK_WRAPPER_BYPASS, m_pDummyItem->sBasicOp.bWrapperBypass );

	/* item always log, Juver, 2020/10/23 */
	SetWin_Check ( this, IDC_CHECK_ITEM_ALWAYS_LOG, m_pDummyItem->sBasicOp.bAlwaysLog );

	/* play time system, Juver, 2021/01/27 */
	SetWin_Num_LONGLONG ( this, IDC_EDIT_PLAY_TIME_REQ, m_pDummyItem->sBasicOp.llPlayTimeReq );

	/* block wrapper, Juver, 2021/06/08 */
	SetWin_Check ( this, IDC_CHECK_ITEM_BLOCK_WRAPPER, m_pDummyItem->sBasicOp.bBlockWrapper );

	SetWin_Check ( this, IDC_CHECK_USE_RVCARD, m_pDummyItem->sBasicOp.bUseRVCard );
...
BOOL CPageEdit1::DataSave ()
{
	...
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_FLAG_LOCKER ), m_pDummyItem->sBasicOp.dwFlags, ITEM_LOCKER );
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_FLAG_COLOR_CHANGE ), m_pDummyItem->sBasicOp.dwFlags, ITEM_COLOR_CHANGE );
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_FLAG_BOX_WRAPPING ), m_pDummyItem->sBasicOp.dwFlags, ITEM_BOX_WRAPPING );
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_FLAG_DISMANTLE ), m_pDummyItem->sBasicOp.dwFlags, ITEM_DISMANTLE );
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_FLAG_PET_WRAPPING ), m_pDummyItem->sBasicOp.dwFlags, ITEM_PET_WRAPPING );

	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_FLAG_EX_01 ), m_pDummyItem->sBasicOp.dwFlags, ITEM_RESERVE_01 );
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_FLAG_EX_02 ), m_pDummyItem->sBasicOp.dwFlags, ITEM_RESERVE_02 );
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_FLAG_EX_03 ), m_pDummyItem->sBasicOp.dwFlags, ITEM_RESERVE_03 );

	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_FLAG_CLUB_LOCKER ), m_pDummyItem->sBasicOp.dwFlags, ITEM_CLUB_LOCKER );
	...
	StringCchCopy ( m_pDummyItem->sRandomOpt.szNAME, ITEM::SRANDOM_OPT::NAME_LEN, GetWin_Text(this,IDC_EDIT_RANDOM_OPTION).GetString() );
	...
	/*bike color , Juver, 2017/11/13 */
	m_pDummyItem->sVehicle.bUseColor = GetWin_Check ( this, IDC_CHECK_VEHICLE_USE_COLOR );
	...
	/*use rebuild flag, Juver, 2019/02/18 */
	m_pDummyItem->sBasicOp.bUseRebuild = GetWin_Check ( this, IDC_CHECK_USE_REBUILD )? true:false;

	/*wrapper bypass, Juver, 2019/02/20 */
	m_pDummyItem->sBasicOp.bWrapperBypass = GetWin_Check ( this, IDC_CHECK_WRAPPER_BYPASS )? true:false;
	
	/* item always log, Juver, 2020/10/23 */
	m_pDummyItem->sBasicOp.bAlwaysLog = GetWin_Check ( this, IDC_CHECK_ITEM_ALWAYS_LOG )? true:false;

	/* play time system, Juver, 2021/01/27 */
	m_pDummyItem->sBasicOp.llPlayTimeReq = GetWin_Num_LONGLONG ( this, IDC_EDIT_PLAY_TIME_REQ );

	/* block wrapper, Juver, 2021/06/08 */
	m_pDummyItem->sBasicOp.bBlockWrapper = GetWin_Check ( this, IDC_CHECK_ITEM_BLOCK_WRAPPER )? true:false;

	m_pDummyItem->sBasicOp.bUseRVCard = GetWin_Check ( this, IDC_CHECK_USE_RVCARD )? true:false;
...
void CPageEdit1::LoadWearingfile( int nID )
{
	...
	CFileDialog dlg( TRUE,".cps", DxSkinPieceContainer::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, szFilter, this );
...
void CPageEdit1::InitVehicleTypes()
{
	...
	case VEHICLE_TYPE_BIKE_V2:
		{
			SetWin_Combo_Init ( this, IDC_COMBO_VEHICLE2, COMMENT::VEHICLE_SUBTYPE_BIKE_V2, VEHICLE_SUBTYPE_SIZE );
		}break;
