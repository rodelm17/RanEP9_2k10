...
// PatchBuilder.cpp : Defines the class behaviors for the application.
//
...
// The one and only CPatchBuilderApp object

CPatchBuilderApp theApp;


// CPatchBuilderApp initialization
