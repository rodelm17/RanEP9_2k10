...
class GLSummonClient : public GLSUMMONLOGIC_CLIENT, public GLCOPY
{
protected:
...
public:
	...
	HRESULT Create ( const PGLSUMMONLOGIC_CLIENT pSummonData, D3DXVECTOR3 vPos, D3DXVECTOR3 vDir, NavigationMesh* pNavi, LPDIRECT3DDEVICEQ pd3dDevice );
