...
void CPageEdit2::AttackShow( int nATTACK )
{
	...
	SetWin_Num_int( this, IDC_EDIT_ATTACK_UNKNOWN_0, sATTACK.unknown_var_0 );
	SetWin_Num_float( this, IDC_EDIT_ATTACK_UNKNOWN_1_X, sATTACK.unknown_var_1.x );
	SetWin_Num_float( this, IDC_EDIT_ATTACK_UNKNOWN_1_Y, sATTACK.unknown_var_1.y );
	SetWin_Num_float( this, IDC_EDIT_ATTACK_UNKNOWN_1_Z, sATTACK.unknown_var_1.z );
}
...
void CPageEdit2::AttackSave( int nATTACK )
{
	...
	m_pDummyCrow->m_sCrowAttack[nATTACK].unknown_var_0 = GetWin_Num_int( this, IDC_EDIT_ATTACK_UNKNOWN_0 );
	m_pDummyCrow->m_sCrowAttack[nATTACK].unknown_var_1.x = GetWin_Num_float( this, IDC_EDIT_ATTACK_UNKNOWN_1_X );
	m_pDummyCrow->m_sCrowAttack[nATTACK].unknown_var_1.y = GetWin_Num_float( this, IDC_EDIT_ATTACK_UNKNOWN_1_Y );
	m_pDummyCrow->m_sCrowAttack[nATTACK].unknown_var_1.z = GetWin_Num_float( this, IDC_EDIT_ATTACK_UNKNOWN_1_Z );
}