...
HRESULT GLActivity::LoadFile ( const char* szFile, BOOL bServer )
{
	...
	if ( dwFILEVER>=VERSION_ENCODE2 )
		SFile.SetEncodeType ( EMRCRYPT_BYTE_TYPE_ACTIVITY_FILE_VER_2 );

	if ( dwFILEVER>=ENCODE_VER_BYTE_CRYPT_2021_ACTIVITY_V1 )
		SFile.SetEncodeType ( EMRCRYPT_BYTE_TYPE_2021_ACTIVITY_V1 );
