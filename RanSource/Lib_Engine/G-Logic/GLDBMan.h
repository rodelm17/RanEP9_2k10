...
#include "../../Lib_Network/s_NetGlobal.h" // struct VIEWLOGITEMEXCHANGEMAX; struct SHOPPURCHASE;
// #include "../../Lib_Network/s_CDbAction.h" // class CDbAction;

#include "../../Lib_Engine/Common/ByteStream.h" // class CByteStream;

#include "../../Lib_Client/G-Logic/GLCharData.h" // struct SCHARDATA2;
#include "../../Lib_Client/G-Logic/GLClubMan.h" // struct GLCLUBMEMBER; struct GLCLUBINFO;
#include "../../Lib_Client/G-Logic/GLGuidance.h" // struct GLGUID_DB;
#include "../../Lib_Client/G-Logic/GLPet.h" //struct GLPET;
#include "../../Lib_Client/G-Logic/GLContrlCharJoinMsg.h" // struct GLCHARAG_DATA;
...
struct SLOGITEMEXCHANGE
{
	...
	BYTE		m_cOptTYPE1; // 공격력
	BYTE		m_cOptTYPE2; // 기저항
	BYTE		m_cOptTYPE3;
	BYTE		m_cOptTYPE4;

	short		m_nOptVALUE1; // 공격력 %
	short		m_nOptVALUE2; // 기저항 %
	short		m_nOptVALUE3;
	short		m_nOptVALUE4;
	...
	SLOGITEMEXCHANGE(
		...
		, m_cOptTYPE1(_cOptTYPE1)
		, m_cOptTYPE2(_cOptTYPE2)
		, m_cOptTYPE3(_cOptTYPE3)
		, m_cOptTYPE4(_cOptTYPE4)

		, m_nOptVALUE1(_nOptVALUE1)
		, m_nOptVALUE2(_nOptVALUE2)
		, m_nOptVALUE3(_nOptVALUE3)
		, m_nOptVALUE4(_nOptVALUE4)
	{
	}
...
public:
	...
	* \return
	*/
	virtual int SetClubBattle( DWORD dwClubP, DWORD dwClub, __time64_t tStartTime, __time64_t tEndTime, int nAlliance )	{ return 0; }
	...
	*/
	virtual int SetChatBlockTime (int nUserNum, const std::string& strUserID, __time64_t tBlockTime, const std::string& strReason, int nGMUserNum, const std::string& strGMUserID) { return 0; }
	...
	*/
	...
	virtual int SetPoints( int nChaNum, DWORD dwUserID , DWORD dwClientID , int  nAmount ,WORD wType ) { return 0; }
	...
	*/
	...
	virtual int SetPetDualSkill( int nChaNum, int nPetNum, bool bDualSkill) { return 0; }
	...
	*/
	...
	virtual int GetVehicleColor( GLVEHICLE* pVehicle, int nVehicleNum, int nCharNum ) { return 0; }
	virtual int SetVehicleColor( int nVehicle, int nCharNum, CByteStream &ByteStream ) { return 0; }
	...
	*/
	...
	virtual int gm_cmd_log_insert ( DWORD user_id, DWORD user_type, DWORD char_id, char* char_name, char* command_info ) { return 0; }

	virtual int LogPutonDrop( DWORD dwCharID, char* szCharName, char* szSerial, 
		SNATIVEID sItemID, BYTE cItemGen, SNATIVEID sMapID, SNATIVEID sFactID_A, SNATIVEID sFactID_B, 
		BOOL bPet, SNATIVEID sPetSkill_A, SNATIVEID sPetSkill_B ) { return 0; }

	virtual int PCIDBlock ( DWORD dwUserID, DWORD dwCharID, const char* szCharName, DWORD dwType, const char* szHWID, const char* szMAC ) { return 0; }

	/* user flag restricted, Juver, 2020/04/21 */
	virtual int UserRestrict ( DWORD dwUserID, bool bUserRestrict ) { return 0; }

	/* login device check, Juver, 2020/11/06 */
	virtual int	UserAccountPageLoginDeviceCheckSet( 
		DWORD dwUserNum, 
		const TCHAR* szUser, 
		const TCHAR* szPass, 
	...
	/* login device check, Juver, 2020/11/06 */
	virtual int	UserLoginDeviceCheckVerifyRequest(
		const TCHAR* szUser, 
		const TCHAR* szPass, 
		int nSvrGrp, 
		int nSvrNum, 
		...
		const TCHAR* szPCID_MAC ) { return 0; }

	/* award title, Juver, 2021/02/13 */
	virtual int	getChaTitle( DWORD dwChaNum, MAP_AWARD_TITLE_DATA& mapTitle ) { return 0; }

	/* game notice, Juver, 2021/06/11 */
	virtual int GetGameNotice(GAME_NOTICE_VEC &vecGameNotice) { return 0; }

	/* log gm party, Juver, 2021/06/13 */
	virtual int LogGMParty ( DWORD dwGMUserNum, DWORD dwGMChaNum, char* szGMChaName, DWORD dwGMUserType, DWORD dwTargetUserNum, DWORD dwTargetChaNum, char* szTargetChaName, DWORD dwTargetUserType ) { return 0; }

#if defined( BUILD_CH ) || defined( BUILD_CHY )
	/* wtf, Juver, 2021/06/24 */
	virtual int SetWTFAction() { return 0; }
#endif

	/* max level notice, Juver, 2021/07/26 */
	virtual int LogMaxLevel ( DWORD dwUserID, DWORD dwCharID, char* szName, WORD wLevel ) { return 0; }

	/* tyranny result log, Juver, 2021/09/09 */
	virtual int LogTyrannyResult( WORD wTyrannyWinner, DWORD dwParticipantSG, DWORD dwParticipantMP, DWORD dwParticipantPHX ) { return 0; }

	/* tyranny result log, Juver, 2021/09/09 */
	virtual int LogTyrannyParticipant( 
		int nSessionID,
		DWORD dwChaNum,
		const char* szName, 
		WORD wSchool, 
		...
		WORD wScoreResu,
		DWORD dwScoreTotal,
		WORD wRewardPoint ) { return 0; }
	
	virtual int LoadUserDBEtcCharData( SCHARDATA2* pCharData2 )		{ return 0; }
	virtual int SaveUserDBEtcCharData( SCHARDATA2* pCharData2 )		{ return 0; }
	...
	/////////////////////////////////////////////////////////////////////////////
	// LG-7 GlobalRanking
	virtual int GetTopKill(VEC_TOP_KILL& vecKill)	{ return 0; }
	virtual int GetTopRich(VEC_TOP_RICH& vecRich)				{ return 0; }
	virtual int GetTopGuild(VEC_TOP_GUILD& vecGuild)			{ return 0; }
	virtual int GetTopResu(VEC_TOP_RESU& vecResu)				{ return 0; }/*Top Resu, Mhundz */
	virtual int GetTopMMR(VEC_TOP_MMR& vecMMR)				{ return 0; }/*Top MMR, Mhundz */
	/////////////////////////////////////////////////////////////////////////////

	/*re-coded LG-7 Global Ranking by DevArt22*/
	virtual int GetTopKillBr(VEC_TOP_KILL_BR& vecKill)	{ return 0; }
	virtual int GetTopKillSw(VEC_TOP_KILL_SW& vecKill)	{ return 0; }
	virtual int GetTopKillAr(VEC_TOP_KILL_AR& vecKill)	{ return 0; }
	virtual int GetTopKillSh(VEC_TOP_KILL_SH& vecKill)	{ return 0; }
	virtual int GetTopKillEx(VEC_TOP_KILL_EX& vecKill)	{ return 0; }
	virtual int GetTopKillSc(VEC_TOP_KILL_SC& vecKill)	{ return 0; }
	virtual int GetTopKillAs(VEC_TOP_KILL_AS& vecKill)	{ return 0; }
...
public:
    ...
    * \return DB_OK, DB_ERROR
    */
    virtual int GetCharacterInfo(int nUserNumber, int nChaNum, GLCHARAG_DATA* pChaData, int nNameType = 0) { return 0; }
    ...
    * \return DB_OK, DB_ERROR
    */
    virtual int GetCharacterInfoByChaNum(int nChaNum, GLCHARAG_DATA* pChaData, int nNameType = 0) { return 0; }
};
