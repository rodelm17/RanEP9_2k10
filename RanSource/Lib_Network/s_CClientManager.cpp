...
/* user flag verified, Juver, 2020/02/25 */
bool CClientManager::GetUserFlagVerified(DWORD dwClient)
{
	return m_pClient[dwClient].GetUserFlagVerified();
}
...
/* user flag restricted, Juver, 2020/04/20 */
bool CClientManager::GetUserFlagRestricted(DWORD dwClient)
{
	return m_pClient[dwClient].GetUserFlagRestricted();
}
...
/* HWID watchlist, Juver, 2020/05/05 */
bool CClientManager::GetUserFlagHWIDWatchList(DWORD dwClient)
{
	return m_pClient[dwClient].GetUserFlagHWIDWatchList();
}
