...
public:
	...
	void hs_send_close_request();
	void hs_send_run_status( DWORD hs_sdk_version );
#endif

#ifdef USE_MSHIELD
	void MShieldLoginFB( std::string strUser );
	void MShieldResetInfo();
	void MShieldRequestHandShake( UINT nKey );
	void MShieldReplyHandShake();
#endif
