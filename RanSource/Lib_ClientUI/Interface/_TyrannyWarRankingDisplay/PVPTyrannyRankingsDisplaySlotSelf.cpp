...
CPVPTyrannyRankingsDisplaySlotSelf::CPVPTyrannyRankingsDisplaySlotSelf ()
: m_pTextRank(NULL)
, m_pTextName(NULL)
...
void CPVPTyrannyRankingsDisplaySlotSelf::CreateSubControl ()
{
...
void CPVPTyrannyRankingsDisplaySlotSelf::ResetData()
{
...
HRESULT CPVPTyrannyRankingsDisplaySlotSelf::Render(LPDIRECT3DDEVICEQ pd3dDevice)
{
...
void CPVPTyrannyRankingsDisplaySlotSelf::SetData( int nRank, std::string strName, DWORD dwCharID, int nChaClass, WORD wKill, WORD wDeath , WORD wResu, WORD wSchool )
{
	ResetData();
