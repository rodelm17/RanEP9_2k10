...
class	CGachaPreviewWindowRender : public CUIGroup
{
...
public:
	CGachaPreviewWindowRender();
	virtual	~CGachaPreviewWindowRender();
...
public:
	...
	D3DXVECTOR3			m_vRot;
	EMCHARGENDER		m_emCharGender;
	EMCHARCLASS			m_emCharClass;
...
public:
	...
	void			SetCharGender( EMCHARGENDER emGender ) { m_emCharGender  = emGender; };
	EMCHARGENDER	GetCharGender() { return m_emCharGender;  };
};