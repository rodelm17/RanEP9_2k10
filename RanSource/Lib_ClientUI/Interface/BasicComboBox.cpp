...
void CBasicComboBox::CreateBaseComboBox ( char* szComboBoxControl, DWORD dwFontSize, DWORD dwFontFlag )
{	
	...
	CD3DFontPar* pFont = DxFontMan::GetInstance().LoadDxFont ( _DEFAULT_FONT, dwFontSize, dwFontFlag );
...
void CBasicComboBox::SetText ( CString str, DWORD dwTextColor /*= NS_UITEXTCOLOR::WHITE*/ )
{
	m_pTextBox->SetOneLineText ( str, dwTextColor );
}