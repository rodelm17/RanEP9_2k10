...
char		DxEffCharEmit::NAME[MAX_PATH]	= "DxEffCharEmit";
...
HRESULT	DxEffCharEmit::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharEmit::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT	DxEffCharEmit::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharEmit::R2LoadFile", SFile.GetFileName(), dwVer );
