#include "StdAfx.h"
#include "PVPTyrannyRankingsDisplayMain.h"
...
CPVPTyrannyRankingsDisplayMain::CPVPTyrannyRankingsDisplayMain ()
: m_nPage(-1)
...
void CPVPTyrannyRankingsDisplayMain::CreateSubControl ()
{
	...
	m_pPageRankingPlayer = new CPVPTyrannyRankingsDisplay;
	...
	m_pPageRankingPlayerResu = new CPVPTyrannyRankingsDisplayResu;
	...
	m_pPageRankingGuild = new CPVPTyrannyRankingsDisplayGuild;
...
CMultiModeButton* CPVPTyrannyRankingsDisplayMain::CreateTabButton( const char* szButtonBox, const char* szButtonText, UIGUID ControlID )
{
...
CBasicTextButton* CPVPTyrannyRankingsDisplayMain::CreateTextButton19 ( char* szButton, UIGUID ControlID, char* szText )
{
...
void CPVPTyrannyRankingsDisplayMain::SetVisibleSingle ( BOOL bVisible )
{
...
void CPVPTyrannyRankingsDisplayMain::TranslateUIMessage ( UIGUID cID, DWORD dwMsg )
{
...
void CPVPTyrannyRankingsDisplayMain::OpenPage( int nPage )
{
...
void CPVPTyrannyRankingsDisplayMain::RefreshPage()
{
	m_pPageRankingPlayer->RefreshTyrannyRanking();
	m_pPageRankingPlayerResu->RefreshTyrannyRankingResu();
	m_pPageRankingGuild->RefreshTyrannyClubRanking();
}