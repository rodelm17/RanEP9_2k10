...
#include "../Lib_Engine/DxEffect/Char/DxEffChar.h"
...
{
	CFileDialog dlgInput( true, NULL, DxSkinMeshMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, RFILE_DIALOG_FILTERS::strFilterSkin, this );
...
{
	CFileDialog dlg( TRUE, NULL, TextureManager::GetTexturePath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, RFILE_DIALOG_FILTERS::strFilterTexture, this );
