...
public:
	...
	BOOL OpenFile ( const char *_szZipFileName, const char *_szFileName, EMRCRYPT_BYTE_TYPE emCryptType = EMRCRYPT_BYTE_TYPE_NONE, BOOL bPack = FALSE );
...
public:
	CSerialMemory ();
	CSerialMemory ( const char *_szZipFileName, const char *_szFileName, EMRCRYPT_BYTE_TYPE emCryptType = EMRCRYPT_BYTE_TYPE_NONE );
