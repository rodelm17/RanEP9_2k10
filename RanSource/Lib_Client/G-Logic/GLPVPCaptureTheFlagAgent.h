...
public:
	void	RequestPlayerRegister( DWORD dwCharID, WORD wLevel, DWORD dwContri, BOOL bRegister, WORD wTeam, std::string strHash );
...
public:
	...
	/* PVPCaptureTheFlag hash check, Juver, 2021/07/18 */
	CAPTURE_THE_FLAG_PLAYER_HASH_DATA_MAP	m_mapPlayerHash;
