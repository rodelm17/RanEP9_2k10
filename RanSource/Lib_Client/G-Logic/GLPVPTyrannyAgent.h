...
public:
	...
	void	CalculateRemainingTimeNexBattle (); // PVP Next Battle UI - Jxyyy
...
private:
	...
	BOOL	InsertRegister( TYRANNY_REGISTER_DATA_MAP& mapData, DWORD dwCharID, const char* szName, WORD wClass, WORD wSchool, BOOL bLateJoin );
...
public:
	...
	void	PlayerRegister( DWORD dwCharID, TYRANNY_REGISTER_DATA_MAP& mapData, TYRANNY_REGISTER_DATA_QUEUE_VEC& vecData, std::string strHash );
	...
	void	PlayerLateJoinBattle( DWORD dwCharID, WORD wLevel, std::string strHash );
...
public:
	...
	/* PVPTyranny Hash Check, Juver, 2020/07/28 */
	TYRANNY_PLAYER_HASH_DATA_MAP	m_mapPlayerHash;
