...
////////////////////////////////////////////////////////////////////
//	사용자 메시지 정의
const DWORD UIMSG_MOUSEIN_SKILLSLOT_EX = UIMSG_USER1;
////////////////////////////////////////////////////////////////////

class	CBasicQuickSkillSlot2Ex;
class	CBasicVarTextBox;
struct	SCHARSKILL;

class CBasicSkillTrayEx : public CUIGroup
{
private:
...
public:
	CBasicQuickSkillSlot2Ex*		m_pSlotEx[QUICK_SKILL_SLOT_MAX];
private:	
