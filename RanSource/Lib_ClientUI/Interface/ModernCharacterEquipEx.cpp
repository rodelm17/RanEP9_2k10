...
const int CModernCharacterEquipEx::nOUTOFRANGE = -1;

CModernCharacterEquipEx::CModernCharacterEquipEx ()
	: m_pMouseOver(NULL)
	, m_pAButton(NULL)
	, m_pBButton(NULL)
	, m_pARHandSlot(NULL)
...
void CModernCharacterEquipEx::CreateSubControl ()
{
	...
	std::string strInvenWearOver[MODERN_CHARACTER_WINDOW_ITEM_IMAGE_SIZE] = 
	{
		...
		"MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_FIRST_RIGHT_WEAPON_OVER",
		"MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_FIRST_LEFT_WEAPON_OVER",
		"MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_SECOND_RIGHT_WEAPON_OVER",
		"MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_SECOND_LEFT_WEAPON_OVER",
	...
	std::string strInvenSlotError[MODERN_CHARACTER_WINDOW_ITEM_IMAGE_SIZE] = 
	{
		...
		"MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_FIRST_RIGHT_WEAPON_ERROR",
		"MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_FIRST_LEFT_WEAPON_ERROR",
		"MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_SECOND_RIGHT_WEAPON_ERROR",
		"MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_SECOND_LEFT_WEAPON_ERROR",
	...
	m_pAButton->CreateSub ( this, "MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_FIRST_RADIO_BUTTON", UI_FLAG_DEFAULT, MODERN_CHARACTER_WINDOW_TEXT_A_BUTTON );
	m_pAButton->CreateFlip ( "MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_RADIO_BUTTON_F", CBasicButton::RADIO_FLIP );
	m_pAButton->SetFlip ( TRUE );
	RegisterControl ( m_pAButton );

	m_pBButton = new CBasicButton;
	m_pBButton->CreateSub ( this, "MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_SECOND_RADIO_BUTTON", UI_FLAG_DEFAULT, MODERN_CHARACTER_WINDOW_TEXT_B_BUTTON );
	m_pBButton->CreateFlip ( "MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_RADIO_BUTTON_F", CBasicButton::RADIO_FLIP );
	m_pBButton->SetFlip ( TRUE );
	RegisterControl ( m_pBButton );

	m_pARHandSlot = CreateControl("MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_FIRST_RIGHT_WEAPON_USE");
	m_pALHandSlot = CreateControl("MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_FIRST_LEFT_WEAPON_USE");
	m_pBRHandSlot = CreateControl("MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_SECOND_RIGHT_WEAPON_USE");
	m_pBLHandSlot = CreateControl("MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_SECOND_LEFT_WEAPON_USE");	
...
CUIControl*	CModernCharacterEquipEx::CreateControl ( const char* szControl )
{
...
CItemImage*	CModernCharacterEquipEx::CreateItemImage ( const char* szControl, UIGUID ControlID )
{
...
void CModernCharacterEquipEx::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
...
void CModernCharacterEquipEx::TranslateUIMessage ( UIGUID ControlID, DWORD dwMsg )
{
	switch ( ControlID )
	{
	...
	case MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_FIRST_RIGHT_WEAPON:
	case MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_FIRST_LEFT_WEAPON:
	case MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_SECOND_RIGHT_WEAPON:
	case MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_SECOND_LEFT_WEAPON:
	...
	case MODERN_CHARACTER_WINDOW_WEAR_SLOT_VEHICLE:
		{
			if ( CHECK_MOUSE_IN ( dwMsg ) )
			{
				...
				if ( pItemMove->GetItem () != NATIVEID_NULL () )
				{
					...
					AddMessageEx ( UIMSG_MOUSEIN_MODERN_CHARACTER_WINDOW_WEARSLOTEX | UIMSG_TOTOPPARENT );
				}				
	...
	case MODERN_CHARACTER_WINDOW_TEXT_A_BUTTON:
	case MODERN_CHARACTER_WINDOW_TEXT_B_BUTTON:
		{
...
void CModernCharacterEquipEx::SetVisibleSingle( BOOL bVisible )
{
...
EMSLOT CModernCharacterEquipEx::IMAGE2EMSLOT ( int nIndex )
{
	switch ( nIndex )
	{	
	...
	case MODERN_CHARACTER_WINDOW_WEAR_SLOT_WAIST:			return SLOT_BELT;				/*ep8 puton slots, Juver, 2018/03/30 */
	...
	case MODERN_CHARACTER_WINDOW_WEAR_SLOT_LEFT_ACCESSORY:	return SLOT_ACCESSORY_L;		/*ep8 puton slots, Juver, 2018/03/30 */
	...
	case MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_FIRST_RIGHT_WEAPON:	return SLOT_RHAND;
	case MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_FIRST_LEFT_WEAPON:	return SLOT_LHAND;

	case MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_SECOND_RIGHT_WEAPON:	return SLOT_RHAND_S;
	case MODERN_CHARACTER_WINDOW_WEAR_SLOT_EX_SECOND_LEFT_WEAPON:	return SLOT_LHAND_S;
...
EMSLOT CModernCharacterEquipEx::GetItemSlot ()
{
	return IMAGE2EMSLOT ( GetItemIndex () + MODERN_CHARACTER_WINDOW_WEAR_SLOT_HEAD );
}

SITEMCUSTOM& CModernCharacterEquipEx::GetItem ( int nIndex )
{
	return m_ItemCustomArray[nIndex];
}


void CModernCharacterEquipEx::LoadItem ( int nIndex, SITEMCUSTOM& ref_sItemCustom )
{
...
void CModernCharacterEquipEx::UnLoadItem ( int nIndex, SITEMCUSTOM& ref_sItemCustom )
{
	m_ItemCustomArray[nIndex] = ref_sItemCustom;
...
void CModernCharacterEquipEx::SetTabButton( BOOL bMain )
{
	if( bMain )
	{
		m_pAButton->SetFlip( TRUE );
...
void CModernCharacterEquipEx::ClearRender()
{
	if( m_pRender )
		m_pRender->ClearRender();
}

void CModernCharacterEquipEx::StartRender()
{
	if( m_pRender )
	{
