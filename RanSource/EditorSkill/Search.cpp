...
void CSearch::OnBnClickedButtonSearch()
{
	...
	case EMSEARCH_SKILL_IMPACT_SIDE:
		{
			for ( int MID = 0; MID < EMSKILLCLASS_NSIZE; MID++ )
			{
				for ( int SID = 0; SID < GLSkillMan::MAX_CLASSSKILL; SID++ )
				{
					...
					if ( pSKILL )
					{
						if ( pSKILL->m_sBASIC.emIMPACT_SIDE == static_cast<EMIMPACT_SIDE>( nSELECTED )  )
						{
							SSEARCH sResult;
							sResult.sID = pSKILL->m_sBASIC.sNATIVEID;
							sResult.strNAME = pSKILL->GetName();
							sResult.strFIND = COMMENT::IMPACT_SIDE[pSKILL->m_sBASIC.emIMPACT_SIDE].c_str();
							vec.push_back( sResult );
						}
					}
				}
	...
	case EMSEARCH_SKILL_IMPACT_TAR:
		{
			for ( int MID = 0; MID < EMSKILLCLASS_NSIZE; MID++ )
			{
				for ( int SID = 0; SID < GLSkillMan::MAX_CLASSSKILL; SID++ )
				{
					...
					if ( pSKILL )
					{
						if ( pSKILL->m_sBASIC.emIMPACT_TAR == static_cast<EMIMPACT_TAR>( nSELECTED )  )
						{
							SSEARCH sResult;
							sResult.sID = pSKILL->m_sBASIC.sNATIVEID;
							sResult.strNAME = pSKILL->GetName();
							sResult.strFIND = COMMENT::IMPACT_TAR[pSKILL->m_sBASIC.emIMPACT_TAR].c_str();
							vec.push_back( sResult );
						}
					}
				}
	...
	case EMSEARCH_SKILL_IMPACT_REALM:
		{
			for ( int MID = 0; MID < EMSKILLCLASS_NSIZE; MID++ )
			{
				for ( int SID = 0; SID < GLSkillMan::MAX_CLASSSKILL; SID++ )
				{
					...
					if ( pSKILL )
					{
						if ( pSKILL->m_sBASIC.emIMPACT_REALM == static_cast<EMIMPACT_REALM>( nSELECTED )  )
						{
							SSEARCH sResult;
							sResult.sID = pSKILL->m_sBASIC.sNATIVEID;
							sResult.strNAME = pSKILL->GetName();
							sResult.strFIND = COMMENT::IMPACT_REALM[pSKILL->m_sBASIC.emIMPACT_REALM].c_str();
							vec.push_back( sResult );
						}
					}
				}
...
void CSearch::SearchInit()
{
	...
	else if ( emSearch == EMSEARCH_DDSXY  )
	{
		...
		emSearch == EMSEARCH_SKILL_SPECIALTYPE || emSearch == EMSEARCH_SKILL_ACTIONTYPE || emSearch == EMSEARCH_SKILL_IMPACT_SIDE || 
		emSearch == EMSEARCH_SKILL_IMPACT_TAR || emSearch == EMSEARCH_SKILL_IMPACT_REALM ) 
	{
	...
	case EMSEARCH_SKILL_IMPACT_SIDE:
		{
			SetWin_Combo_Init( this, IDC_COMBO_SEARCH, COMMENT::IMPACT_SIDE, SIDE_SIZE );
		}break;

	case EMSEARCH_SKILL_IMPACT_TAR:
		{
			SetWin_Combo_Init( this, IDC_COMBO_SEARCH, COMMENT::IMPACT_TAR, TAR_SIZE );
		}break;

	case EMSEARCH_SKILL_IMPACT_REALM:
		{
			SetWin_Combo_Init( this, IDC_COMBO_SEARCH, COMMENT::IMPACT_REALM, REALM_SIZE );
		}break;
	};
}
