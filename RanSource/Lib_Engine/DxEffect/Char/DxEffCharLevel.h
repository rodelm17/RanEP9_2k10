...
struct EFFCHAR_PROPERTY_LEVEL_104_105
{
	DWORD			m_dwFlag;
	DWORD			m_dwColorOP;
	DWORD			m_dwMaterials;
	...
	EFFCHAR_PROPERTY_LEVEL_104_105 () 
	{
		SecureZeroMemory( m_szTexture, sizeof(char)*MAX_PATH );
	}
};

struct EFFCHAR_PROPERTY_LEVEL_106
{
	DWORD			m_dwFlag;
	DWORD			m_dwColorOP;
	DWORD			m_dwMaterials;
	...
	EFFCHAR_PROPERTY_LEVEL_106 () 
	{
		SecureZeroMemory( m_szTexture, sizeof(char)*MAX_PATH );
	}
};

struct EFFCHAR_PROPERTY_LEVEL : public EFFCHAR_PROPERTY	//Ver.107
{
	DWORD			m_dwFlag;
	DWORD			m_dwColorOP;
	DWORD			m_dwMaterials;
