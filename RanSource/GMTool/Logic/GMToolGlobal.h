...
enum USERPAGE_SEARCH_TYPE
{
	...
	USERPAGE_SEARCH_TYPE_USER_FULLNAME	= 3,
	USERPAGE_SEARCH_TYPE_USERGM			= 4,
	USERPAGE_SEARCH_TYPE_ONLINE			= 5,

	//PCID
	USERPAGE_SEARCH_TYPE_PCID_HWID		= 6,
	USERPAGE_SEARCH_TYPE_PCID_MAC		= 7,

	/* user flag restricted, Juver, 2020/04/20 */
	USERPAGE_SEARCH_TYPE_RESTRICTED		= 8,

	USERPAGE_SEARCH_TYPE_SIZE			= 9,
};
...
enum EMEQUIPMENT_LOCK_PAGE_SEARCH_TYPE
{
	...
	EMEQUIPMENT_LOCK_PAGE_SEARCH_TYPE_EPIN		= 1,
	EMEQUIPMENT_LOCK_PAGE_SEARCH_TYPE_SIZE		= 2
};
