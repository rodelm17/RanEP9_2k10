...
void CsheetWithTab::ActivePageEdit3( int nCurPage, PCROWDATA pCROW )
{
	m_PageEdit3.SetCallPage( nCurPage );
	m_PageEdit3.CrowSet( pCROW );
	SetActivePage ( PAGE_EDIT3 );
}
