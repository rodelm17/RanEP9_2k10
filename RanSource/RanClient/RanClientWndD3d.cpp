...
HRESULT CRanClientWnd::ConfirmDevice ( D3DCAPSQ* pCaps, DWORD dwBehavior, D3DFORMAT Format )
{
...
HRESULT CRanClientWnd::Resize3DEnvironment()
{
	HRESULT hr=S_OK;
...
void CRanClientWnd::OnSize(UINT nType, int cx, int cy) 
{
...
HRESULT CRanClientWnd::OneTimeSceneInit()
{
	HRESULT hr(S_OK);
...
HRESULT CRanClientWnd::CreateObjects()
{
...
HRESULT CRanClientWnd::InitDeviceObjects()
{	
	HRESULT hr = S_OK;
...
HRESULT CRanClientWnd::RestoreDeviceObjects()
{
	HRESULT hr=S_OK;
...
HRESULT CRanClientWnd::FrameMove3DEnvironment ()
{
	HRESULT hr=S_OK;
...
HRESULT CRanClientWnd::Render3DEnvironment ()
{
	HRESULT hr=S_OK;
...
HRESULT CRanClientWnd::FrameMove()
{
	PROFILE_BLOCKSTART();
...
HRESULT CRanClientWnd::RenderText()
{
...
HRESULT CRanClientWnd::InvalidateDeviceObjects()
{
...
HRESULT CRanClientWnd::DeleteDeviceObjects()
{
...
HRESULT CRanClientWnd::FinalCleanup()
{
...
void CRanClientWnd::OnSysCommand(UINT nID, LPARAM lParam)
{
	if(nID==SC_KEYMENU)	return;
	__super::OnSysCommand(nID, lParam);
}

BOOL CRanClientWnd::OnWndMsg(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pResult)
{
	MSG msg;
	msg.hwnd = m_hWnd;
	msg.message = message;
...
void CRanClientWnd::OnGetMinMaxInfo(MINMAXINFO* lpMMI)
{
...
BOOL CRanClientWnd::OnNcActivate(BOOL bActive)
{
...
void CRanClientWnd::OnTimer(UINT nIDEvent)
{
	__super::OnTimer(nIDEvent);
}

void CRanClientWnd::OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized)
{
