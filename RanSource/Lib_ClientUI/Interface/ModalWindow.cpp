...
/* Codex, Archie 02/16/24 */
void	CModalWindow::SetCodexModalData ( SNATIVEID nData1, DWORD nData2, WORD nData3, WORD nData4 )
{
	m_nCodexData1 = nData1;
	m_nCodexData2 = nData2;
	m_nCodexData3 = nData3;
	m_nCodexData4 = nData4;
}

void	CModalWindow::GetCodexModalData ( SNATIVEID* pnData1, DWORD* pnData2, WORD* pnData3, WORD* pnData4)
{
	*pnData1 = m_nCodexData1;
	*pnData2 = m_nCodexData2;
	*pnData3 = m_nCodexData3;
	*pnData4 = m_nCodexData4;
}
...
/* Codex, Archie 02/16/24 */
void SetCodexModalData ( SNATIVEID nData1, DWORD nData2, WORD nData3, WORD nData4 )
{
	CModalWindow* pModalWindow = CInnerInterface::GetInstance().GetModalWindow ();
	if ( pModalWindow ) pModalWindow->SetCodexModalData ( nData1, nData2, nData3, nData4 );
}