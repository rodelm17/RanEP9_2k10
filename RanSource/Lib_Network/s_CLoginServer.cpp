...
void CLoginServer::IPFilterBlockAdd( std::string strIP )
{
	if ( strIP.size() <= 0 )
	{
...
void CLoginServer::IPFilterBlockDel( std::string strIP )
{
	if ( strIP.size() <= 0 )
	{
		CConsoleMessage::GetInstance()->Write("Invalid IP");
...
void CLoginServer::IPFilterKnownAdd( std::string strIP )
{
	if ( strIP.size() <= 0 )
	{
		CConsoleMessage::GetInstance()->Write("Invalid IP");
...
void CLoginServer::IPFilterKnownDel( std::string strIP )
{
	if ( strIP.size() <= 0 )
	{
		CConsoleMessage::GetInstance()->Write("Invalid IP");
...
void CLoginServer::IPFilterSessionBlockAdd( std::string strIP )
{
	if ( strIP.size() <= 0 )
	{
...
void CLoginServer::IPFilterSessionBlockDel( std::string strIP )
{
	if ( strIP.size() <= 0 )
	{
...
void CLoginServer::IPFilterSessionKnownAdd( std::string strIP )
{
	if ( strIP.size() <= 0 )
	{
...
void CLoginServer::IPFilterSessionKnownDel( std::string strIP )
{
	if ( strIP.size() <= 0 )
	{
...
void CLoginServer::IPFilterSave()
{
	NET_IPFILTER_SERVER_TO_SESSION_LISTSAVE netMsg;
	SendSession( &netMsg );
}

void CLoginServer::IPFilterCleanIP( std::string strIP )
{
