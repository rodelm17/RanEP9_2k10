...
typedef stdext::hash_map<DWORD,GLCLUBMEMBER>	CLUBMEMBERS;
...
typedef stdext::hash_set<DWORD>					CLUBCONFT;
...
struct GLCLUBBATTLE
{
	...
	{
		CLUB_BATTLE_NOW				= 0,	// Proceeding
		CLUB_BATTLE_DRAW			= 1,	// Tie
		CLUB_BATTLE_ARMISTICE		= 2,	// Truce
		CLUB_BATTLE_SUBMISSION		= 3,	// Surrender
		CLUB_BATTLE_SUBMISSION_WIN	= 4,	// Surrender victory
		CLUB_BATTLE_LOSE			= 5,	// Defeat
		CLUB_BATTLE_WIN				= 6		// Victory
	};
...
typedef stdext::hash_map<DWORD,GLCLUBBATTLE>		CLUB_BATTLE;
typedef stdext::hash_map<DWORD,GLCLUBBATTLE_DEL>	CLUB_BATTLE_DEL;
...
typedef stdext::hash_map<DWORD,GLCLUB>		CLUBS;
