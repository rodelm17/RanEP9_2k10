...
protected:
	...
	EMRCRYPT_BYTE_TYPE	m_emCrypt_Type;
	INT			m_nVersion;
...
public:
	...
	virtual void SetEncodeType ( EMRCRYPT_BYTE_TYPE emCryptType ){CALLERROR;}
...
public:
	virtual void DumpToDisk( std::string strPATH, std::string strFILE ){CALLERROR;}
	virtual void DumpToDisk_Increment( std::string strPATH ){CALLERROR;}
...
public:
	virtual BOOL operator << ( D3DXVECTOR2 Value ){CALLERROR; return TRUE;}
	virtual BOOL operator << ( D3DXVECTOR3 Value ){CALLERROR; return TRUE;}
	virtual BOOL operator << ( D3DXVECTOR4 Value ){CALLERROR; return TRUE;}
	virtual BOOL operator << ( D3DXMATRIX Value ){CALLERROR; return TRUE;}

	virtual BOOL operator >> ( D3DXVECTOR2 &Value ) = 0;
	virtual BOOL operator >> ( D3DXVECTOR3 &Value ) = 0;
	virtual BOOL operator >> ( D3DXVECTOR4 &Value ) = 0;
	virtual BOOL operator >> ( D3DXMATRIX &Value ) = 0;
...
public:
	basestream() :
		...
		m_DefaultOffSet(0),
		m_dwBlockMarkPOS(0),
		m_emCrypt_Type(EMRCRYPT_BYTE_TYPE_NONE),
		m_nVersion(-1)
	{
