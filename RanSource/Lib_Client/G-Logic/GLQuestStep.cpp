...
GLQUEST_STEP& GLQUEST_STEP::operator= ( const GLQUEST_STEP &rVALUE )
{
	...
	m_stepMoveMap = rVALUE.m_stepMoveMap;

	m_dummy_var1 = rVALUE.m_dummy_var1;
	m_dummy_var2 = rVALUE.m_dummy_var2;
	m_dummy_var3 = rVALUE.m_dummy_var3;
	m_dummy_var4 = rVALUE.m_dummy_var4;
	m_dummy_var5 = rVALUE.m_dummy_var5;
	m_dummy_var6 = rVALUE.m_dummy_var6;
	m_dummy_var7 = rVALUE.m_dummy_var7;
	m_dummy_var8 = rVALUE.m_dummy_var8;
	m_dummy_var9 = rVALUE.m_dummy_var9;
	m_dummy_var10 = rVALUE.m_dummy_var10;
	m_dummy_var11 = rVALUE.m_dummy_var11;
	m_dummy_var12 = rVALUE.m_dummy_var12;
	m_dummy_var13 = rVALUE.m_dummy_var13;
	m_dummy_var14 = rVALUE.m_dummy_var14;
	m_dummy_var15 = rVALUE.m_dummy_var15;
...
bool GLQUEST_STEP::LOAD_0017( basestream &SFile )
{
...
bool GLQUEST_STEP::LOAD_0018( basestream &SFile )
{
...
bool GLQUEST_STEP::LOAD_0019( basestream &SFile )
{
	typedef std::vector<SITEMCUSTOM_QUEST_117>	INVENQARRAY_OLD;
	typedef INVENQARRAY_OLD::iterator		INVENQARRAY_OLD_ITER;
...
bool GLQUEST_STEP::LOAD_0202( basestream &SFile )
{
	typedef std::vector<SITEMCUSTOM_200>	INVENQARRAY_OLD;
	typedef INVENQARRAY_OLD::iterator		INVENQARRAY_OLD_ITER;
...
bool GLQUEST_STEP::LOAD_0203( basestream &SFile )
{
...
bool GLQUEST_STEP::LOAD_0204( basestream &SFile )
{
	DWORD dwSize(0);
...
bool GLQUEST_STEP::LOAD ( basestream &SFile )
{
	...
	case VERSION:	LOAD_0204 ( SFile ); break;
