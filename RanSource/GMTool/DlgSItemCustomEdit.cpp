...
void CDlgSItemCustomEdit::DataShow()
{
	...
	std::string strGEN[EMITEMGEN_SIZE] = 
	{
		"EMGEN_DEFAULT",
		"EMGEN_INIT",
		"EMGEN_SHOP",
	...
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_REFORM_USE_COUNT, m_pItemCustom->wReformUseCount );

	/* set item option, Juver, 2021/09/01 */
	SetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SET_OPTION_GEN, m_pItemCustom->wSetItemID );
}
...
BOOL CDlgSItemCustomEdit::DataSave()
{
	...
	/* Item Reform use limit, Juver, 2021/07/22 */
	WORD wUseReformCount = GetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_REFORM_USE_COUNT );

	/* set item option, Juver, 2021/09/01 */
	WORD wSetOptionID = GetWin_Num_int( this, IDC_SITEMCUSTOM_EDIT_EDIT_SET_OPTION_GEN );
	...
	if ( !bNonDrop && m_pItemCustom->IsGM_GENITEM() ){
		...
		m_pItemCustom->cGenType = EMGEN_DEFAULT;
	}
	...
	/* Item Reform use limit, Juver, 2021/07/22 */
	m_pItemCustom->wReformUseCount = wUseReformCount;

	/* set item option, Juver, 2021/09/01 */
	m_pItemCustom->wSetItemID = wSetOptionID;
