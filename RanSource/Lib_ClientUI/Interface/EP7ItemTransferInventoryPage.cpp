...
const INT CEP7ItemTransferInvenPage::nSTARTLINE = 0;	
const INT CEP7ItemTransferInvenPage::nOUTOFRANGE = -1;

CEP7ItemTransferInvenPage::CEP7ItemTransferInvenPage()
...
void CEP7ItemTransferInvenPage::CreateSubControl()
{
	CString strSlotKeyword[ nMAX_ONE_VIEW_SLOT ] =
	{
		"EP7_ITEM_TRANSFER_INVENTORYSLOT_ITEM_SLOT0",
		"EP7_ITEM_TRANSFER_INVENTORYSLOT_ITEM_SLOT1",
		"EP7_ITEM_TRANSFER_INVENTORYSLOT_ITEM_SLOT2",
		"EP7_ITEM_TRANSFER_INVENTORYSLOT_ITEM_SLOT3",
		"EP7_ITEM_TRANSFER_INVENTORYSLOT_ITEM_SLOT4",
		"EP7_ITEM_TRANSFER_INVENTORYSLOT_ITEM_SLOT5",
		"EP7_ITEM_TRANSFER_INVENTORYSLOT_ITEM_SLOT6",
		"EP7_ITEM_TRANSFER_INVENTORYSLOT_ITEM_SLOT7",
		"EP7_ITEM_TRANSFER_INVENTORYSLOT_ITEM_SLOT8",
		"EP7_ITEM_TRANSFER_INVENTORYSLOT_ITEM_SLOT9",
...
CItemSlotEx* CEP7ItemTransferInvenPage::CreateItemSlot( CString strKeyword, UIGUID ControlID )
{
...
CUIControl*	CEP7ItemTransferInvenPage::CreateControl( const TCHAR* szControl )
{
...
void CEP7ItemTransferInvenPage::Update( INT x, INT y, BYTE LB, BYTE MB, BYTE RB, INT nScroll, FLOAT fElapsedTime, BOOL bFirstControl )
{
...
void CEP7ItemTransferInvenPage::TranslateUIMessage( UIGUID ControlID, DWORD dwMsg )
{
...
void CEP7ItemTransferInvenPage::ResetItemSlotRender ( int nStart, int nEnd )
{
	if ( nEnd < 0 )			return;
...
void CEP7ItemTransferInvenPage::SetItemSlotRender ( int nStart, int nEnd )
{
	if ( nEnd < 0 ) return ;
	if ( nStart > nEnd ) return ;
...
void CEP7ItemTransferInvenPage::SetItemIndex( INT nPosX, INT nPosY )
{
	m_nPosX = nPosX;
	m_nPosY = nPosY;
}

void CEP7ItemTransferInvenPage::GetItemIndex( INT* pnPosX, INT* pnPosY )
{
	*pnPosX = m_nPosX;
	*pnPosY = m_nPosY;
}

void CEP7ItemTransferInvenPage::LoadItemPage( GLInventory &ItemData )
{
...
void CEP7ItemTransferInvenPage::LoadItem( SINVENITEM& ref_InvenItem )
{	
...
void CEP7ItemTransferInvenPage::UnLoadItemPage()
{
...
void CEP7ItemTransferInvenPage::UnLoadItem( INT nPosX, INT nPosY )
{
	m_pItemSlotArray[ nPosY ]->ResetItemImage( nPosX );
}

void CEP7ItemTransferInvenPage::ResetAllFlipItem()
{
	for( WORD y=0; y<EM_INVENSIZE_Y; ++y )
		for( WORD x=0; x<EM_INVENSIZE_X; ++x )
...
void CEP7ItemTransferInvenPage::UpdateFlipItem( GLInventory& ref_Inventory )
{
	ResetAllFlipItem();
...
void CEP7ItemTransferInvenPage::UpdateFlipItem( SINVEN_POS& ref_GarbageItem )
{
...
void CEP7ItemTransferInvenPage::UpdateBLOCK()
{
...
SINVENITEM& CEP7ItemTransferInvenPage::GetItem( INT nPosX, INT nPosY )
{
	return m_pItemSlotArray[ nPosY ]->GetItemImage( nPosX );
}

void CEP7ItemTransferInvenPage::SetOneViewSlot( const INT& nMAX_ONE_VIEW )
{
