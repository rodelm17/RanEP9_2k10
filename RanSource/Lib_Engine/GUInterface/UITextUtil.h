...
namespace	NS_UITEXTUTIL
{
	...
	const DWORD MINTCREAM	= D3DCOLOR_ARGB(0xFF,0xF5,0xFF,0xFA);
	const DWORD LIGHTGREEN	= D3DCOLOR_ARGB(0xFF,0x92,0xD0,0x50);
	const DWORD ORENGE		= D3DCOLOR_ARGB(0xFF,0xFF,0xC0,0x00);
