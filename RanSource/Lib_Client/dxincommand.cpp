...
#include "./G-Logic/UserTypeDefine.h"
...
#include "./G-Logic/GLLandManClient.h"
...
namespace dxincommand
{
	...
	bool command ( const char* szcommand, SITEMLINK* pItemLink ) 
	{
		...
		if ( dwUSERLVL == NSUSER_TYPE::USER_TYPE_GM4 )
		{
			if ( szcommand[0]=='&' )
			{
		...
		else if ( strCOMMAND=="/pvp" )
        {

            if ( strArray.GetSize() != 2 )
            {
                CInnerInterface::GetInstance().PrintConsoleText ( "pvp : invalid param" );
                return true;
            }

            CString strPARAM_02 = strArray.GetAt(1);
            GLMSG::SNET_GM_PVP_CONTROL pNetMsg;
            if( strPARAM_02 == "tw" )
            {
                pNetMsg.emType = PVP_CONTROL_TYPE_TW;
                NETSEND ( &pNetMsg );
            }
            else if( strPARAM_02 == "sw" )
            {
                pNetMsg.emType = PVP_CONTROL_TYPE_SW;
                NETSEND ( &pNetMsg );
            }
            else if( strPARAM_02 == "rr" )
            {
                pNetMsg.emType = PVP_CONTROL_TYPE_RR;
                NETSEND ( &pNetMsg );
            }
            else if( strPARAM_02 == "cw" )
            {
                pNetMsg.emType = PVP_CONTROL_TYPE_CW;
                NETSEND ( &pNetMsg );
            }
            else if( strPARAM_02 == "cdm" )
            {
                pNetMsg.emType = PVP_CONTROL_TYPE_CDM;
                NETSEND ( &pNetMsg );
            }
            else if( strPARAM_02 == "ctf" )
            {
                pNetMsg.emType = PVP_CONTROL_TYPE_CTF;
                NETSEND ( &pNetMsg );
            }
            else if( strPARAM_02 == "woe" )
            {
                pNetMsg.emType = PVP_CONTROL_TYPE_WOE;
                NETSEND ( &pNetMsg );
            }
            else CInnerInterface::GetInstance().PrintConsoleText ( "pvp : invalid param" );
        }
		...
		else if ( strCOMMAND== "/item" ) 
		{
			...
			if( strArray.GetSize() == 5 )
			{
				...
				CString strPARAM_03 = strArray.GetAt(3); //num
				CString strPARAM_04 = strArray.GetAt(4); //pass

				WORD wmid = (WORD) atoi ( strPARAM_01.GetString() );
				WORD wsid = (WORD) atoi ( strPARAM_02.GetString() );
				WORD wnum = (WORD) atoi ( strPARAM_03.GetString() );
				std::string strpass = strPARAM_04.GetString();

				GLGaeaClient::GetInstance().GetCharacter()->GMGetItem( wmid, wsid, wnum, strpass );
			}
			else if( strArray.GetSize() == 4 )
			{
				CString strPARAM_01 = strArray.GetAt(1); //mid
		...
		/* additional gm commands, Juver, 2018/03/01 */
		else if ( strCOMMAND== "/get_item_range" ) 
		{
			if ( strArray.GetSize() != 7 &&  strArray.GetSize() != 6  )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "Invalid Command! :P" );
				return true;
			}

			if( strArray.GetSize() == 7 )
			{
				CString strPARAM_01 = strArray.GetAt(1); //mid
				CString strPARAM_02 = strArray.GetAt(2); //sid
				CString strPARAM_03 = strArray.GetAt(3); //mid
				CString strPARAM_04 = strArray.GetAt(4); //sid
				CString strPARAM_05 = strArray.GetAt(5); //pass
				CString strPARAM_06 = strArray.GetAt(6); //amount

				DWORD	dwUPGRADE = 0;
				WORD wMIDSTART = atoi ( strPARAM_01.GetString() );
				WORD wSIDSTART = atoi ( strPARAM_02.GetString() );
				WORD wMIDEND = atoi ( strPARAM_03.GetString() );
				WORD wSIDEND = atoi ( strPARAM_04.GetString() );
				std::string strpass = strPARAM_05.GetString();
				WORD	wAmount	 = (WORD) atoi ( strPARAM_06.GetString() );

				for ( WORD wMID = wMIDSTART; wMID < (wMIDEND+1); ++ wMID )
				{
					for ( WORD wSID = wSIDSTART; wSID < (wSIDEND+1); ++ wSID )
					{
						SNATIVEID	sItemReq;
						sItemReq.wMainID = wMID; 
						sItemReq.wSubID  = wSID;
						GLGaeaClient::GetInstance().GetCharacter()->GMGetItem( sItemReq.wMainID, sItemReq.wSubID, wAmount, strpass.c_str() );
					}
				}
			}
			else if( strArray.GetSize() == 6 )
			{
				CString strPARAM_01 = strArray.GetAt(1); //mid
				CString strPARAM_02 = strArray.GetAt(2); //sid
				CString strPARAM_03 = strArray.GetAt(3); //mid
				...
				for ( WORD wMID = wMIDSTART; wMID < (wMIDEND+1); ++ wMID )
				{
					for ( WORD wSID = wSIDSTART; wSID < (wSIDEND+1); ++ wSID )
					{
						...
						GLGaeaClient::GetInstance().GetCharacter()->GMGetItem( sItemReq.wMainID, sItemReq.wSubID, 1, strpass.c_str() );
					}
				}
			}
		}
		/* additional gm commands, Juver, 2018/03/01 */
		else if ( strCOMMAND== "/get_inven_open" ) 
		{
			if ( strArray.GetSize() != 2 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			CString strPARAM = strArray.GetAt(1); 
			std::string strpass = strPARAM.GetString();
			GLGaeaClient::GetInstance().GetCharacter()->GMInvenOpen( strpass );
		}
		/* additional gm commands, Juver, 2018/03/01 */
		else if ( strCOMMAND== "/get_skill_all" ) 
		{
			if ( strArray.GetSize() != 2 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			CString strPARAM = strArray.GetAt(1); 
			std::string strpass = strPARAM.GetString();
			GLGaeaClient::GetInstance().GetCharacter()->GMGetSkillAll( strpass );
		}
		/* additional gm commands, Juver, 2018/03/01 */
		else if ( strCOMMAND== "/get_skill" ) 
		{
			if ( strArray.GetSize() != 4 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			GLGaeaClient::GetInstance().GetCharacter()->GMGetSkill( wmid, wsid, strpass );
		}
		/* additional gm commands, Juver, 2018/03/02 */
		else if ( strCOMMAND == "/get_level" )
		{
			if ( strArray.GetSize() != 3 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			WORD wLEVEL = (WORD) atoi ( strPARAM_01.GetString() );
			std::string strpass = strPARAM_02.GetString();

			GLGaeaClient::GetInstance().GetCharacter()->GMGetLevel( wLEVEL, strpass );
		}
		/* additional gm commands, Juver, 2018/03/02 */
		else if ( strCOMMAND == "/get_stats" )
		{
			if ( strArray.GetSize() != 3 && strArray.GetSize() != 4 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
				return true;
			}
			...
			if( strArray.GetSize() == 3 )
			{
				...
				EMSTATS emSTAT( EMSIZE );
				WORD wNum = (WORD)atoi ( strPARAM_01.GetString() );
				std::string strpass = strPARAM_02.GetString();
				GLGaeaClient::GetInstance().GetCharacter()->GMGetStat( emSTAT, wNum, strpass );
			}
			else if( strArray.GetSize() == 4 )
			{
				CString strPARAM_01 = strArray.GetAt(1);
				...
				else if ( strPARAM_01 == "dex" )
				{
					emSTAT = EMDEX;
				}
				else if ( strPARAM_01 == "int" )
				{
					emSTAT = EMSPI;
				}
				else if ( strPARAM_01 == "vit" )
				{
					emSTAT = EMSTR;
				}
				else if ( strPARAM_01 == "stm" )
				{
					emSTAT = EMSTA;
				}

				WORD wNum = (WORD)atoi ( strPARAM_02.GetString() );
				std::string strpass = strPARAM_03.GetString();
				GLGaeaClient::GetInstance().GetCharacter()->GMGetStat( emSTAT, wNum, strpass );
			}	
		}
		/* additional gm commands, Juver, 2018/03/02 */
		else if ( strCOMMAND == "/get_statpoint" )
		{
			if ( strArray.GetSize() != 3 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			WORD wNUM = (WORD)  atoi ( strPARAM_01.GetString() );
			std::string strpass = strPARAM_02.GetString();
			GLGaeaClient::GetInstance().GetCharacter()->GMGetStatP( wNUM, strpass );

		}
		/* additional gm commands, Juver, 2018/03/02 */
		else if ( strCOMMAND == "/get_skillpoint" )
		{
			if ( strArray.GetSize() != 3 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			WORD wNUM = (WORD)  atoi ( strPARAM_01.GetString() );
			std::string strpass = strPARAM_02.GetString();
			GLGaeaClient::GetInstance().GetCharacter()->GMGetSkillP( wNUM, strpass );

		}
		/*gm command send item, Juver, 2019/03/23 */
		else if ( strCOMMAND== "/send_item" ) 
		{
			if ( strArray.GetSize() != 5  )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			CString strPARAM_01 = strArray.GetAt(1); //charid
			CString strPARAM_02 = strArray.GetAt(2); //mid
			CString strPARAM_03 = strArray.GetAt(3); //sid
			CString strPARAM_04 = strArray.GetAt(4); //pass

			DWORD dwCharID = (DWORD) atoi ( strPARAM_01.GetString() );
			WORD wMid = (WORD) atoi ( strPARAM_02.GetString() );
			WORD wSid = (WORD) atoi ( strPARAM_03.GetString() );
			std::string strPass = strPARAM_04.GetString();

			GLGaeaClient::GetInstance().GetCharacter()->GMSendItem( dwCharID, wMid, wSid, strPass );
		}
		else if ( strCOMMAND == "/get_crow_time" )
		{
			if ( strArray.GetSize() != 6 && strArray.GetSize() != 4 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
				return true;
			}
			...
			if ( strArray.GetSize() == 6)
			{
				CString strPARAM_01 = strArray.GetAt(1); //mob mid
				CString strPARAM_02 = strArray.GetAt(2); //mob sid
				CString strPARAM_03 = strArray.GetAt(3); //map mid
				CString strPARAM_04 = strArray.GetAt(4); //map sid
				CString strPARAM_05 = strArray.GetAt(5); //pass
				...
				GLGaeaClient::GetInstance().GetCharacter()->GMGetCrowTime( wMobMID, wMobSID, wMapMID, wMapSID, strPass );
			}
			else if ( strArray.GetSize() == 4 )
			{
				CString strPARAM_01 = strArray.GetAt(1); //mob mid
				...
				{
					SNATIVEID nidMAP = pLAND->GetMapID();
					GLGaeaClient::GetInstance().GetCharacter()->GMGetCrowTime( wMobMID, wMobSID, nidMAP.wMainID, nidMAP.wSubID, strPass );
				}
			}
			
		}
		else if ( strCOMMAND == "/contri_event_tw_start" )
		{
			if ( strArray.GetSize() != 3 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			CString strPARAM_01 = strArray.GetAt(1); //multi
			CString strPARAM_02 = strArray.GetAt(2); //pass

			float fMulti  = (float)atof(strPARAM_01.GetString());
			std::string strPass = strPARAM_02.GetString();

			GLGaeaClient::GetInstance().GetCharacter()->GMEventContriTyranny( fMulti, strPass.c_str() );
		}
		else if ( strCOMMAND == "/contri_event_tw_end" )
		{
			if ( strArray.GetSize() != 2 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			GLGaeaClient::GetInstance().GetCharacter()->GMEventContriTyranny( 1.0f, strPass.c_str() );
		}
		else if ( strCOMMAND == "/contri_event_sw_start" )
		{
			if ( strArray.GetSize() != 3 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			GLGaeaClient::GetInstance().GetCharacter()->GMEventContriSchoolWar( fMulti, strPass.c_str() );
		}
		else if ( strCOMMAND == "/contri_event_sw_end" )
		{
			if ( strArray.GetSize() != 2 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			GLGaeaClient::GetInstance().GetCharacter()->GMEventContriSchoolWar( 1.0f, strPass.c_str() );
		}
		else if ( strCOMMAND == "/contri_event_ctf_start" )
		{
			if ( strArray.GetSize() != 3 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			GLGaeaClient::GetInstance().GetCharacter()->GMEventContrinCaptureTheFlag( fMulti, strPass.c_str() );
		}
		else if ( strCOMMAND == "/contri_event_ctf_end" )
		{
			if ( strArray.GetSize() != 2 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			GLGaeaClient::GetInstance().GetCharacter()->GMEventContrinCaptureTheFlag( 1.0f, strPass.c_str() );
		}
		...
		else if ( strCOMMAND == "/restrict" )
		{
			...
			CString strPARAM_01 = strArray.GetAt(1); //charid
			CString strPARAM_02 = strArray.GetAt(2); //on off
			CString strPARAM_03 = strArray.GetAt(3); //pass
			...
			GLGaeaClient::GetInstance().GetCharacter()->GMUserRestrict( dwCharID, bRestrict, strPass );
		}
		/* gm command inven clear, Juver, 2020/05/08 */
		else if ( strCOMMAND == "/inven_clear" )
		{
			if ( strArray.GetSize() != 2 )
			{
				CInnerInterface::GetInstance().PrintConsoleText ( "invalid command!" );
			...
			GLGaeaClient::GetInstance().GetCharacter()->GMInvenClear( strPass );
		}
