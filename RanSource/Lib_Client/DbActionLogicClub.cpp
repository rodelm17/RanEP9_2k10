...
CSetClubBattle::CSetClubBattle(DWORD dwClubP, DWORD dwClubS, __time64_t tStartTime, __time64_t tEndTime, bool bAlliance )
	: m_dwClubP ( dwClubP )
	, m_dwClubS ( dwClubS )
...
{
	return m_pDbManager->SetClubBattle(m_dwClubP, m_dwClubS, m_tStartTime, m_tEndTime, (int)m_bAlliance );
}
