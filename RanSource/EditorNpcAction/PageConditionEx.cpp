...
BOOL CPageCondition::DataUpdate()
{
	...
	SetWin_Combo_Sel( this, IDC_COMBO_VIP_LEVEL, COMMENT::CHAR_VIP[m_DummyCondition.m_emVIPLevel]);

	SetWin_Num_int ( this, IDC_EDIT_REBORN_REQ, m_DummyCondition.m_dwRebornReq );
...
BOOL CPageCondition::DataSave()
{
	...
	m_DummyCondition.m_emVIPLevel = static_cast<EMVIP_LEVEL>( GetWin_Combo_Sel( this, IDC_COMBO_VIP_LEVEL ) );

	m_DummyCondition.m_dwRebornReq = GetWin_Num_int ( this, IDC_EDIT_REBORN_REQ );
