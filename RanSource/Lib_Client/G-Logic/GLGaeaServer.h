...
protected:
	BOOL					m_bUpdate;
	bool					m_bEmulator;
	bool					m_bReservedStop;		// ���� ���� ����

	bool					m_bGenItemHold;
	bool					m_bClubBattleStarted;
	bool					m_bClubDMStarted;		// Ŭ��������ġ ���ۿ���

	//float					m_fMaxDelayMsgProc;		//	�޽��� ó���� �ִ� ���� �ð�.  ( ���� Flip Time )

	DWORD					m_dwMaxClient;
	PGLCHAR*				m_PCArray;				//	PC �迭.
	
	GLCHARLIST				m_GaeaPCList;			//	PC ����Ʈ.
	...
	CMList<DWORD>			m_FreePETGIDs;			//	�̻��� PET GlobID ��.
	VPETID					m_reqDropOutPet;		//  DropOutPet PET GUID

	// Summon
	PGLSUMMONFIELD*			m_SummonArray;
	CMemPool<GLSummonField>	m_poolSummon;
	CMList<DWORD>			m_FreeSummonGIDs;			//	�̻��� SUMMON GlobID ��.
	VSUMMONID				m_reqDropOutSummon;		//  DropOutSummon SUMMON GUID

	GLLandMan*				m_pLandMan[MAXLANDMID][MAXLANDSID];	// ���� ������.
	VEC_LANDMAN				m_vecLandMan;

	VEC_INSTANT_MAPID		m_vecInstantMapId;						// �δ� �� ���̵� ����
	VEC_LANDMAN				m_vecInstantMapSrcLandMan;				// �δ� ���� ��� �� ����

	GLPartyFieldMan			m_cPartyFieldMan;
	GLClubMan				m_cClubMan;

	VPCID					m_reqDropOutChar;		//	dropout ��û.
	
	PCID					m_reqSaveDBUserID;		//	�����û�� userid.
