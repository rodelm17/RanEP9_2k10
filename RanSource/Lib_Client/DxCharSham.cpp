...
HRESULT DxCharSham::SetCharInfo ( const SCHARINFO_LOBBY &CharInfo, const BOOL bThread )
{
	...
	//	Note : �ɸ����� ������ ����.
	StringCchCopy ( GLCHARLOGIC_CLIENT::m_szName, CHAR_SZNAME, m_CharInfo.m_szName );
	GLCHARLOGIC_CLIENT::m_emClass = m_CharInfo.m_emClass;
	GLCHARLOGIC_CLIENT::m_wSchool = m_CharInfo.m_wSchool;
	GLCHARLOGIC_CLIENT::m_wHair = m_CharInfo.m_wHair;
	GLCHARLOGIC_CLIENT::m_wHairColor = m_CharInfo.m_wHairColor;
	GLCHARLOGIC_CLIENT::m_wFace = m_CharInfo.m_wFace;

	GLCHARLOGIC_CLIENT::m_wLevel = m_CharInfo.m_wLevel;
	GLCHARLOGIC_CLIENT::m_sStats = m_CharInfo.m_sStats;

	GLCHARLOGIC_CLIENT::m_fScaleRange = m_CharInfo.m_fScaleRange;
...
//	memcpy ( GLCHARLOGIC::m_PutOnItems, m_CharInfo.m_PutOnItems, sizeof(SITEMCUSTOM)*SLOT_TSIZE );
	...
	{
		GLCHARLOGIC_CLIENT::m_PutOnItems[i].Assign(  m_CharInfo.m_PutOnItems[i] );
	}
