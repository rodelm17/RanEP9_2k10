...
HRESULT DxSetLandMan::Render ( LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	// Note : 조각 파일 렌더링.
	m_sMaterialPie.m_pLightMapDay = m_pTextureLightMapDay;
...
HRESULT DxSetLandMan::Render_EFF ( LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	// Note : 조각 파일 렌더링.
	m_sMaterialPie.m_pLightMapDay = m_pTextureLightMapDay;
	m_PieceManager.RenderAlpha( pd3dDevice, cv, NULL, &m_FrameMesh, NULL, NULL, m_sMaterialPie );
	...
	m_PieceManager.RenderPickAlpha( pd3dDevice, cv, NULL, &m_FrameMesh, NULL, NULL, m_sMaterialPie );
