...
HRESULT POINTLIGHT_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "POINTLIGHT_PROPERTY::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT POINTLIGHT_PROPERTY::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
