...
char		DxEffCharDust::NAME[MAX_PATH]	= "DxEffCharDust";
...
HRESULT	DxEffCharDust::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharDust::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT	DxEffCharDust::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharDust::R2LoadFile", SFile.GetFileName(), dwVer );
