...
enum EMGLMSG
{
	...
	EMGLMSG_CODEX_MAX		= 20, /* Codex, Archie 02/16/24 */
	EMGLMSG_BATTLEPASS_MAX	= 70,	/*12-9-14, Battle Pass - CNDev*/

	EMGLMSG_INVEN_SORT_MAX	= 20,	/*inventory sort, Juver, 2018/07/07 */
	EMGLMSG_DAILYLOGIN_MAX	 = 50,	/*12-16-24, daily login - CNDev*/
};
...
enum EMCHAR_GATEOUT_FB
{
	...
	EMCHAR_GATEOUT_TO_INDEX			= 12,	/* multi gate out, Juver, 2020/11/21 */
};
...
{
	EM_SELFBUFF_FAIL		= 0,
	EM_SELFBUFF_SUCCESS		= 1,
	EM_SELFBUFF_NO_MONEY	= 2,
};
...
enum EMPARTY_LURE_FB
{
	...
	EMPARTY_LURE_BLOCK_MAP_MASTER	= 8,	
	EMPARTY_LURE_BLOCK_MAP_TARGET	= 9,	

	/* pvp club death match, Juver, 2020/11/26 */
	EMPARTY_LURE_OTHER_GUILD		= 10,
};
