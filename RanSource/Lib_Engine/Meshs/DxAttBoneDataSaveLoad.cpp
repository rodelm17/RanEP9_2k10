...
BOOL DxAttBoneData::SaveFile ( const char* szFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	SFile.SetEncodeType( EMRCRYPT_BYTE_TYPE_2021_ATT_BONE_DATA_V1 );
...
BOOL DxAttBoneData::LOAD_Ver_0201( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	//skeleton name
	SFile >> m_strSkeleton;
...
BOOL DxAttBoneData::LoadFile ( const char* szFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread, bool bREPRESH /*=false*/ )
{
	...
	if ( dwVer >= ENCODE_VER_BYTE_CRYPT_2021_ATT_BONE_V1 )
		SFile.SetEncodeType( EMRCRYPT_BYTE_TYPE_2021_ATT_BONE_DATA_V1 );
