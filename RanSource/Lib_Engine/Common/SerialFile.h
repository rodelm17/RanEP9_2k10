...
public:
	...
	virtual void SetEncodeType ( EMRCRYPT_BYTE_TYPE emCryptType );

	BOOL OpenFile ( const FOPENTYPE _Type, const char *_szFileName, EMRCRYPT_BYTE_TYPE emCryptType = EMRCRYPT_BYTE_TYPE_NONE );
...
public:
	virtual void	DumpToDisk( std::string strPATH, std::string strFILE );
	virtual void	DumpToDisk_Increment( std::string strPATH );
...
public:
	virtual BOOL operator << ( D3DXVECTOR2 Value );
	virtual BOOL operator << ( D3DXVECTOR3 Value );
	virtual BOOL operator << ( D3DXVECTOR4 Value );
	virtual BOOL operator << ( D3DXMATRIX Value );
...
public:
	CSerialFile ();
	CSerialFile ( FOPENTYPE _Type, const char *_szFileName, EMRCRYPT_BYTE_TYPE emCryptType = EMRCRYPT_BYTE_TYPE_NONE );
	virtual ~CSerialFile ();
};
