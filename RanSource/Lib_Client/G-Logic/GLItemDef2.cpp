...
EMITEM_TYPE EXITEM_TO_ITEM( EMEXITEM_TYPE _emTYPE )
{
	...
	case EXITEM_REPAIR_TOOLS_LINK_CARD:	return ITEM_REPAIR_TOOLS_LINK_CARD;	break;
	case EXITEM_SEALED_CARD:			return ITEM_SEALED_CARD;	break;
//	case EXITEM_BUFF_CARD:			return ITEM_BUFF_CARD;				break;
	};
