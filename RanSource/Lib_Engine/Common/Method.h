...
protected:
	...
	static void HelpThrow(std::string const& rostrFileIn);
...
public:
	...
	virtual void EncryptFile(std::string const& rostrFileIn, std::string const& rostrFileOut) = 0;
	//Decryption for a File
	virtual void DecryptFile(std::string const& rostrFileIn, std::string const& rostrFileOut) = 0;
...
protected:
	...
	static char const* sm_szErrorMsg1000;
	static char const* sm_szErrorMsg1001;
