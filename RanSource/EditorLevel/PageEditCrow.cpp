...
BOOL CPageEditCrow::OnInitDialog()
{
	...
	char* szColumnName1[nColumnCount] = { "#", "Type", "Val", "Coll" };
	int nColumnWidthPercent[nColumnCount] = { 10, 25, 50, 15 };
...
void CPageEditCrow::InitUI( BOOL bENABLE )
{
	...
	SetWin_Enable( this, IDC_EDIT_EX_1, bENABLE );
	SetWin_Enable( this, IDC_EDIT_EX_2, bENABLE );
	SetWin_Enable( this, IDC_EDIT_EX_3, bENABLE );
	SetWin_Enable( this, IDC_EDIT_EX_4, bENABLE );
	SetWin_Enable( this, IDC_EDIT_EX_5, bENABLE );
	SetWin_Enable( this, IDC_EDIT_EX_6, bENABLE );
	SetWin_Enable( this, IDC_EDIT_EX_7, bENABLE );
	...
	SetWin_Num_float( this, IDC_EDIT_EX_4, 0.0f );

	SetWin_Num_float( this, IDC_EDIT_EX_5, 0.0f );
	SetWin_Num_float( this, IDC_EDIT_EX_6, 0.0f );
	SetWin_Num_float( this, IDC_EDIT_EX_7, 0.0f );
...
void CPageEditCrow::DataShow()
{
	...
	SetWin_Num_int( this, IDC_EDIT_EX_1, m_pEdit->m_dummy_var_1 );
	SetWin_Num_int( this, IDC_EDIT_EX_2, m_pEdit->m_dummy_var_2 );
	SetWin_Num_int( this, IDC_EDIT_EX_3, m_pEdit->m_dummy_var_3 );
	SetWin_Num_float( this, IDC_EDIT_EX_4, m_pEdit->m_dummy_var_4 );

	SetWin_Num_float( this, IDC_EDIT_EX_5, m_pEdit->m_dummy_var_5 );
	SetWin_Num_float( this, IDC_EDIT_EX_6, m_pEdit->m_dummy_var_6 );
	SetWin_Num_float( this, IDC_EDIT_EX_7, m_pEdit->m_dummy_var_7 );
...
BOOL CPageEditCrow::DataSave()
{
	...
	m_pEdit->m_dummy_var_1 = GetWin_Num_int( this, IDC_EDIT_EX_1 );
	m_pEdit->m_dummy_var_2 = GetWin_Num_int( this, IDC_EDIT_EX_2 );
	m_pEdit->m_dummy_var_3 = GetWin_Num_int( this, IDC_EDIT_EX_3 );
	m_pEdit->m_dummy_var_4 = GetWin_Num_float( this, IDC_EDIT_EX_4 );

	m_pEdit->m_dummy_var_5 = GetWin_Num_float( this, IDC_EDIT_EX_5 );
	m_pEdit->m_dummy_var_6 = GetWin_Num_float( this, IDC_EDIT_EX_6 );
	m_pEdit->m_dummy_var_7 = GetWin_Num_float( this, IDC_EDIT_EX_7 );
	...
	if ( m_pEdit->m_bLeaderMonster )
	{
		...
		{
			CDebugSet::MsgBox( "GroupName cannot be empty if crow is leader!" );
			return FALSE;
		}
	}
...
void CPageEditCrow::ShowActions()
{
	...
	for ( int i = 0; pCur; pCur = pCur->pNext, ++i )
	{
		...
		if ( pCur->Data.emAction == EMACTION_MOVE )
		{
			...
			m_pGLLand->GetNavi()->IsCollision( pCur->Data.vPos + D3DXVECTOR3(0,+5,0), pCur->Data.vPos - D3DXVECTOR3(0,+5,0), vStart, dwStartID, bCol );

			if( !bCol )	
				m_List.SetItemText( i, 3, "error" );
		}
...
void CPageEditCrow::OnBnClickedButtonRegnew()
{
	...
	sSched.m_CrowID = pCROW->m_sBasic.sNativeID;
	sSched.m_pAffineParts->vTrans = vPOS; 

	if ( pCROW->m_sBasic.m_emCrow == CROW_MOB )
...
void CPageEditCrow::OnBnClickedButtonBus()
{
	...
	CFileDialog dlg ( TRUE, ".BUSLOC", GLOGIC::GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, szFilter, this );
...
void CPageEditCrow::OnBnClickedButtonRebuild()
{
	...
	if ( !m_pEdit->CheckCollision( m_pGLLand->GetNavi() ) )
		CDebugSet::MsgBox( GetSafeHwnd(), "schedule %s collision error", m_pEdit->m_szName );
}
