...
{
	CFileDialog dlg( TRUE, NULL, DxEffSinglePropGMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, RFILE_DIALOG_FILTERS::strFilterEGP, this );
...
{
	CFileDialog dlg( TRUE, NULL, DxSimpleMeshMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, RFILE_DIALOG_FILTERS::strFilterSkin, this );
