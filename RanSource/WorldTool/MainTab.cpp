...
CMainTab::CMainTab(CRect& rect, LOGFONT logfont, CWnd* pParentWnd)
	...
	m_pFont ( NULL )
{
	...
	m_PageWLD.m_psp.dwFlags |= PSP_USETITLE;
	m_PageWLD.m_psp.pszTitle = "LandMan";

	m_PagePIE.m_psp.dwFlags |= PSP_USETITLE;
	m_PagePIE.m_psp.pszTitle = "Piece";


	m_PageWLD.SetSheetTab ( this );
...
HBRUSH CMainTab::CtlColor(CDC* pDc, UINT uCtlColor) 
{
...
void CMainTab::ChangeDialogFont(CWnd* pWnd, CFont* pFont, int nFlag)
{
	CRect windowRect;
