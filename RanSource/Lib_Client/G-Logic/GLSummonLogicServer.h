...
struct GLSUMMONLOGIC_SERVER
{
	...
	GLSUMMONLOGIC_SERVER ( const GLSUMMONLOGIC_SERVER& value ) { operator=( value ); }
	GLSUMMONLOGIC_SERVER& operator= ( const GLSUMMONLOGIC_SERVER& rvalue );
	...
	void ASSIGN ( const GLSUMMONLOGIC_SERVER& sSummonData );
	void RESET ();
...
typedef GLSUMMONLOGIC_SERVER* PGLSUMMON_LOGIC_SERVER;
