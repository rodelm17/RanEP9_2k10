...
public:
	...
	{
		CDM_BATTLE_NOSTART		= 0,
		CDM_BATTLE_READY		= 1,
		CDM_BATTLE_START		= 2,
		CDM_BATTLE_END_AWARD	= 3,
		CDM_BATTLE_END			= 4,
	};
...
public:
	bool IsBattle () { return ( m_emBattleState == CDM_BATTLE_START ); }
	bool IsBattleReady() { return ( m_emBattleState == CDM_BATTLE_READY ); }
	bool IsBattleEndAward() { return ( m_emBattleState == CDM_BATTLE_END_AWARD); }
	bool IsBattleEnd() { return ( m_emBattleState == CDM_BATTLE_END ); }
