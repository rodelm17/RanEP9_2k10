...
void CPageCondition::DataShow()
{
	...
	SetWin_Check( this, IDC_CHECK_DUMMY_VAR1, pREQ->m_dummy_var1 );

	SetWin_Num_int( this, IDC_EDIT_REQ_MID_UNKNOWN_1, pREQ->unknown_var1.wMainID );
	SetWin_Num_int( this, IDC_EDIT_REQ_SID_UNKNOWN_1, pREQ->unknown_var1.wSubID );
	SetWin_Num_int( this, IDC_EDIT_REQ_MID_UNKNOWN_2, pREQ->unknown_var2.wMainID );
	SetWin_Num_int( this, IDC_EDIT_REQ_SID_UNKNOWN_2, pREQ->unknown_var2.wSubID );
	SetWin_Num_int( this, IDC_EDIT_REQ_MID_UNKNOWN_3, pREQ->unknown_var3.wMainID );
	SetWin_Num_int( this, IDC_EDIT_REQ_SID_UNKNOWN_3, pREQ->unknown_var3.wSubID );
	SetWin_Num_int( this, IDC_EDIT_REQ_MID_UNKNOWN_4, pREQ->unknown_var4.wMainID );
	SetWin_Num_int( this, IDC_EDIT_REQ_SID_UNKNOWN_4, pREQ->unknown_var4.wSubID );
}
...
BOOL CPageCondition::DataSave()
{
	...
	pREQ->m_dummy_var1 = ( GetWin_Check( this, IDC_CHECK_DUMMY_VAR1 ) == TRUE );
	...
	pREQ->unknown_var1.wMainID = GetWin_Num_int( this, IDC_EDIT_REQ_MID_UNKNOWN_1 );
	pREQ->unknown_var1.wSubID = GetWin_Num_int( this, IDC_EDIT_REQ_SID_UNKNOWN_1 );
	pREQ->unknown_var2.wMainID = GetWin_Num_int( this, IDC_EDIT_REQ_MID_UNKNOWN_2 );
	pREQ->unknown_var2.wSubID = GetWin_Num_int( this, IDC_EDIT_REQ_SID_UNKNOWN_2 );
	pREQ->unknown_var3.wMainID = GetWin_Num_int( this, IDC_EDIT_REQ_MID_UNKNOWN_3 );
	pREQ->unknown_var3.wSubID = GetWin_Num_int( this, IDC_EDIT_REQ_SID_UNKNOWN_3 );
	pREQ->unknown_var4.wMainID = GetWin_Num_int( this, IDC_EDIT_REQ_MID_UNKNOWN_4 );
	pREQ->unknown_var4.wSubID = GetWin_Num_int( this, IDC_EDIT_REQ_SID_UNKNOWN_4 );
