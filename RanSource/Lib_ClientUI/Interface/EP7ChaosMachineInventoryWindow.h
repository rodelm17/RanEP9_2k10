/*!
 * \file EP7ChaosMachineInventoryWindow.h
 *
 * \author Juver
 * \date 2021/07/08
 *
...
#ifndef EP7CHAOSMACHINEINVENTORYWINDOW_H_INCLUDED__
#define EP7CHAOSMACHINEINVENTORYWINDOW_H_INCLUDED__
...
class CEP7ChaosMachineInvenPage;
class CMultiModeButton;

#define EP7_CHAOS_MACHINE_INVEN_DEFAULT_VIEW 10

class CEP7ChaosMachineInvenWindow : public CUIWindowEx	
{
protected:
	enum
	{
...
private:
	CEP7ChaosMachineInvenPage*	m_pPage;
...
public:
	CEP7ChaosMachineInvenWindow();
	virtual	~CEP7ChaosMachineInvenWindow();
...
#endif // EP7CHAOSMACHINEINVENTORYWINDOW_H_INCLUDED__