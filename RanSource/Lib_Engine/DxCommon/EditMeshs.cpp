...
namespace EDITMESHS
{
	...
	void RENDERAABB ( LPDIRECT3DDEVICEQ pd3dDevice, D3DXVECTOR3 &vMax, D3DXVECTOR3 &vMin, DWORD dwColor/*=0xffffffff*/ )
	{
		...
		DWORD OldColorArg;
		DWORD OldColorOP;
		pd3dDevice->GetTextureStageState( 0, D3DTSS_COLORARG2, &OldColorArg );
		pd3dDevice->GetTextureStageState( 0, D3DTSS_COLOROP, &OldColorOP );
		...
		pd3dDevice->SetTextureStageState( 0, D3DTSS_COLORARG2,	OldColorArg );
		pd3dDevice->SetTextureStageState( 0, D3DTSS_COLOROP,	OldColorOP );
	...
	void RENDERSPHERE ( LPDIRECT3DDEVICEQ pd3dDevice, D3DXMATRIX matPos, float fScale, DWORD dwColor/*=0xffffffff*/ )
	{
		RENDERSPHERE( pd3dDevice, D3DXVECTOR3( matPos._41, matPos._42, matPos._43 ), fScale, NULL, dwColor );
	}
