...
CGameItemShopPageTypeBase::CGameItemShopPageTypeBase ()
	: m_pImageBase(NULL)
	, m_pImageSelect(NULL)
	, m_pImageOver(NULL)
{
...
void CGameItemShopPageTypeBase::CreateSubControl ( std::string strbase, std::string strselect, std::string strover )
{
...
void CGameItemShopPageTypeBase::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
...
void CGameItemShopPageTypeBase::SetSelect( BOOL bSelect )
{
	if ( m_pImageSelect )
