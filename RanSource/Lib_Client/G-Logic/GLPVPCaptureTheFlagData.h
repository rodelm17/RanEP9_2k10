...
struct CAPTURE_THE_FLAG_PLAYER_HASH_DATA
{
	DWORD dwCharID;
	std::string strHash;

	CAPTURE_THE_FLAG_PLAYER_HASH_DATA()
		: dwCharID(CAPTURE_THE_FLAG_PLAYER_NULL)
		, strHash("")
	{
	}
...
/* PVPCaptureTheFlag hash check, Juver, 2021/07/18 */
typedef std::vector<CAPTURE_THE_FLAG_PLAYER_HASH_DATA>				CAPTURE_THE_FLAG_PLAYER_HASH_DATA_VEC;
typedef std::map<std::string, CAPTURE_THE_FLAG_PLAYER_HASH_DATA>	CAPTURE_THE_FLAG_PLAYER_HASH_DATA_MAP;
typedef CAPTURE_THE_FLAG_PLAYER_HASH_DATA_MAP::iterator				CAPTURE_THE_FLAG_PLAYER_HASH_DATA_MAP_ITER;
