...
void GLITEMLMT::SetItemGenNum ( const SNATIVEID &sNID, EMITEMGEN emTYPE, LONGLONG lnMax )
{
	...
	switch ( emTYPE )
	{
	case EMGEN_DEFAULT:					sLMT.lnDEFAULT = lnMax;			break;
	case EMGEN_INIT:					sLMT.lnINIT = lnMax;			break;
	case EMGEN_SHOP:					sLMT.lnSHOP = lnMax;			break;
	case EMGEN_NPC:						sLMT.lnNPC = lnMax;				break;
	case EMGEN_QUEST:					sLMT.lnQUEST = lnMax;			break;
	case EMGEN_MOB:						sLMT.lnMOB = lnMax;				break;
	case EMGEN_GMEDIT:					sLMT.lnGM = lnMax;				break;
	case EMGEN_OLD:						sLMT.lnOLD = lnMax;				break;
	case EMGEN_BILLING:					sLMT.lnBILLING = lnMax;			break;
	case EMGEN_ITEMMIX:					sLMT.lnItemMix = lnMax;			break;
	case EMGEN_GATHERING:				sLMT.lnGather = lnMax;			break;
	case EMGEN_SYSTEM:					sLMT.lnSystem = lnMax;			break;
	case EMGEN_ACTION_SYSTEM:			sLMT.lnActionSystem = lnMax;	break;
	case EMGEN_ACTION_USER:				sLMT.lnActionUser = lnMax;		break;
	case EMGEN_PVP_EVENT_REWARD:		sLMT.lnPVPEvent = lnMax;		break;
	};
...
LONGLONG GLITEMLMT::GetItemGenNum ( const SNATIVEID &sNID, EMITEMGEN emTYPE )
{
	...
	if ( iter!=m_mapGENITEM.end() )
	{
		...
		case EMGEN_ITEMMIX:				return sLMT.lnItemMix;
		case EMGEN_GATHERING:			return sLMT.lnGather;
		case EMGEN_SYSTEM:				return sLMT.lnSystem;
		case EMGEN_ACTION_SYSTEM:		return sLMT.lnActionSystem;
		case EMGEN_ACTION_USER:			return sLMT.lnActionUser;
		case EMGEN_PVP_EVENT_REWARD:	return sLMT.lnPVPEvent;
...
LONGLONG GLITEMLMT::RegItemGen ( const SNATIVEID &sNID, EMITEMGEN emTYPE /*=EMGEN_DEFAULT*/ )
{
	...
	case EMGEN_ACTION_SYSTEM:
		lnCOUNT = ++sLMT.lnActionSystem;
		break;

	case EMGEN_ACTION_USER:
		lnCOUNT = ++sLMT.lnActionUser;
		break;

	case EMGEN_PVP_EVENT_REWARD:
		lnCOUNT = ++sLMT.lnPVPEvent;
		break;
	};
...
inline bool IsLOG_PILE_ITEM ( EMITEM_TYPE emTYPE )
{
	...
	case ITEM_NONDROP_CARD:					

		/*change scale card, Juver, 2018/01/03 */
	case ITEM_CHANGE_SCALE_CARD:			

		/*item wrapper, Juver, 2018/01/11 */
	case ITEM_WRAPPER:						

		/*change school card, Juver, 2018/01/12 */
	case ITEM_CHANGE_SCHOOL:				

		/* personal lock system, Juver, 2019/12/06 */
	case ITEM_PERSONAL_LOCK_ENABLE:	
	case ITEM_PERSONAL_LOCK_RESET:
	case ITEM_PERSONAL_LOCK_CHANGE_PIN:
	case ITEM_PERSONAL_LOCK_RECOVER_PIN:

		/*item transfer card, Juver, 2018/01/18 */
	case ITEM_TRANSFER_CARD:				

		/*item random option rebuild, Juver, 2018/07/02 */
	case ITEM_SEALED_CARD:		

		/*item random option rebuild, Juver, 2018/07/02 */
	case ITEM_RANDON_OPTION_REBUILD:		
