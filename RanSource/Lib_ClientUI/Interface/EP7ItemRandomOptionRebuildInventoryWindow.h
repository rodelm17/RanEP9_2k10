/*!
 * \file EP7ItemRandomOptionRebuildInventoryWindow.h
 *
 * \author Juver
 * \date July 2018
 *
...
class CEP7ItemRandomOptionRebuildInventoryPage;
class CMultiModeButton;

#define EP7_ITEM_RANDOM_OPTION_REBUILD_INVEN_DEFAULT_VIEW 10

class CEP7ItemRandomOptionRebuildInventoryWindow : public CUIWindowEx	
{
protected:
	enum
	{
...
private:
	CEP7ItemRandomOptionRebuildInventoryPage*	m_pPage;
...
public:
	CEP7ItemRandomOptionRebuildInventoryWindow();
	virtual	~CEP7ItemRandomOptionRebuildInventoryWindow();
