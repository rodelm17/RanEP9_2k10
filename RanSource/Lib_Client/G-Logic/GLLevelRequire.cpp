...
VOID SLEVEL_REQUIRE::SaveCsvHead( std::fstream &SFile )
{
	...
	SFile << "Entry Req dummy var1" << ",";

	SFile << "Entry Req unknown_var1_MID" << ",";
	SFile << "Entry Req unknown_var1_SID" << ",";
	SFile << "Entry Req unknown_var2_MID" << ",";
	SFile << "Entry Req unknown_var2_SID" << ",";
	SFile << "Entry Req unknown_var3_MID" << ",";
	SFile << "Entry Req unknown_var3_SID" << ",";
	SFile << "Entry Req unknown_var4_MID" << ",";
...
VOID SLEVEL_REQUIRE::SaveCsv( std::fstream &SFile )
{
	...
	SFile << unknown_var1.wMainID << ",";
	SFile << unknown_var1.wSubID << ",";
	SFile << unknown_var2.wMainID << ",";
	SFile << unknown_var2.wSubID << ",";
	SFile << unknown_var3.wMainID << ",";
	SFile << unknown_var3.wSubID << ",";
	SFile << unknown_var4.wMainID << ",";
...
void SLEVEL_REQUIRE::LOAD_0105 ( basestream &SFile, DWORD dwSIZE )
{
	...
	SFile >> unknown_var1.dwID;
	SFile >> unknown_var2.dwID;
