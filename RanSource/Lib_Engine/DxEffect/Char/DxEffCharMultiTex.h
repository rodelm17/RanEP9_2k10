...
struct EFFCHAR_PROPERTY_MULTITEX_100_1
{
	...
	{
		SecureZeroMemory( m_szTex1, sizeof(char)*MAX_PATH );
		SecureZeroMemory( m_szTex2, sizeof(char)*MAX_PATH );
...
struct EFFCHAR_PROPERTY_MULTITEX_103_104_105		// Ver.103,104_105
{
	DWORD			m_dwFlag;
	DWORD			m_dwMaterials;
	int				m_nBlend;
	...
	EFFCHAR_PROPERTY_MULTITEX_103_104_105()
	{
		SecureZeroMemory( m_szTex1, sizeof(char)*MAX_PATH );
		SecureZeroMemory( m_szTex2, sizeof(char)*MAX_PATH );
		SecureZeroMemory( m_szTexture, sizeof(char)*MAX_PATH );
...
struct EFFCHAR_PROPERTY_MULTITEX : public EFFCHAR_PROPERTY
{
	DWORD			m_dwFlag;
	DWORD			m_dwMaterials;
	char			m_szTex1[MAX_PATH];
