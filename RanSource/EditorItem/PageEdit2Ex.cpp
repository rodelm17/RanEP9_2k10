...
BOOL CPageEdit2::DataShow ()
{
	...
	SetWin_Num_int ( this, IDC_EDIT_DRUG_DUMMY_1, m_pDummyItem->sDrugOp.unknown_var_1 );
	SetWin_Num_int ( this, IDC_EDIT_DRUG_DUMMY_2, m_pDummyItem->sDrugOp.unknown_var_2 );
	SetWin_Num_int ( this, IDC_EDIT_DRUG_DUMMY_3, m_pDummyItem->sDrugOp.unknown_var_3 );
	SetWin_Num_int ( this, IDC_EDIT_DRUG_DUMMY_4, m_pDummyItem->sDrugOp.unknown_var_4 );
...
BOOL CPageEdit2::DataSave()
{
	...
	m_pDummyItem->sDrugOp.unknown_var_1 = GetWin_Num_int ( this, IDC_EDIT_DRUG_DUMMY_1 );
	m_pDummyItem->sDrugOp.unknown_var_2 = GetWin_Num_int ( this, IDC_EDIT_DRUG_DUMMY_2 );
	m_pDummyItem->sDrugOp.unknown_var_3 = GetWin_Num_int ( this, IDC_EDIT_DRUG_DUMMY_3 );
	m_pDummyItem->sDrugOp.unknown_var_4 = GetWin_Num_int ( this, IDC_EDIT_DRUG_DUMMY_4 );
