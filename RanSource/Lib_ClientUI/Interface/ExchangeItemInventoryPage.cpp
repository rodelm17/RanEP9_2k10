...
const INT CExchangeItemInventoryPage::nSTARTLINE = 0;	
const INT CExchangeItemInventoryPage::nOUTOFRANGE = -1;

CExchangeItemInventoryPage::CExchangeItemInventoryPage()
	: m_pScrollBar( NULL )
...
void CExchangeItemInventoryPage::CreateSubControl()
{
	CString strSlotKeyword[ nMAX_ONE_VIEW_SLOT ] =
	{
		"EXCHANGE_ITEM_INVENSLOT_ITEM_SLOT0",
		"EXCHANGE_ITEM_INVENSLOT_ITEM_SLOT1",
		"EXCHANGE_ITEM_INVENSLOT_ITEM_SLOT2",
		"EXCHANGE_ITEM_INVENSLOT_ITEM_SLOT3",
		"EXCHANGE_ITEM_INVENSLOT_ITEM_SLOT4",
		"EXCHANGE_ITEM_INVENSLOT_ITEM_SLOT5",
		"EXCHANGE_ITEM_INVENSLOT_ITEM_SLOT6",
		"EXCHANGE_ITEM_INVENSLOT_ITEM_SLOT7",
		"EXCHANGE_ITEM_INVENSLOT_ITEM_SLOT8",
		"EXCHANGE_ITEM_INVENSLOT_ITEM_SLOT9",
	};
...

	{
		...
		m_pScrollBar->CreateBaseScrollBar( "EXCHANGE_ITEM_INVEN_PAGE_SCROLL" );
...
CItemSlotEx* CExchangeItemInventoryPage::CreateItemSlot( CString strKeyword, UIGUID ControlID )
{
...
CUIControl*	CExchangeItemInventoryPage::CreateControl( const TCHAR* szControl )
{
...
void CExchangeItemInventoryPage::Update( INT x, INT y, BYTE LB, BYTE MB, BYTE RB, INT nScroll, FLOAT fElapsedTime, BOOL bFirstControl )
{
...
void CExchangeItemInventoryPage::TranslateUIMessage( UIGUID ControlID, DWORD dwMsg )
{
...
void CExchangeItemInventoryPage::ResetAllItemSlotRender( INT nTotal )
{
	if( nTotal < 0 )
		return;
...
void CExchangeItemInventoryPage::SetItemSlotRender( INT nStartIndex, INT nTotal )
{
	if( nTotal < 0 )
		return;
...
void CExchangeItemInventoryPage::SetItemIndex( INT nPosX, INT nPosY )
{
	m_nPosX = nPosX;
	m_nPosY = nPosY;
}

void CExchangeItemInventoryPage::GetItemIndex( INT* pnPosX, INT* pnPosY )
{
	*pnPosX = m_nPosX;
	*pnPosY = m_nPosY;
}

void CExchangeItemInventoryPage::LoadItemPage( GLInventory &ItemData )
{
...
void CExchangeItemInventoryPage::LoadItem( SINVENITEM& ref_InvenItem )
{	
...
void CExchangeItemInventoryPage::UnLoadItemPage()
{
...
void CExchangeItemInventoryPage::UnLoadItem( INT nPosX, INT nPosY )
{
	m_pItemSlotArray[ nPosY ]->ResetItemImage( nPosX );
}

void CExchangeItemInventoryPage::ResetAllFlipItem()
{
	for( WORD y=0; y<EM_INVENSIZE_Y; ++y )
		for( WORD x=0; x<EM_INVENSIZE_X; ++x )
...
void CExchangeItemInventoryPage::UpdateFlipItem( GLInventory& ref_Inventory )
{
	ResetAllFlipItem();
...
void CExchangeItemInventoryPage::UpdateFlipItem( SINVEN_POS& ref_GarbageItem )
{
...
void CExchangeItemInventoryPage::UpdateBLOCK()
{
...
SINVENITEM& CExchangeItemInventoryPage::GetItem( INT nPosX, INT nPosY )
{
	return m_pItemSlotArray[ nPosY ]->GetItemImage( nPosX );
}

void CExchangeItemInventoryPage::SetOneViewSlot( const INT& nMAX_ONE_VIEW )
{
