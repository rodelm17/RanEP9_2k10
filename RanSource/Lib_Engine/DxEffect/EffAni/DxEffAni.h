...
class DxAttBone; /*ABL system, Juver, 2017/05/29 */
...
public:
	...
	virtual HRESULT	Render( const LPDIRECT3DDEVICEQ pd3dDevice, DxAttBone* pAttBone, const D3DXMATRIX& matCurPos ) = 0;
	virtual HRESULT	Render( const LPDIRECT3DDEVICEQ pd3dDevice, DxAttBoneRender* pAttBone, const D3DXMATRIX& matCurPos ) = 0;

	/*vehicle system, Juver, 2017/08/02 */
	virtual HRESULT	Render( const LPDIRECT3DDEVICEQ pd3dDevice, DxVehicle* pVehicle, const D3DXMATRIX& matCurPos ) = 0;
