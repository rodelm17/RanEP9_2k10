...
BOOL CEditorQuestDlg::DoSave ()
{
	...
	CFileDialog dlg( FALSE, ".qst", GLQuestMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, szFilter, this);
...
{
	CString szFilter = "Quest List File (*.lst)|*.lst|";
	CFileDialog dlg( TRUE, ".qst", GLQuestMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, szFilter, this );
...
{
	CFileDialog dlg( TRUE, ".csv", GLQuestMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, "csv file (*.csv)|*.csv|", this );
...
{
	CFileDialog dlg( FALSE, ".csv", GLQuestMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, "csv file (*.csv)|*.csv|", this );
...
{
	CFileDialog dlg( TRUE, ".txt", GLQuestMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, "txt file (*.txt)|*.txt|", this );
...
{
	CFileDialog dlg( FALSE, ".txt", GLQuestMan::GetInstance().GetPath(), OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT, "text file (*.txt)|*.txt|", this );
