...
void CPVPCaptureTheFlagPageBattle::SetCompetitionJoin( bool bEnable )
{
	if ( m_pButtonRegister1 )
		m_pButtonRegister1->SetVisibleSingle( bEnable );

	if ( m_pButtonRegister2 )
		m_pButtonRegister2->SetVisibleSingle( bEnable );
}