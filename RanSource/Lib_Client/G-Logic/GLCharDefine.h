...
#define PK_STREAK_SIZE 15 // 15 /* PK Streak Sigaw - Jxyy */

#define MAX_RV_PREVIEW_COOLTIME 4.0f
...
struct SBATTLE_RANKING
{
	...
	SBATTLE_RANKING()
		...
		, wDead(0)
	{
		SecureZeroMemory(szChaName, sizeof(char) * CHAR_SZNAME);
	}
};
typedef std::map<DWORD, SBATTLE_RANKING>	MAP_BATTLE_RANKING;
typedef MAP_BATTLE_RANKING::iterator		MAP_BATTLE_RANKING_ITER;
typedef std::vector<SBATTLE_RANKING>		VEC_BATTLE_RANKING;
typedef VEC_BATTLE_RANKING::iterator		VEC_BATTLE_RANKING_ITER;

struct SCW_RANKING_REWARD
{
...
struct SCHARSTATS
{
	...
	BOOL isOverFlow()
	{
		...
		if ( dwSUM_STATS > 0xffff )	return TRUE;
...
enum EMACTIONTYPE
{
	...
	GLAT_SKILL_PUSH_PULL	= 9,		/* push skill logic, Juver, 2020/12/14 */	/* pull skill logic, Juver, 2020/12/14 */
	GLAT_SKILL_DASH			= 10,		/*dash skill logic, Juver, 2017/06/17 */

	//insert new enum before GLAT_FALLING 
	GLAT_FALLING	= 11,
	GLAT_DIE		= 12,
...
enum EMIMPACT_TAR
{
	...
	TAR_ZONE		= 3,		//	위치 영향.
	TAR_SPECIFIC	= 4,		/*specific skill target, Juver, 2018/08/27 */
...
enum EMSPEC_ADDON
{
	...
	EMSPECA_SKILL_DASH		= 15,	/* dash skill logic, Juver, 2020/12/14 */

	/* skill turn/find invisible, Juver, 2020/04/25 */
	EMSPECA_TURN_INVISIBLE			= 16,
	EMSPECA_SHOW_INVISIBLE			= 17,
	...
	EMSPECA_PULL					= 28, /* pull skill logic, Juver, 2020/12/14 */
	EMSPECA_PUSH					= 29, /* push skill logic, Juver, 2020/12/14 */
	...
	EMSPECA_ITEMDROP_RATE		= 37, /*item drop rate buff, Juver, 2018/07/01 */
	EMSPECA_MONEYDROP_RATE		= 38, /*gold drop buff, Juver, 2018/07/01 */
	EMSPECA_GETEXP_RATE			= 39, /*exp rate buff, Juver, 2018/07/01 */
	EMSPECA_TALK_TO_NPC			= 40, /*npc talk buff, Juver, 2017/10/03 */
	EMSPECA_SPECIAL_ITEM_DROP	= 41, /*special item drop buff, Juver, 2018/07/01 */

	EMSPECA_TELEPORT			= 42, /*skill teleport, Juver, 2018/09/06 */
	EMSPECA_POSITION_SHIFT		= 43, /*skill position shift, Juver, 2018/09/06 */
	EMSPECA_AMPLIFY				= 44, /* skill amplify, Juver, 2020/12/09 */
	EMSPECA_ILLUSION			= 45, /* skill illusion, Juver, 2021/01/17 */
	EMSPECA_VEHICLE_OFF			= 46, /*skill vehicle off, Juver, 2018/09/07 */
	EMSPECA_DURATION_CHANGE		= 47, /* skill buff duration change, Juver, 2020/12/16 */
	EMSPECA_STIGMA				= 48, /* skill stigma, Juver, 2020/12/11 */
	EMSPECA_TRANSFORM			= 49, /*skill transform, Juver, 2018/09/08 */
	EMSPECA_EFFECT_RELEASE		= 50, /* skill effect release, Juver, 2020/04/30 */
	EMSPECA_DAMAGE_LOOP			= 51, //get attacker hp delta ( max-now ) and transfer as damage to target //when target is mob act as hp steal
	EMSPECA_PET_OFF				= 52, /*skill pet off, Juver, 2018/09/07 */
	EMSPECA_IMMUNE				= 53, /* immune skill logic, Juver, 2020/12/24 */
	EMSPECA_HOSTILE_ON			= 54, /* skill hostile, Juver, 2020/12/16 */
	EMSPECA_HOSTILE_OFF			= 55, /* skill hostile, Juver, 2020/12/16 */
...
enum EMSKILLCLASS
{
	...
	EMSKILL_SHAPER_TRANSFORM_01	=	65,
	EMSKILL_SHAPER_TRANSFORM_02	=	66,
	EMSKILL_SHAPER_TRANSFORM_03	=	67,
	EMSKILL_SHAPER_TRANSFORM_04	=	68,
...
enum EMETCFUNC
{
	...
	EMETCFUNC_NORESPAWN	  = 6,	/*no respawn, Juver, 2018/06/29 */
	EMETCFUNC_UNKNOWN2	  = 7,
...
enum EMLANDEFFECT_TYPE
{
	...
	EMLANDEFFECT_NON_VEND		= 10,	/* non vend area, Juver, 2021/01/17 */

	EMLANDEFFECT_SIZE			= 11,	//	세이프 존
...
struct SPARTY_OPT
{
	...
	bool bPrivateParty;				/* party finder, Juver, 2020/01/11 */

	SPARTY_OPT () 
		: emGET_ITEM(EMPTYITEMOPT_DEFAULT)
		, emGET_MONEY(EMPTYMONEYOPT_DEFAULT)
		, bPrivateParty(false)		/* party finder, Juver, 2020/01/11 */
	{
	}
	...
	bool operator!= ( const SPARTY_OPT &rvalue ) const
	{
		...
		if ( bPrivateParty!=rvalue.bPrivateParty )	return true;		/* party finder, Juver, 2020/01/11 */
	...
	bool operator== ( const SPARTY_OPT &rvalue ) const
	{
		...
		if ( bPrivateParty!=rvalue.bPrivateParty )	return false;		/* party finder, Juver, 2020/01/11 */
...
enum EMSKILL_PURCHASE_CHECK
{
	EMSKILL_PURCHASE_CHECK_FAIL = 0,
	EMSKILL_PURCHASE_CHECK_OK	= 1,
	EMSKILL_PURCHASE_CHECK_REQUIRE = 2
};
