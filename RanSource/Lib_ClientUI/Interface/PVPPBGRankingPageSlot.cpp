...
CPVPPBGRankingPageSlot::CPVPPBGRankingPageSlot ()
	: m_pTextRank(NULL)
	, m_pTextName(NULL)
	, m_pTextKill(NULL)
	, m_pTextDeath(NULL)
...
void CPVPPBGRankingPageSlot::CreateSubControl( BOOL bSelf )
{
	m_bSelf = bSelf;
	...
	m_pTextKill->CreateSub ( this, "PVP_PBG_RESULT_TEXT_BASE_KILL" );
	...
	m_pTextDeath->CreateSub ( this, "PVP_PBG_RESULT_TEXT_BASE_DEATH" );
	...
	m_pTextResu->CreateSub ( this, "PVP_PBG_RESULT_TEXT_BASE_REBIRTH" );
	...
	m_pTextHeal->CreateSub ( this, "PVP_PBG_RESULT_TEXT_BASE_HEAL" );
	...
	m_pTextScore->CreateSub ( this, "PVP_PBG_RESULT_TEXT_BASE_SCORE" );
	...
	m_pTextPoint->CreateSub ( this, "PVP_PBG_RESULT_TEXT_BASE_CONTRIBUTION" );
...
void CPVPPBGRankingPageSlot::ResetData()
{
...
void CPVPPBGRankingPageSlot::SetData( PVPPBG::PLAYER_DATA* pData )
{
	ResetData();
