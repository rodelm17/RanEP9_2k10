...
public:
	...
	afx_msg void OnBnClickedUserlogloginButtonReadHwid();
	afx_msg void OnBnClickedUserlogloginButtonReadMac();
	afx_msg void OnBnClickedUserlogloginButtonClear();
	afx_msg void OnBnClickedCancel();
	

	afx_msg void OnNMClickListLoglogin(NMHDR *pNMHDR, LRESULT *pResult);
};
