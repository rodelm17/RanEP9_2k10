...
void CCodexItemList::CreateSubControl ()
{
	CBasicLineBox* pLineBox = new CBasicLineBox;
	pLineBox->CreateSub ( this, "BASIC_LINE_BOX_QUEST_LIST", UI_FLAG_XSIZE | UI_FLAG_YSIZE );
	pLineBox->CreateBaseBoxQuestList ( "RAN_CODEX_SALESITEM_LIST_LINEBOX" );
	...
	m_pScrollBar->CreateBaseScrollBar ( "RAN_CODEX_SALESITEM_LIST_SCROLLBAR" );
	...
	{
		"RAN_CODEX_SALESITEM_LIST_ITEM_0",
		"RAN_CODEX_SALESITEM_LIST_ITEM_1",
		"RAN_CODEX_SALESITEM_LIST_ITEM_2",
		"RAN_CODEX_SALESITEM_LIST_ITEM_3",
		"RAN_CODEX_SALESITEM_LIST_ITEM_4",
		"RAN_CODEX_SALESITEM_LIST_ITEM_5",
		"RAN_CODEX_SALESITEM_LIST_ITEM_6",
		"RAN_CODEX_SALESITEM_LIST_ITEM_7",
	};

	for( int i=0; i<ACTIVITY_ITEM_LIST_SLOT_MAX; ++i )
	{
		m_pSlot[i] = new CCodexItemListSlot;
...
void CCodexItemList::TranslateUIMessage ( UIGUID ControlID, DWORD dwMsg )
{
	CUIGroup::TranslateUIMessage ( ControlID, dwMsg );

}

void CCodexItemList::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
