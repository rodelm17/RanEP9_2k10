...
HRESULT LIGHTNING_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "LIGHTNING_PROPERTY::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT LIGHTNING_PROPERTY::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
