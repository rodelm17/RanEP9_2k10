...
SCROWBASIC& SCROWBASIC::operator = ( const SCROWBASIC_120 &sCrowBasic )
{
	...
	dummy_var_3			= sCrowBasic.dummy_var_3;
	dummy_var_4			= sCrowBasic.dummy_var_4;
	dummy_var_5			= sCrowBasic.dummy_var_5;
...
SCROWBASIC& SCROWBASIC::operator = ( const SCROWBASIC_121 &sCrowBasic )
{
	...
	dummy_var_6			= sCrowBasic.dummy_var_6;
	dummy_var_7			= sCrowBasic.dummy_var_7;
...
SCROWBASIC& SCROWBASIC::operator = ( const SCROWBASIC_122 &sCrowBasic )
{
	...
	dummy_var_8			= sCrowBasic.dummy_var_8;
...
SCROWBASIC& SCROWBASIC::operator = ( const SCROWBASIC_205 &sCrowBasic )
{
	StringCbCopy( m_szName, CHAR_SZNAME, sCrowBasic.m_szName );
	sNativeID			= sCrowBasic.sNativeID;
	m_emCrow			= sCrowBasic.m_emCrow;
	...
	m_bHideName			= sCrowBasic.m_bHideName;	/*hide crow name, Juver, 2017/09/01 */
	m_dwNotice			= sCrowBasic.m_dwNotice;	/*crow notice, Juver, 2017/11/25 */
	m_emCTFType			= sCrowBasic.m_emCTFType;	/*pvp capture the flag, Juver, 2018/02/03 */
...
SCROWBASIC& SCROWBASIC::operator = ( const SCROWBASIC_206 &sCrowBasic )
{
	StringCbCopy( m_szName, CHAR_SZNAME, sCrowBasic.m_szName );
	sNativeID			= sCrowBasic.sNativeID;
	m_emCrow			= sCrowBasic.m_emCrow;
...
SCROWBASIC& SCROWBASIC::operator = ( const SCROWBASIC_207 &sCrowBasic )
{
	StringCbCopy( m_szName, CHAR_SZNAME, sCrowBasic.m_szName );
	sNativeID			= sCrowBasic.sNativeID;
	m_emCrow			= sCrowBasic.m_emCrow;
...
SCROWBASIC& SCROWBASIC::operator = ( const SCROWBASIC_208 &sCrowBasic )
{
	StringCbCopy( m_szName, CHAR_SZNAME, sCrowBasic.m_szName );
	sNativeID			= sCrowBasic.sNativeID;
	m_emCrow			= sCrowBasic.m_emCrow;
	...
	m_dwNotice			= sCrowBasic.m_dwNotice;	/*crow notice, Juver, 2017/11/25 */
	m_emCTFType			= sCrowBasic.m_emCTFType;	/*pvp capture the flag, Juver, 2018/02/03 */
	m_emCrowSchool		= sCrowBasic.m_emCrowSchool;	/*crow school, Juver, 2018/08/02 */
	m_bBlockPushPull	= false;
...
SCROWBASIC& SCROWBASIC::operator = ( const SCROWBASIC_209 &sCrowBasic )
{
	StringCbCopy( m_szName, CHAR_SZNAME, sCrowBasic.m_szName );
	sNativeID			= sCrowBasic.sNativeID;
	m_emCrow			= sCrowBasic.m_emCrow;
	...
	m_emCTFType			= sCrowBasic.m_emCTFType;	/*pvp capture the flag, Juver, 2018/02/03 */
	m_emCrowSchool		= sCrowBasic.m_emCrowSchool;	/*crow school, Juver, 2018/08/02 */
	m_bBlockPushPull	= sCrowBasic.m_bBlockPushPull;
...
SCROWBASIC& SCROWBASIC::operator = ( const SCROWBASIC_210 &sCrowBasic )
{
	StringCbCopy( m_szName, CHAR_SZNAME, sCrowBasic.m_szName );
	sNativeID			= sCrowBasic.sNativeID;
	m_emCrow			= sCrowBasic.m_emCrow;
	...
	m_dwCrowFlag		= sCrowBasic.m_dwCrowFlag;
...
//	기획팀 요청으로 제거함
	...
	m_bOverlapAttack = atoi( StrArray[ iCsvCur++ ] ) ? true:false;
	...
	/*hide crow name, Juver, 2017/09/01 */
	m_bHideName = atoi( StrArray[ iCsvCur++ ] ) ? true:false; 
	...
	/*crow school, Juver, 2018/08/02 */
	m_emCrowSchool = (EMCROW_SCHOOL)atoi( StrArray[ iCsvCur++ ] );

	/*block crow push/pull, Juver, 2019/02/14 */
	m_bBlockPushPull = atoi( StrArray[ iCsvCur++ ] ) ? true:false; 

	m_bBlockStun = atoi( StrArray[ iCsvCur++ ] ) ? true:false; 

	dummy_var_0 = (DWORD)atoi( StrArray[ iCsvCur++ ] );
	dummy_var_1 = atoi( StrArray[ iCsvCur++ ] ) ? true:false; 
	dummy_var_2 = atoi( StrArray[ iCsvCur++ ] ) ? true:false; 
	dummy_var_3 = (float)atof( StrArray[ iCsvCur++ ] );
	dummy_var_4 = atoi( StrArray[ iCsvCur++ ] ) ? true:false; 
	dummy_var_5 = (WORD)atoi( StrArray[ iCsvCur++ ] );
	dummy_var_6 = (float)atof( StrArray[ iCsvCur++ ] );
	dummy_var_7 = (float)atof( StrArray[ iCsvCur++ ] );
	dummy_var_8 = (float)atof( StrArray[ iCsvCur++ ] );

	m_dwCrowFlag = (DWORD)atoi( StrArray[ iCsvCur++ ] );
}