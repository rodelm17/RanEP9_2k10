...
HRESULT MOVETARGET_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "MOVETARGET_PROPERTY::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT MOVETARGET_PROPERTY::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
