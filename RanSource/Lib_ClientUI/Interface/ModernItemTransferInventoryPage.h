/*!
 * \file ModernItemTransferInventoryPage.h
 *
 * \author Juver
 * \date January 2018
 *
...
class CModernItemTransferInvenPage : public CUIGroup	
{
private:
...
public:
	CModernItemTransferInvenPage();
	virtual	~CModernItemTransferInvenPage();
