...
#include "../../Lib_Client/G-Logic/GLItemMix.h"
...
private:
	...
	CBasicTextBox*		m_pTextProductPlayTimeReq;
	CBasicTextBox*		m_pTextProductPlayPointUse;

	CBasicTextBox*		m_pTextProductContriUse;
