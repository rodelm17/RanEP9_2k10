...
public:
	...
	bool CheckCollision( NavigationMesh* pNaviMesh );
...
public:
	...
	BOOL Load_0113( basestream &SFile );
...
public:
	...
	SGLNODE<GLMobSchedule*>* FindMobSch ( DWORD dwGlobID );
	...
	GLMobSchedule*	FindMobScheduleCrowID ( const SNATIVEID& sCrowID );
...
public:
	...
	BOOL LoadFile_106 ( basestream &SFile, DWORD dwGroupNum );
