...
const INT CEP7ItemRandomOptionRebuildInventoryPage::nSTARTLINE = 0;	
const INT CEP7ItemRandomOptionRebuildInventoryPage::nOUTOFRANGE = -1;

CEP7ItemRandomOptionRebuildInventoryPage::CEP7ItemRandomOptionRebuildInventoryPage()
...
void CEP7ItemRandomOptionRebuildInventoryPage::CreateSubControl()
{
	CString strSlotKeyword[ nMAX_ONE_VIEW_SLOT ] =
	{
		"EP7_ITEM_RANDOM_OPTION_REBUILD_INVENTORYSLOT_ITEM_SLOT0",
		"EP7_ITEM_RANDOM_OPTION_REBUILD_INVENTORYSLOT_ITEM_SLOT1",
		"EP7_ITEM_RANDOM_OPTION_REBUILD_INVENTORYSLOT_ITEM_SLOT2",
		"EP7_ITEM_RANDOM_OPTION_REBUILD_INVENTORYSLOT_ITEM_SLOT3",
		"EP7_ITEM_RANDOM_OPTION_REBUILD_INVENTORYSLOT_ITEM_SLOT4",
		"EP7_ITEM_RANDOM_OPTION_REBUILD_INVENTORYSLOT_ITEM_SLOT5",
		"EP7_ITEM_RANDOM_OPTION_REBUILD_INVENTORYSLOT_ITEM_SLOT6",
		"EP7_ITEM_RANDOM_OPTION_REBUILD_INVENTORYSLOT_ITEM_SLOT7",
		"EP7_ITEM_RANDOM_OPTION_REBUILD_INVENTORYSLOT_ITEM_SLOT8",
		"EP7_ITEM_RANDOM_OPTION_REBUILD_INVENTORYSLOT_ITEM_SLOT9",
...
CItemSlotEx* CEP7ItemRandomOptionRebuildInventoryPage::CreateItemSlot( CString strKeyword, UIGUID ControlID )
{
...
CUIControl*	CEP7ItemRandomOptionRebuildInventoryPage::CreateControl( const TCHAR* szControl )
{
...
void CEP7ItemRandomOptionRebuildInventoryPage::Update( INT x, INT y, BYTE LB, BYTE MB, BYTE RB, INT nScroll, FLOAT fElapsedTime, BOOL bFirstControl )
{
...
void CEP7ItemRandomOptionRebuildInventoryPage::TranslateUIMessage( UIGUID ControlID, DWORD dwMsg )
{
...
void CEP7ItemRandomOptionRebuildInventoryPage::ResetItemSlotRender ( int nStart, int nEnd )
{
	if ( nEnd < 0 )			return;
...
void CEP7ItemRandomOptionRebuildInventoryPage::SetItemSlotRender ( int nStart, int nEnd )
{
	if ( nEnd < 0 ) return ;
	if ( nStart > nEnd ) return ;
...
void CEP7ItemRandomOptionRebuildInventoryPage::SetItemIndex( INT nPosX, INT nPosY )
{
	m_nPosX = nPosX;
	m_nPosY = nPosY;
}

void CEP7ItemRandomOptionRebuildInventoryPage::GetItemIndex( INT* pnPosX, INT* pnPosY )
{
	*pnPosX = m_nPosX;
	*pnPosY = m_nPosY;
}

void CEP7ItemRandomOptionRebuildInventoryPage::LoadItemPage( GLInventory &ItemData )
{
...
void CEP7ItemRandomOptionRebuildInventoryPage::LoadItem( SINVENITEM& ref_InvenItem )
{	
...
void CEP7ItemRandomOptionRebuildInventoryPage::UnLoadItemPage()
{
...
void CEP7ItemRandomOptionRebuildInventoryPage::UnLoadItem( INT nPosX, INT nPosY )
{
	m_pItemSlotArray[ nPosY ]->ResetItemImage( nPosX );
}

void CEP7ItemRandomOptionRebuildInventoryPage::ResetAllFlipItem()
{
	for( WORD y=0; y<EM_INVENSIZE_Y; ++y )
		for( WORD x=0; x<EM_INVENSIZE_X; ++x )
...
void CEP7ItemRandomOptionRebuildInventoryPage::UpdateFlipItem( GLInventory& ref_Inventory )
{
	ResetAllFlipItem();
...
void CEP7ItemRandomOptionRebuildInventoryPage::UpdateFlipItem( SINVEN_POS& ref_GarbageItem )
{
...
void CEP7ItemRandomOptionRebuildInventoryPage::UpdateBLOCK()
{
...
SINVENITEM& CEP7ItemRandomOptionRebuildInventoryPage::GetItem( INT nPosX, INT nPosY )
{
	return m_pItemSlotArray[ nPosY ]->GetItemImage( nPosX );
}

void CEP7ItemRandomOptionRebuildInventoryPage::SetOneViewSlot( const INT& nMAX_ONE_VIEW )
{
