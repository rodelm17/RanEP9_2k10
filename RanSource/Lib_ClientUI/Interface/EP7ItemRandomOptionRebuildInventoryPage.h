/*!
 * \file EP7ItemRandomOptionRebuildInventoryPage.h
 *
 * \author Juver
 * \date July 2018
 *
...
class CEP7ItemRandomOptionRebuildInventoryPage : public CUIGroup	
{
private:
...
public:
	CEP7ItemRandomOptionRebuildInventoryPage();
	virtual	~CEP7ItemRandomOptionRebuildInventoryPage();
