...
public:
	...
	{ 
		...
		ENCODE_VER_BYTE_CRYPT_2021_SKIN_PIECE_V1	= 0x0203,
...
public:
	...
	HRESULT LoadPiece_0202 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread );
	HRESULT LoadPiece_0203 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread );

	HRESULT SavePiece ( const char* szFile );

public:
	HRESULT R2LoadPiece ( const char* szFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread );
	HRESULT R2LoadPiece_0101 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread );
	HRESULT R2LoadPiece_0102 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread );
	HRESULT R2LoadPiece_0103 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread );
	HRESULT R2LoadPiece_0104 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread );
	HRESULT R2LoadPiece_0105 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread );
	HRESULT R2LoadPiece_0106 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread );
	HRESULT R2LoadPiece_0107 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread );
	HRESULT R2LoadPiece_0108 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice, const BOOL bThread );
