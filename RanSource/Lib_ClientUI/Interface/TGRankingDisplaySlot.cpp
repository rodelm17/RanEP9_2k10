...
CTGRankingDisplaySlot::CTGRankingDisplaySlot ()
	: m_pTextRank(NULL)
	, m_pTextClub(NULL)
	, m_pTextScore(NULL)
{
...
void CTGRankingDisplaySlot::CreateSubControl ()
{
...
void CTGRankingDisplaySlot::ResetData()
{
...
void CTGRankingDisplaySlot::SetData( int nRank, std::string strClub, WORD wKill, WORD wDeath )
{
	ResetData();
