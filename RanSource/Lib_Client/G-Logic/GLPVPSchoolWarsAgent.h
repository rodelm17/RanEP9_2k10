...
public:
	void	RequestPlayerRegister( DWORD dwCharID, WORD wLevel, DWORD dwContri, BOOL bRegister, std::string strHash );
	void	RequestPlayerCancelRegister( DWORD dwCharID );
	void	PlayerRegister( DWORD dwCharID, SCHOOLWARS_REGISTER_DATA_MAP& mapData, SCHOOLWARS_REGISTER_DATA_QUEUE_VEC& vecData, std::string strHash );
...
public:
	...
	SCHOOLWARS_PLAYER_HASH_DATA_MAP	m_mapPlayerHash;
