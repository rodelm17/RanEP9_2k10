...
enum EFFECTFLAG
{
	...
	EFF_CFG_R2_FLAG_1	= (0x60000000),	//	자동적으로 AABBBOX를 만든다.
...
struct EFF_PROPERTY
{
	...
	virtual HRESULT R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
...
public:
	enum
	{
		...
		ENCODE_VER_BYTE_CRYPT_2021_EFFECT_GROUP_V1	= 0x0201,
...
public:
	...
	HRESULT R2LoadFile ( const char* szFileName, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT SaveFile ( const char* szFileName );

	HRESULT  LOAD_0100 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  LOAD_0101 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  LOAD_0102 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  LOAD_0103 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  LOAD_0104 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  LOAD_0105 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  LOAD_0106 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  LOAD_0200 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  LOAD_0201 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );

	HRESULT  R2LOAD_0100 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  R2LOAD_0101 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  R2LOAD_0102 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  R2LOAD_0103 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  R2LOAD_0104 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  R2LOAD_0105 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	HRESULT  R2LOAD_0106 ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
