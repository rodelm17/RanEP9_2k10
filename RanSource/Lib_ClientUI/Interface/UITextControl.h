...
namespace	NS_UITEXTCOLOR
{
	...
	const DWORD DARKLBUE		= D3DCOLOR_ARGB(0xFF,0x87,0xCE,0xFE);
	const DWORD BRIGHTGREEN		= D3DCOLOR_ARGB(0xFF,0x00,0xFF,0x00);

	const DWORD WARMPINK		= D3DCOLOR_ARGB(0xFF,0xF9,0xB6,0xB0);


	const DWORD UIINFO_HEAD		= D3DCOLOR_ARGB(0xFF,0xFF,0xFF,0xFF);
	const DWORD UIINFO_COSNAME	= D3DCOLOR_ARGB(0xFF,0x87,0xDE,0x87);
	const DWORD UIINFO_OPTION1	= D3DCOLOR_ARGB(0xFF,0x00,0xFE,0xFE);
	const DWORD UIINFO_OPTION2	= D3DCOLOR_ARGB(0xFF,0x00,0xF1,0x00);
	const DWORD UIINFO_EXPIRE	= D3DCOLOR_ARGB(0xFF,0xF7,0x96,0x46);
	const DWORD UIINFO_PLUS		= D3DCOLOR_ARGB(0xFF,0xFE,0xFE,0x00);
	const DWORD UIINFO_GRAY		= D3DCOLOR_ARGB(0xFF,0x96,0x96,0x96);
	const DWORD UIINFO_BLUE		= D3DCOLOR_ARGB(0xFF,0x1E,0x90,0xFF);
	...
	const DWORD UICDM_SCORE_GREEN = D3DCOLOR_ARGB(0xFF,0x98,0xFB,0x98);
