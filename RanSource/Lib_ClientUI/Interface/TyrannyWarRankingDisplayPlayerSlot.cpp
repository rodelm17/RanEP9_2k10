...
CCTyrannyWarRankingDisplayPlayerSlot::CCTyrannyWarRankingDisplayPlayerSlot ()
...
void CCTyrannyWarRankingDisplayPlayerSlot::CreateSubControl ()
{
	...
	m_pLineBox->CreateBaseBoxQuestList ( "TYRANNY_RANKING_LINEBOX_PLAYER_WHITE_SELF_SLOT" );
	...
	m_pLineBoxWhite->CreateBaseBoxWhiteBlankBody ( "TYRANNY_RANKING_LINEBOX_PLAYER_WHITE_SLOTRANK" );
	...
	m_pLineBoxRankWhite->CreateBaseBoxWhiteBlankBody ( "TYRANNY_RANKING_LINEBOX_PLAYER_WHITE_RANKNUMBER" );
	...
	m_pLineBoxCharacterDetailsWhite->CreateBaseBoxWhiteBlankBody ( "TYRANNY_RANKING_LINEBOX_PLAYER_WHITE_CHARACTER_DETAILS" );
	...
	m_pLineBoxCharacterNameWhite->CreateBaseBoxWhiteBlankBody ( "TYRANNY_RANKING_LINEBOX_PLAYER_WHITE_CHARACTER_NAME" );
	...
	m_pRankTextSlot->CreateSub ( this, "TYRANNY_RANKING_TEXT_BASE_RANK_PLAYER_SLOT" );
	...
	m_pPlayerNameTextSlot->CreateSub ( this, "TYRANNY_RANKING_TEXT_BASE_PLAYER_NAME_SLOT" );
	...
	m_pPlayerScoreTextSlotKill->CreateSub ( this, "TYRANNY_RANKING_TEXT_BASE_PLAYER_KILLSCORE_RESULT" );
	...
	m_pPlayerScoreTextSlotDeath->CreateSub ( this, "TYRANNY_RANKING_TEXT_BASE_PLAYER_DEATHSCORE_RESULT" );
	...
	{
		"TYRANNY_RANKING_PLAYER_CHARACTER_SCHOOL_WINDOW_SM",
		"TYRANNY_RANKING_PLAYER_CHARACTER_SCHOOL_WINDOW_HA",
		"TYRANNY_RANKING_PLAYER_CHARACTER_SCHOOL_WINDOW_BH",
	};
	...
	m_pKillIcon->CreateSub ( this, "TYRANNY_RANKING_PLAYER_SLOT_IMAGES_KILL", UI_FLAG_XSIZE | UI_FLAG_YSIZE );
	m_pKillIcon->SetVisibleSingle ( FALSE );
	RegisterControl ( m_pKillIcon );

	m_pDeathIcon = new CUIControl;
	m_pDeathIcon->CreateSub ( this, "TYRANNY_RANKING_PLAYER_SLOT_IMAGES_DEATH", UI_FLAG_XSIZE | UI_FLAG_YSIZE );
	m_pDeathIcon->SetVisibleSingle ( FALSE );
	RegisterControl ( m_pDeathIcon );

	m_pClassImage = new CUIControl;
	m_pClassImage->CreateSub(this, "TYRANNY_RANKING_PLAYER_SLOT_CLASS_IMAGE", UI_FLAG_DEFAULT, CLASS_DUMMY);
	RegisterControl(m_pClassImage);


	m_pGuildImage = new CUIControl;
	m_pGuildImage->CreateSub(this, "TYRANNY_RANKING_PLAYER_CLUB_MARK", UI_FLAG_DEFAULT, GUILD_DUMMY);
...
CUIControl* CCTyrannyWarRankingDisplayPlayerSlot::CreateControl ( const char* szControl )
{
...
void CCTyrannyWarRankingDisplayPlayerSlot::TranslateUIMessage( UIGUID cID, DWORD dwMsg )
{
	CUIGroup::TranslateUIMessage( cID, dwMsg );
}

void CCTyrannyWarRankingDisplayPlayerSlot::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
	if ( !IsVisible () ) return ;
...
HRESULT CCTyrannyWarRankingDisplayPlayerSlot::InitDeviceObjects(LPDIRECT3DDEVICEQ pd3dDevice)
{
	GASSERT(pd3dDevice);
...
HRESULT CCTyrannyWarRankingDisplayPlayerSlot::Render(LPDIRECT3DDEVICEQ pd3dDevice)
{
	GASSERT( pd3dDevice );
...
void CCTyrannyWarRankingDisplayPlayerSlot::ResetData()
{
...
void CCTyrannyWarRankingDisplayPlayerSlot::SetData( int nRank, std::string strName, WORD wKill, WORD wDeath, WORD wSchool, int nChaClass, WORD wGuNum, WORD wGuMarkVer )
{
	ResetData();
