...
//originally V_PASS is V, but V fucks up boost templates
//juver
#if defined(DEBUG) | defined(_DEBUG)
#ifndef V_PASS
#define V_PASS(x)           { hr = x; if( FAILED(hr) ) { DXUTTrace( __FILE__, (DWORD)__LINE__, hr, L#x, true ); } }
#endif
#ifndef V_RETURN
