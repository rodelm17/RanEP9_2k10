...
struct SCROWACTION_201
{
	enum { SALENUM = 3, PATTERNNUM = 10, ACTION_MAXATTACK = 10 };
...
struct SCROWACTION_202
{
	enum { VERSION = 0x0202, SALENUM = 3, PATTERNNUM = 10, ACTION_MAXATTACK = 10 };
	...
	std::string			m_strItemExchangeFile;			/*item exchange, Juver, 2017/10/11 */
	std::string			m_strCurrencyShop;
};

struct SCROWACTION
{
	enum { VERSION = 0x0203, SALENUM = 3, PATTERNNUM = 10, ACTION_MAXATTACK = 10 };
	...
	std::string			m_strItemExchangeFile;			/*item exchange, Juver, 2017/10/11 */
	std::string			m_strCurrencyShop;
	std::string			m_strContributionShop;
	...
	bool LOAD201 ( basestream &SFile );
	bool LOAD202 ( basestream &SFile );
