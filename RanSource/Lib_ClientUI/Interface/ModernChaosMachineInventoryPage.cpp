...
const INT CModernChaosMachineInvenPage::nSTARTLINE = 0;	
const INT CModernChaosMachineInvenPage::nOUTOFRANGE = -1;

CModernChaosMachineInvenPage::CModernChaosMachineInvenPage()
...
void CModernChaosMachineInvenPage::CreateSubControl()
{
	CString strSlotKeyword[ nMAX_ONE_VIEW_SLOT ] =
	{
		"MODERN_CHAOS_MACHINE_INVENTORY_WINDOW_ITEM_SLOT0",
		"MODERN_CHAOS_MACHINE_INVENTORY_WINDOW_ITEM_SLOT1",
		"MODERN_CHAOS_MACHINE_INVENTORY_WINDOW_ITEM_SLOT2",
		"MODERN_CHAOS_MACHINE_INVENTORY_WINDOW_ITEM_SLOT3",
		"MODERN_CHAOS_MACHINE_INVENTORY_WINDOW_ITEM_SLOT4",
		"MODERN_CHAOS_MACHINE_INVENTORY_WINDOW_ITEM_SLOT5",
		"MODERN_CHAOS_MACHINE_INVENTORY_WINDOW_ITEM_SLOT6",
		"MODERN_CHAOS_MACHINE_INVENTORY_WINDOW_ITEM_SLOT7",
		"MODERN_CHAOS_MACHINE_INVENTORY_WINDOW_ITEM_SLOT8",
		"MODERN_CHAOS_MACHINE_INVENTORY_WINDOW_ITEM_SLOT9",
...
CItemSlotEx* CModernChaosMachineInvenPage::CreateItemSlot( CString strKeyword, UIGUID ControlID )
{
...
CUIControl*	CModernChaosMachineInvenPage::CreateControl( const TCHAR* szControl )
{
...
void CModernChaosMachineInvenPage::Update( INT x, INT y, BYTE LB, BYTE MB, BYTE RB, INT nScroll, FLOAT fElapsedTime, BOOL bFirstControl )
{
...
void CModernChaosMachineInvenPage::TranslateUIMessage( UIGUID ControlID, DWORD dwMsg )
{
...
void CModernChaosMachineInvenPage::ResetItemSlotRender ( int nStart, int nEnd )
{
	if ( nEnd < 0 )			return;
...
void CModernChaosMachineInvenPage::SetItemSlotRender( int nStart, int nEnd )
{
	if ( nEnd < 0 ) return ;
	if ( nStart > nEnd ) return ;
...
void CModernChaosMachineInvenPage::SetItemIndex( INT nPosX, INT nPosY )
{
	m_nPosX = nPosX;
	m_nPosY = nPosY;
}

void CModernChaosMachineInvenPage::GetItemIndex( INT* pnPosX, INT* pnPosY )
{
	*pnPosX = m_nPosX;
	*pnPosY = m_nPosY;
}

void CModernChaosMachineInvenPage::LoadItemPage( GLInventory &ItemData )
{
...
void CModernChaosMachineInvenPage::LoadItem( SINVENITEM& ref_InvenItem )
{	
...
void CModernChaosMachineInvenPage::UnLoadItemPage()
{
...
void CModernChaosMachineInvenPage::UnLoadItem( INT nPosX, INT nPosY )
{
	m_pItemSlotArray[ nPosY ]->ResetItemImage( nPosX );
}

void CModernChaosMachineInvenPage::ResetAllFlipItem()
{
	for( WORD y=0; y<EM_INVENSIZE_Y; ++y )
		for( WORD x=0; x<EM_INVENSIZE_X; ++x )
...
void CModernChaosMachineInvenPage::UpdateFlipItem( GLInventory& ref_Inventory )
{
	ResetAllFlipItem();
...
void CModernChaosMachineInvenPage::UpdateFlipItem( SINVEN_POS& ref_GarbageItem )
{
...
void CModernChaosMachineInvenPage::UpdateBLOCK()
{
...
SINVENITEM& CModernChaosMachineInvenPage::GetItem( INT nPosX, INT nPosY )
{
	return m_pItemSlotArray[ nPosY ]->GetItemImage( nPosX );
}

void CModernChaosMachineInvenPage::SetOneViewSlot( const INT& nMAX_ONE_VIEW )
{
