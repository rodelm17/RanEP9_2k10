/*!
 * \file ClubWarRankingDisplayPlayerSlot.h
 *
 * \author RSiLENT
...
class CClubWarRankingDisplayPlayerSlot : public CUIGroup
{
	enum
	{
		DUMMY = NO_ID + 1,
...
public:
	CClubWarRankingDisplayPlayerSlot ();
	virtual	~CClubWarRankingDisplayPlayerSlot ();
...
public:
	CBasicTextBox*		m_pRankTextSlot;
	CBasicTextBox*		m_pPlayerNameTextSlot;
	CBasicTextBox*		m_pPlayerScoreTextSlotKill;
	CBasicTextBox*		m_pPlayerScoreTextSlotDeath;
...
public:
	void	ResetData();
	void	SetData( int nRank, std::string strName, WORD wKill, WORD wDeath, WORD wSchool, int nChaClass, WORD wGuNum, WORD wGuMarkVer );
};