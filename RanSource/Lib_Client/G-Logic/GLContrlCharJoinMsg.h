...
struct GLCHARAG_DATA
{
	...
	GLCHARAG_DATA () :
		...
		/* HWID watchlist, Juver, 2020/05/05 */
		m_bUserFlagHWIDWatchlist(false),
...
namespace GLMSG
{
	...
	struct SNETLOBBY_CHARINFO
	{
		...
		SNETLOBBY_CHARINFO ()
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_CHARINFO)<=NET_DATA_BUFSIZE);
		}
	};
	...
	struct SNETLOBBY_CHARJOIN
	{
		...
		DWORD				dwNumCodexProg;				
		DWORD				dwNumCodexDone;
		...
		DWORD				dwNumBattlePassProg;				
		DWORD				dwNumBattlePassDone;
		DWORD				dwNumBattlePassRewardData;

		/*12-16-24, daily login - CNDev*/
		DWORD				dwNumDailyLoginData;
		SNETLOBBY_CHARJOIN () :
			dwClientID(0),
			dwGaeaID(0),
			...
			/*12-9-14, Battle Pass - CNDev*/
			dwNumBattlePassProg(0), 
			dwNumBattlePassDone(0), 
			dwNumBattlePassRewardData(0),

			/*12-16-24, daily login - CNDev*/
			dwNumDailyLoginData(0),
			...
			nMyCCafeClass(0)
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_CHARJOIN)<=NET_DATA_BUFSIZE);
		}
	};
	...
	struct SNETLOBBY_CHARPUTON
	{
		...
		SNETLOBBY_CHARPUTON ()
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_CHARPUTON)<=NET_DATA_BUFSIZE);
		}
	};
	...
	struct SNETLOBBY_CHARPUTON_EX
	{
		...
		: nSlot ( 0 )
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_CHARPUTON_EX)<=NET_DATA_BUFSIZE);
		}
	};	
	...
	struct SNETLOBBY_CHARSKILL
	{
			...
			wNum(0)
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_CHARSKILL)<=NET_DATA_BUFSIZE);
		}
	...
	struct SNETLOBBY_INVENITEM
	{
		...
		SNETLOBBY_INVENITEM ()
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_INVENITEM)<=NET_DATA_BUFSIZE);
		}
	};
	...
	struct SNETLOBBY_VIETNAM_INVENITEM
	{
		...
		SNETLOBBY_VIETNAM_INVENITEM ()
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_VIETNAM_INVENITEM)<=NET_DATA_BUFSIZE);
		}
	};
	...
	struct SNETLOBBY_QUEST_PROG
	{
			...
			dwLengthStream(0)
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_QUEST_PROG)<=NET_DATA_BUFSIZE);
		}
	...
	struct SNETLOBBY_QUEST_END
	{
			...
			dwLengthStream(0)
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_QUEST_END)<=NET_DATA_BUFSIZE);
		}
	...
	struct SNETLOBBY_CHARGE_ITEM
	{
			...
			: nidITEM(false)
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_CHARGE_ITEM)<=NET_DATA_BUFSIZE);
		}
	};
	...
	struct SNETLOBBY_ITEM_COOLTIME
	{
			...
			, emCoolType( EMCOOL_ITEMID )
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_ITEM_COOLTIME)<=NET_DATA_BUFSIZE);
		}
	...
	struct SNETPC_LAND_INFO
	{
		...
		bool				bPVPClubDeathMatchBattleMap;
		bool				bPVPClubDeathMatchLobbyMap;

		bool				bPVPPBGBattleMap;
		bool				bPVPPBGLobbyMap;
		bool 				bPVPWoe;	/*woe Arc Development 08-06-2024*/
		...
		SNETPC_LAND_INFO () 
			...
			, bPVPClubDeathMatchBattleMap(false)
			, bPVPClubDeathMatchLobbyMap(false)
			, bPVPPBGBattleMap(false)
			, bPVPPBGLobbyMap(false)
			, bPVPWoe(false)	/*woe Arc Development 08-06-2024*/
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETPC_LAND_INFO)<=NET_DATA_BUFSIZE);
		}
	};
	...
	struct SNETLOBBY_ITEMFOOD
	{
		...
		SNETLOBBY_ITEMFOOD ()
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_ITEMFOOD)<=NET_DATA_BUFSIZE);
		}
	};	
	...
	struct SNETLOBBY_ACTIVITY_PROG
	{
			...
			: dwNum(0)
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_ACTIVITY_PROG)<=NET_DATA_BUFSIZE);
		}
	...
	struct SNETLOBBY_ACTIVITY_DONE
	{
			...
			: dwNum(0)
		{
			...
			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_ACTIVITY_DONE)<=NET_DATA_BUFSIZE);
		}
	...
	struct SNETLOBBY_CHAR_INFO_PERSONAL_LOCK
	{
		NET_MSG_GENERIC		nmg;

		SPERSONAL_LOCK		sPersonalLock[EMPERSONAL_LOCK_SIZE];

		SNETLOBBY_CHAR_INFO_PERSONAL_LOCK ()
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_LOBBY_CHAR_INFO_PERSONAL_LOCK;
			GASSERT(nmg.dwSize<=NET_DATA_BUFSIZE);

			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_CHAR_INFO_PERSONAL_LOCK)<=NET_DATA_BUFSIZE);
		}
	};

	/* pk combo, Juver, 2021/02/09 */
	struct SNETLOBBY_CHAR_INFO_PK_COMBO_COUNT
	{
		NET_MSG_GENERIC		nmg;

		SPKCOMBO_COUNT		sPKComboCount;

		SNETLOBBY_CHAR_INFO_PK_COMBO_COUNT ()
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_LOBBY_CHAR_INFO_PK_COMBO_COUNT;
			GASSERT(nmg.dwSize<=NET_DATA_BUFSIZE);

			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_CHAR_INFO_PK_COMBO_COUNT)<=NET_DATA_BUFSIZE);
		}
	};


	struct SNETLOBBY_CHAR_INFO_COMBAT_RECORD
	{
		NET_MSG_GENERIC		nmg;

		nscombat_record::SDATA		sCombatRecord;

		SNETLOBBY_CHAR_INFO_COMBAT_RECORD ()
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_LOBBY_CHAR_INFO_COMBAT_RECORD;
			GASSERT(nmg.dwSize<=NET_DATA_BUFSIZE);

			BOOST_STATIC_ASSERT(sizeof(SNETLOBBY_CHAR_INFO_COMBAT_RECORD)<=NET_DATA_BUFSIZE);
		}
	};
	...
	/*12-9-14, Battle Pass - CNDev*/
	struct SNETLOBBY_BATTLEPASS_PROG
	{
		NET_MSG_GENERIC		nmg;

		DWORD						dwNum;
		SBATTLEPASS_CHAR_DATA		sBattlePass[EMGLMSG_BATTLEPASS_MAX];

		SNETLOBBY_BATTLEPASS_PROG ()
			: dwNum(0)
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_LOBBY_CHAR_BATTLEPASS_PROG;
			GASSERT(nmg.dwSize<=NET_DATA_BUFSIZE);
		}

		BOOL ADD ( const SBATTLEPASS_CHAR_DATA &sBattlePass_Data )
		{
			if ( dwNum == EMGLMSG_BATTLEPASS_MAX )	return FALSE;

			sBattlePass[dwNum] = sBattlePass_Data;
			dwNum++;

			nmg.dwSize = sizeof(*this) - sizeof(SBATTLEPASS_CHAR_DATA) * ( EMGLMSG_BATTLEPASS_MAX - dwNum );
			return TRUE;
		}
	};

	struct SNETLOBBY_BATTLEPASS_DONE
	{
		NET_MSG_GENERIC		nmg;
		...
		SNETLOBBY_BATTLEPASS_DONE ()
			: dwNum(0)
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_LOBBY_CHAR_BATTLEPASS_DONE;
			GASSERT(nmg.dwSize<=NET_DATA_BUFSIZE);
		}
	...
	struct SNETLOBBY_BATTLEPASS_REWARD_DATA
	{
		NET_MSG_GENERIC		nmg;

		DWORD							dwNum;
		SBATTLEPASS_REWARD_CHAR_DATA	sBattlePass[EMGLMSG_BATTLEPASS_MAX];

		SNETLOBBY_BATTLEPASS_REWARD_DATA ()
			: dwNum(0)
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_LOBBY_CHAR_BATTLEPASS_REWARD_DATA;
			GASSERT(nmg.dwSize<=NET_DATA_BUFSIZE);
		}

		BOOL ADD ( const SBATTLEPASS_REWARD_CHAR_DATA &sBattlePass_Data )
		{
			if ( dwNum == EMGLMSG_BATTLEPASS_MAX )	return FALSE;
			...
			nmg.dwSize = sizeof(*this) - sizeof(SBATTLEPASS_REWARD_CHAR_DATA) * ( EMGLMSG_BATTLEPASS_MAX - dwNum );
			return TRUE;
		}
	};
		...
		/*12-16-24, daily login - CNDev*/
	struct SNETLOBBY_DAILYLOGIN_DATA
	{
		NET_MSG_GENERIC		nmg;

		DWORD						dwNum;
		SDAILYLOGIN_CHAR_DATA		sDailyLogin[EMGLMSG_DAILYLOGIN_MAX];

		SNETLOBBY_DAILYLOGIN_DATA ()
			: dwNum(0)
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_LOBBY_CHAR_DAILYLOGIN_DATA;
			GASSERT(nmg.dwSize<=NET_DATA_BUFSIZE);
		}

		BOOL ADD ( const SDAILYLOGIN_CHAR_DATA &sDailyLogin_Data )
		{
			if ( dwNum == EMGLMSG_DAILYLOGIN_MAX )	return FALSE;

			sDailyLogin[dwNum] = sDailyLogin_Data;
			dwNum++;

			nmg.dwSize = sizeof(*this) - sizeof(SDAILYLOGIN_CHAR_DATA) * ( EMGLMSG_DAILYLOGIN_MAX - dwNum );
			return TRUE;
		}
	};
	
	/* Codex, Archie 02/16/24 */
	struct SNETLOBBY_CODEX_PROG
	{
		NET_MSG_GENERIC		nmg;

		DWORD					dwNum;
		SCODEX_CHAR_DATA		sCodex[EMGLMSG_CODEX_MAX];

		SNETLOBBY_CODEX_PROG ()
			: dwNum(0)
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_LOBBY_CHAR_CODEX_PROG;
			GASSERT(nmg.dwSize<=NET_DATA_BUFSIZE);
		}

		BOOL ADD ( const SCODEX_CHAR_DATA &sCodex_Data )
		{
			if ( dwNum == EMGLMSG_CODEX_MAX )	return FALSE;

			sCodex[dwNum] = sCodex_Data;
			dwNum++;

			nmg.dwSize = sizeof(*this) - sizeof(SCODEX_CHAR_DATA) * ( EMGLMSG_CODEX_MAX - dwNum );
			return TRUE;
		}
	};

	/* Codex, Archie 02/16/24 */
	struct SNETLOBBY_CODEX_DONE
	{
		NET_MSG_GENERIC		nmg;
		...
		SNETLOBBY_CODEX_DONE ()
			: dwNum(0)
		{
			nmg.dwSize = sizeof(*this);
			nmg.nType = NET_MSG_LOBBY_CHAR_CODEX_DONE;
			GASSERT(nmg.dwSize<=NET_DATA_BUFSIZE);
		}
