...
char		DxEffCharNeon::NAME[MAX_PATH]	= "DxEffCharNeon";
...
HRESULT	DxEffCharNeon::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	else if( dwVer == 0x0105 )
	{
		//	Note : 이팩트의 Property 를 저장.
		//
		EFFCHAR_PROPERTY_NEON_102_103_104_105	sProp;
		SFile.ReadBuffer ( &sProp, sizeof(EFFCHAR_PROPERTY_NEON_102_103_104_105) );
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharNeon::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT	DxEffCharNeon::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharNeon::R2LoadFile", SFile.GetFileName(), dwVer );
