...
namespace ITEM
{
	...
	//113 version for magician weapon, add enum later and assign
	struct SSUIT_113
	{
		enum { ADDON_SIZE = 4 };
	...
	struct SSUIT
	{
		enum { ADDON_SIZE = 4, VERSION = 0x0201 };
		...
		void Assign ( SSUIT_100 &sSuitOld );
		void Assign ( SSUIT_101 &sSuitOld );
		void Assign ( SSUIT_102 &sSuitOld );
		void Assign ( SSUIT_103 &sSuitOld );
		void Assign ( SSUIT_104 &sSuitOld );
		void Assign ( SSUIT_105 &sSuitOld );
		void Assign ( SSUIT_106 &sSuitOld );
		void Assign ( SSUIT_107 &sSuitOld );
		void Assign ( SSUIT_108 &sSuitOld );
		void Assign ( SSUIT_109 &sSuitOld );
		void Assign ( SSUIT_110 &sSuitOld );
		void Assign ( SSUIT_112 &sSuitOld );
		void Assign ( SSUIT_113 &sSuitOld );
		void Assign ( SSUIT_200 &sSuitOld );
