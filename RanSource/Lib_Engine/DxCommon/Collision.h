...
public:
	...
	BOOL		LoadFile_BETA ( CSerialFile &SFile );
};
...
public:
	virtual void	FrameMoveAABB( const float fTime, const float fElapsedTime )											{ return; }
	...
	virtual HRESULT Render_THREAD( const LPDIRECT3DDEVICEQ pd3dDevice, const CLIPVOLUME &sCV, SMATERIAL_SETTING& material ) { return S_OK; }
	virtual HRESULT Render_PIECE( const LPDIRECT3DDEVICEQ pd3dDevice, SMATERIAL_SETTING& material ) { return S_OK; }
