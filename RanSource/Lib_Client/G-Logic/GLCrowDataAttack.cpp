...
SCROWATTACK& SCROWATTACK::operator= ( const SCROWATTACK &value )
{
	...
	unknown_var_0		= value.unknown_var_0;
	unknown_var_1		= value.unknown_var_1;
...
bool SCROWATTACK::LOAD_0109 ( basestream &SFile )
{
	DWORD dwDATA(0);
...
bool SCROWATTACK::LOAD_0200 ( basestream &SFile )
{
	DWORD dwDATA(0);
...
VOID SCROWATTACK::SaveCsvHead ( std::fstream &SFile, int iIndex )
{
	...
	SFile << iIndex << " unknown_var_0" << ",";
	SFile << iIndex << " unknown_var_1" << ",";
	SFile << iIndex << " unknown_var_1" << ",";
	SFile << iIndex << " unknown_var_1" << ",";
}
...
VOID SCROWATTACK::SaveCsv ( std::fstream &SFile )
{
	...
	SFile << unknown_var_0 << ",";
	SFile << unknown_var_1.x << ",";
	SFile << unknown_var_1.y << ",";
	SFile << unknown_var_1.z << ",";
}
...
VOID SCROWATTACK::LoadCsv ( CStringArray &StrArray, int& iCsvCur )
{
	...
	unknown_var_0 = (BOOL)atol( StrArray[ iCsvCur++ ] );
	unknown_var_1.x = (float)atof( StrArray[ iCsvCur++ ] );
	unknown_var_1.y = (float)atof( StrArray[ iCsvCur++ ] );
	unknown_var_1.z = (float)atof( StrArray[ iCsvCur++ ] );
}
