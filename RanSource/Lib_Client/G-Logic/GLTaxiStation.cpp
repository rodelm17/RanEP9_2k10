...
HRESULT GLTaxiStation::LoadFile ( const char* szFile )
{
	...
	if ( dwFILEVER>=VERSION_ENCODE )
		SFile.SetEncodeType ( EMRCRYPT_BYTE_TYPE_TAXI_STATION_VER_1 );

	if ( dwFILEVER>=ENCODE_VER_BYTE_CRYPT_2021_TAX_STATION_V1 )
		SFile.SetEncodeType ( EMRCRYPT_BYTE_TYPE_2021_TAXI_STATION_V1 );
