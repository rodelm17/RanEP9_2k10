...
protected:
	...
	bool				m_bUserAccountPageInit;
	bool				m_bUserAccountPageWait;

	/* login device check, Juver, 2020/11/06 */
	bool				m_bUserLoginDeviceCheck;
	bool				m_bUserLoginDeviceCheckVerifyRequestInit;			
	bool				m_bUserLoginDeviceCheckVerifyRequestWait;
...
public:
	...
	/*dmk14 ingame web*/
	void	SetPremiumPoints( DWORD dwPoints );
	DWORD	GetPremiumPoints();

	void	SetCombatPoints( DWORD dwPoints );
	DWORD	GetCombatPoints();
...
public:
	...
	/* user flag verified, Juver, 2020/02/25 */
	void	SetUserFlagVerified( bool bUserFlagVerified );
	bool	GetUserFlagVerified();

	/* user flag restricted, Juver, 2020/04/20 */
	void	SetUserFlagRestricted( bool bUserFlagRestricted );
	bool	GetUserFlagRestricted();

	/* HWID watchlist, Juver, 2020/05/05 */
	void	SetUserFlagHWIDWatchList( bool bUserFlagHWIDWatchList );
	bool	GetUserFlagHWIDWatchList();

	/* user account page, Juver, 2020/11/05 */
	bool    GetUserAccountPageInit();
	void    SetUserAccountPageInit( bool bSet );
	bool    GetUserAccountPageWait();
	void    SetUserAccountPageWait( bool bSet );

	/* login device check, Juver, 2020/11/06 */
	bool    GetUserLoginDeviceCheck();
	void    SetUserLoginDeviceCheck( bool bSet );

	bool	GetUserLoginDeviceCheckVerifyRequestInit();
	void	SetUserLoginDeviceCheckVerifyRequestInit( bool bSet );
	bool	GetUserLoginDeviceCheckVerifyRequestWait();
	void	SetUserLoginDeviceCheckVerifyRequestWait( bool bSet );
};
