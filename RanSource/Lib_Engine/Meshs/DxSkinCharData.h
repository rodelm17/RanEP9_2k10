...
public:
	...
	{ 
		...
		ENCODE_VER_BYTE_CRYPT_2021_SKIN_CHAR_V1	= 0x0202,

		VERSION_ENCRYPT_BYTE_CRYPT2	= 0x0201,
		VERSION_ENCRYPT_BYTE_CRYPT	= 0x0200,
	};
...
protected:
	...
	BOOL LOAD_0201( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
	BOOL LOAD_0202( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
public:
