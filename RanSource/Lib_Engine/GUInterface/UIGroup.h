...
protected:
	void         DragUpdate( int x, int y, D3DXVECTOR2& vInOutPos );
	void         DragMessage( DWORD dwMsg );
...
public:
	...
	virtual void SetAlignedGlobalPos(const UIRECT& Pos);
	...
	virtual void SetNonBoundaryCheck( const bool bEnable );
