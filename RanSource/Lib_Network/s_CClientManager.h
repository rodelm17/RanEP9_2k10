...
public:
	...
	/*dmk14 ingame web*/
	void	SetPremiumPoints	(DWORD dwClient, DWORD dwPoints);
	DWORD	GetPremiumPoints	(DWORD dwClient);

	void	SetCombatPoints		(DWORD dwClient, DWORD dwPoints);
	DWORD	GetCombatPoints		(DWORD dwClient);
	...
	void SetUserFlagVerified( DWORD dwClient, bool bUserFlagVerified );
	bool GetUserFlagVerified( DWORD dwClient );

	/* user flag restricted, Juver, 2020/04/20 */
	void SetUserFlagRestricted( DWORD dwClient, bool bUserFlagRestricted );
	bool GetUserFlagRestricted( DWORD dwClient );

	/* HWID watchlist, Juver, 2020/05/05 */
	void SetUserFlagHWIDWatchList( DWORD dwClient, bool bUserFlagHWIDWatchList );
	bool GetUserFlagHWIDWatchList( DWORD dwClient );
