	...
	m_pSetting(NULL)
{
    ...
    memset( m_pMainBG, 0, sizeof(m_pMainBG) );
    memset( m_pMotionBG, 0, sizeof(m_pMotionBG) );
}
...
{
	{
        ...
        pControl->CreateSub ( this, "MAP_WINDOW_SETTING_MAIN_TITLE_HEAD" );
        RegisterControl( pControl );
        m_pMainBG[TITLE_HEAD] = pControl;

        pControl = new CUIControl();
        pControl->CreateSub ( this, "MAP_WINDOW_SETTING_MAIN_TITLE_BODY" );
        RegisterControl( pControl );
        m_pMainBG[TITLE_BODY] = pControl;

        pControl = new CUIControl();
        pControl->CreateSub ( this, "MAP_WINDOW_SETTING_MAIN_TITLE_TAIL" );
        RegisterControl( pControl );
        m_pMainBG[TITLE_TAIL] = pControl;
	}

	{
        ...
        pControlMotion->CreateSub ( this, "MAP_WINDOW_SETTING_MOTION_TITLE_HEAD" );
        RegisterControl( pControlMotion );
        m_pMotionBG[TITLE_HEAD] = pControlMotion;

        pControlMotion = new CUIControl();
        pControlMotion->CreateSub ( this, "MAP_WINDOW_SETTING_MOTION_TITLE_BODY" );
        RegisterControl( pControlMotion );
        m_pMotionBG[TITLE_BODY] = pControlMotion;

        pControlMotion = new CUIControl();
        pControlMotion->CreateSub ( this, "MAP_WINDOW_SETTING_MOTION_TITLE_TAIL" );
        RegisterControl( pControlMotion );
        m_pMotionBG[TITLE_TAIL] = pControlMotion;
	}
