...
BOOL DxSkinDataDummy::LOAD_0201 ( basestream &SFile )
{
	//skeleton
	SFile >> m_strSkeleton;
...
BOOL DxSkinDataDummy::LOAD_0202 ( basestream &SFile )
{
	//skeleton
	SFile >> m_strSkeleton;
...
BOOL DxSkinDataDummy::LoadFile ( const char* szFile )
{
	...
	if ( dwVer >= DxSkinCharData::VERSION_ENCRYPT_BYTE_CRYPT )
		SFile.SetEncodeType( EMRCRYPT_BYTE_TYPE_SKIN_CONTAINER_VER_1 );

	if ( dwVer >= DxSkinCharData::VERSION_ENCRYPT_BYTE_CRYPT2 )
		SFile.SetEncodeType( EMRCRYPT_BYTE_TYPE_SKIN_CONTAINER_VER_2 );

	if ( dwVer >= DxSkinCharData::ENCODE_VER_BYTE_CRYPT_2021_SKIN_CHAR_V1 )
