...
#include "../Lib_Client/G-Logic/GLPet.h"
...
BOOL CPageEdit1::DataDefault()
{
	...
	SetWin_Combo_Init( this, IDC_COMBO_CROW_SCHOOL, COMMENT::CROW_SCHOOL, EMCROW_SCHOOL_SIZE+1 ); /*crow school, Juver, 2018/08/02 */
...
BOOL CPageEdit1::DataShow()
{
	...
	SetWin_Combo_Sel( this, IDC_COMBO_CROW_SCHOOL, COMMENT::CROW_SCHOOL[m_pDummyCrow->m_sBasic.m_emCrowSchool].c_str() );	/*crow school, Juver, 2018/08/02 */
	...
	SetWin_Combo_Sel( this, IDC_COMBO_GATHER_ANI, COMMENT::ANI_SUBTYPE_SKILL[m_pDummyCrow->m_sBasic.m_wGatherAnimation].c_str() );

	/*block crow push/pull, Juver, 2019/02/14 */
	SetWin_Check( this, IDC_CHECK_BLOCK_PUSH_PULL, m_pDummyCrow->m_sBasic.m_bBlockPushPull );

	SetWin_Check( this, IDC_CHECK_BLOCK_STUN, m_pDummyCrow->m_sBasic.m_bBlockStun );
	...
	SetWin_Text( this, IDC_EDIT_NPC_CURRENCY_SHOP, m_pDummyCrow->m_sAction.m_strCurrencyShop.c_str() );	
	SetWin_Text( this, IDC_EDIT_NPC_CONTRIBUTION_SHOP, m_pDummyCrow->m_sAction.m_strContributionShop.c_str() );	
	...
	SetWin_Text( this, IDC_EDIT_GEN_ITEM, m_pDummyCrow->m_sGenerate.m_strGenItem[0].c_str() );
	SetWin_Text( this, IDC_EDIT_GEN_ITEM2, m_pDummyCrow->m_sGenerate.m_strGenItem[1].c_str() );
	SetWin_Text( this, IDC_EDIT_GEN_ITEM3, m_pDummyCrow->m_sGenerate.m_strGenItem[2].c_str() );
	SetWin_Text( this, IDC_EDIT_GEN_ITEM4, m_pDummyCrow->m_sGenerate.m_strGenItem[3].c_str() );
	SetWin_Text( this, IDC_EDIT_GEN_ITEM5, m_pDummyCrow->m_sGenerate.m_strGenItem[4].c_str() );
	SetWin_Text( this, IDC_EDIT_GEN_ITEM6, m_pDummyCrow->m_sGenerate.m_strGenItem[5].c_str() );
	SetWin_Text( this, IDC_EDIT_GEN_ITEM7, m_pDummyCrow->m_sGenerate.m_strGenItem[6].c_str() );
	SetWin_Text( this, IDC_EDIT_GEN_ITEM8, m_pDummyCrow->m_sGenerate.m_strGenItem[7].c_str() );
	SetWin_Text( this, IDC_EDIT_GEN_QITEM, m_pDummyCrow->m_sGenerate.m_strQtGenItem[0].c_str() );
	SetWin_Text( this, IDC_EDIT_GEN_QITEM2, m_pDummyCrow->m_sGenerate.m_strQtGenItem[1].c_str() );
	SetWin_Text( this, IDC_EDIT_GEN_QITEM3, m_pDummyCrow->m_sGenerate.m_strQtGenItem[2].c_str() );
	SetWin_Text( this, IDC_EDIT_GEN_QITEM4, m_pDummyCrow->m_sGenerate.m_strQtGenItem[3].c_str() );
	...
	SetWin_Num_int( this, IDC_EDIT_UNKNOWN_0, m_pDummyCrow->m_sBasic.dummy_var_0 );
	SetWin_Num_int( this, IDC_EDIT_UNKNOWN_1, m_pDummyCrow->m_sBasic.dummy_var_1 );
	SetWin_Num_int( this, IDC_EDIT_UNKNOWN_2, m_pDummyCrow->m_sBasic.dummy_var_2 );
	SetWin_Num_float( this, IDC_EDIT_UNKNOWN_3, m_pDummyCrow->m_sBasic.dummy_var_3 );
	SetWin_Num_int( this, IDC_EDIT_UNKNOWN_4, m_pDummyCrow->m_sBasic.dummy_var_4 );
	SetWin_Num_int( this, IDC_EDIT_UNKNOWN_5, m_pDummyCrow->m_sBasic.dummy_var_5 );
	SetWin_Num_float( this, IDC_EDIT_UNKNOWN_6, m_pDummyCrow->m_sBasic.dummy_var_6 );
	SetWin_Num_float( this, IDC_EDIT_UNKNOWN_7, m_pDummyCrow->m_sBasic.dummy_var_7 );
	SetWin_Num_float( this, IDC_EDIT_UNKNOWN_8, m_pDummyCrow->m_sBasic.dummy_var_8 );

	SetWin_Check ( this, IDC_CHECK_BASIC_FLAG_NO_TRANSFORM, m_pDummyCrow->m_sBasic.m_dwCrowFlag&CROW_BASIC_FLAG_NO_TRANSFORM );
...
BOOL CPageEdit1::DataSave()
{
	...
	m_pDummyCrow->m_sBasic.m_emCrowSchool = static_cast<EMCROW_SCHOOL> ( GetWin_Combo_Sel( this, IDC_COMBO_CROW_SCHOOL) ); /*crow school, Juver, 2018/08/02 */
	...
	m_pDummyCrow->m_sBasic.m_wGatherAnimation = (WORD)GetWin_Combo_Sel( this, IDC_COMBO_GATHER_ANI );

	/*block crow push/pull, Juver, 2019/02/14 */
	m_pDummyCrow->m_sBasic.m_bBlockPushPull = GetWin_Check( this, IDC_CHECK_BLOCK_PUSH_PULL )? true:false;

	m_pDummyCrow->m_sBasic.m_bBlockStun = GetWin_Check( this, IDC_CHECK_BLOCK_STUN )? true:false;
	...
	m_pDummyCrow->m_sAction.m_strCurrencyShop = GetWin_Text( this, IDC_EDIT_NPC_CURRENCY_SHOP ).GetString(); 
	m_pDummyCrow->m_sAction.m_strContributionShop = GetWin_Text( this, IDC_EDIT_NPC_CONTRIBUTION_SHOP ).GetString(); 
	...
	//gen
	/* multiple crow gen, Juver, 2018/02/21 */
	m_pDummyCrow->m_sGenerate.m_strGenItem[0] = GetWin_Text( this, IDC_EDIT_GEN_ITEM ).GetString();
	m_pDummyCrow->m_sGenerate.m_strGenItem[1] = GetWin_Text( this, IDC_EDIT_GEN_ITEM2 ).GetString();
	m_pDummyCrow->m_sGenerate.m_strGenItem[2] = GetWin_Text( this, IDC_EDIT_GEN_ITEM3 ).GetString();
	m_pDummyCrow->m_sGenerate.m_strGenItem[3] = GetWin_Text( this, IDC_EDIT_GEN_ITEM4 ).GetString();
	m_pDummyCrow->m_sGenerate.m_strGenItem[4] = GetWin_Text( this, IDC_EDIT_GEN_ITEM5 ).GetString();
	m_pDummyCrow->m_sGenerate.m_strGenItem[5] = GetWin_Text( this, IDC_EDIT_GEN_ITEM6 ).GetString();
	m_pDummyCrow->m_sGenerate.m_strGenItem[6] = GetWin_Text( this, IDC_EDIT_GEN_ITEM7 ).GetString();
	m_pDummyCrow->m_sGenerate.m_strGenItem[7] = GetWin_Text( this, IDC_EDIT_GEN_ITEM8 ).GetString();
	m_pDummyCrow->m_sGenerate.m_strQtGenItem[0] = GetWin_Text( this, IDC_EDIT_GEN_QITEM ).GetString();
	m_pDummyCrow->m_sGenerate.m_strQtGenItem[1] = GetWin_Text( this, IDC_EDIT_GEN_QITEM2 ).GetString();
	m_pDummyCrow->m_sGenerate.m_strQtGenItem[2] = GetWin_Text( this, IDC_EDIT_GEN_QITEM3 ).GetString();
	m_pDummyCrow->m_sGenerate.m_strQtGenItem[3] = GetWin_Text( this, IDC_EDIT_GEN_QITEM4 ).GetString();
	...
	m_pDummyCrow->m_sBasic.dummy_var_0 = GetWin_Num_int( this, IDC_EDIT_UNKNOWN_0 );
	m_pDummyCrow->m_sBasic.dummy_var_1 = GetWin_Num_int( this, IDC_EDIT_UNKNOWN_1 )? true:false;
	m_pDummyCrow->m_sBasic.dummy_var_2 = GetWin_Num_int( this, IDC_EDIT_UNKNOWN_2 )? true:false;
	m_pDummyCrow->m_sBasic.dummy_var_3 = GetWin_Num_float( this, IDC_EDIT_UNKNOWN_3 );
	m_pDummyCrow->m_sBasic.dummy_var_4 = GetWin_Num_int( this, IDC_EDIT_UNKNOWN_4 )? true:false;
	m_pDummyCrow->m_sBasic.dummy_var_5 = GetWin_Num_int( this, IDC_EDIT_UNKNOWN_5 );
	m_pDummyCrow->m_sBasic.dummy_var_6 = GetWin_Num_float( this, IDC_EDIT_UNKNOWN_6 );
	m_pDummyCrow->m_sBasic.dummy_var_7 = GetWin_Num_float( this, IDC_EDIT_UNKNOWN_7 );
	m_pDummyCrow->m_sBasic.dummy_var_8 = GetWin_Num_float( this, IDC_EDIT_UNKNOWN_8 );

	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_BASIC_FLAG_NO_TRANSFORM ), m_pDummyCrow->m_sBasic.m_dwCrowFlag,CROW_BASIC_FLAG_NO_TRANSFORM );
