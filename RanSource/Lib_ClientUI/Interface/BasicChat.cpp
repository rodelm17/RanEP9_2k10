...
void CBasicChat::AddStringToChatEx ( CString strTemp, WORD wType, SITEMLINK* pItemLink, bool bStaff )
{
	if( m_pBasicChatRightBody )
	{
		/*item link, Juver, 2017/07/31 */
		/* Chat Color, Mhundz 02/22/25 */
		m_pBasicChatRightBody->AddStringToChatEx ( strTemp, wType, pItemLink, bStaff );
	}
}
