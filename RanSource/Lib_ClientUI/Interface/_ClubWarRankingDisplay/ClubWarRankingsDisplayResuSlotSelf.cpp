#include "StdAfx.h"
#include "ClubWarRankingsDisplayResuSlotSelf.h"
...
CClubWarRankingsDisplayResuSlotSelf::CClubWarRankingsDisplayResuSlotSelf ()
: m_pTextRank(NULL)
, m_pTextName(NULL)
...
void CClubWarRankingsDisplayResuSlotSelf::CreateSubControl ()
{
	...
	m_pLineBox->CreateBaseBoxQuestList1 ( "PVP_TYRANNY_RANKING_RESU_DISPLAY_SLOT_BASE_LINEBOX_SELF" );
	...
	m_pTextRank->CreateSub ( this, "PVP_TYRANNY_RANKING_RESU_DISPLAY_SLOT_TEXT_BASE_RANK_SELF" );
	...
	m_pTextName->CreateSub ( this, "PVP_TYRANNY_RANKING_RESU_DISPLAY_SLOT_TEXT_BASE_NAME_SELF" );
	...
	m_pTextScoreKill->CreateSub ( this, "PVP_TYRANNY_RANKING_RESU_DISPLAY_SLOT_TEXT_BASE_SCORE_KILL_SELF" );
	...
	m_pTextScoreDeath->CreateSub ( this, "PVP_TYRANNY_RANKING_RESU_DISPLAY_SLOT_TEXT_BASE_SCORE_DEATH_SELF" );
	...
	m_pTextScoreResu->CreateSub ( this, "PVP_TYRANNY_RANKING_RESU_DISPLAY_SLOT_TEXT_BASE_SCORE_RESU_SELF" );
	...
	m_pIconGuild->CreateSub(this, "PVP_TYRANNY_RANKING_RESU_DISPLAY_SLOT_ICON_GUILD_SELF", UI_FLAG_DEFAULT);
	...
	m_pIconDeath->CreateSub(this, "PVP_TYRANNY_RANKING_RESU_DISPLAY_SLOT_ICON_DEATH_SELF", UI_FLAG_DEFAULT);
	RegisterControl(m_pIconDeath);


	m_pIconResu = new CUIControl;
	m_pIconResu->CreateSub(this, "PVP_TYRANNY_RANKING_RESU_DISPLAY_SLOT_ICON_RESU_SELF", UI_FLAG_DEFAULT);
	RegisterControl(m_pIconResu);
}

void CClubWarRankingsDisplayResuSlotSelf::ResetData()
{
...
HRESULT CClubWarRankingsDisplayResuSlotSelf::Render(LPDIRECT3DDEVICEQ pd3dDevice)
{
...
void CClubWarRankingsDisplayResuSlotSelf::SetData( int nRank, std::string strName, DWORD dwCharID, int nChaClass, WORD wKill, WORD wDeath , WORD wResu, WORD wSchool )
{
	ResetData();
