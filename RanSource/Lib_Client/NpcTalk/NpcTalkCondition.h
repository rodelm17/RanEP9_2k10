...
public:
	...
	BOOL IsTERM_VIP ()			{ return m_emVIPLevel!=EMVIP_LEVEL_NONE; }

	BOOL IsTERM_REBORN()		{ return m_dwRebornReq != 0; }

public:
	BOOL DoTEST ( GLCHARLOGIC_SERVER *pCHARLOGIC );
	BOOL DoTEST ( GLCHARLOGIC_CLIENT *pCHARLOGIC );
