...
#include "../Lib_Client/G-Logic/GLLandMark.h"
...
void CPageEditLandMark::InitUI( BOOL bENABLE )
{
	...
	SetWin_Enable( this, IDC_EDIT_LM_DATA_1, bENABLE );
	SetWin_Enable( this, IDC_EDIT_LM_DATA_2, bENABLE );
	SetWin_Enable( this, IDC_EDIT_LM_DATA_3, bENABLE );

	SetWin_Text( this, IDC_EDIT_LM_NAME, "" );

	SetWin_Num_int( this, IDC_EDIT_LM_DATA_1, 0 );
	SetWin_Num_int( this, IDC_EDIT_LM_DATA_2, 0 );
	SetWin_Num_int( this, IDC_EDIT_LM_DATA_3, 0 );
}
...
void CPageEditLandMark::DataShow()
{
	...
	SetWin_Num_int( this, IDC_EDIT_LM_DATA_1, m_pEdit->unknown_var1 );
	SetWin_Num_int( this, IDC_EDIT_LM_DATA_2, m_pEdit->unknown_var2 );
	SetWin_Num_int( this, IDC_EDIT_LM_DATA_3, m_pEdit->unknown_var3 );
...
BOOL CPageEditLandMark::DataSave()
{
	...
	m_pEdit->unknown_var1 = GetWin_Num_int( this, IDC_EDIT_LM_DATA_1 );
	m_pEdit->unknown_var2 = GetWin_Num_int( this, IDC_EDIT_LM_DATA_2 );
	m_pEdit->unknown_var3 = GetWin_Num_int( this, IDC_EDIT_LM_DATA_3 );
