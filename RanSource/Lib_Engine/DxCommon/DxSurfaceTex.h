...
public:
	...
	LPDIRECT3DTEXTUREQ	m_pShadowTex2048;		// Shadow - 1024
	LPDIRECT3DSURFACEQ	m_pShadowSuf2048;		// Shadow
	LPDIRECT3DSURFACEQ	m_pShadowZBuf2048;		// Shadow
	...
	LPDIRECT3DTEXTUREQ	m_pTempTex2048;		// Temp - 512	( 임시 그림자 )
	LPDIRECT3DSURFACEQ	m_pTempSuf2048;		// Temp
