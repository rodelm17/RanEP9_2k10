...
DxEffCharMan::DxEffCharMan ()
{
	...
	RegistType( DxEffCharAroundEff::TYPEID,		DxEffCharAroundEff::NAME );	
}
...
HRESULT DxEffCharMan::RestoreDeviceObjects ()
{
	...
	DxEffCharAroundEff::CreateDevice ( m_pd3dDevice );
...
HRESULT DxEffCharMan::InvalidateDeviceObjects ()
{
	...
	DxEffCharAroundEff::ReleaseDevice ( m_pd3dDevice );
