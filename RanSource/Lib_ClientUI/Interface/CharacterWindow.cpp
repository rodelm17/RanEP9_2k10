...
void CCharacterWindow::CreateSubControl ()
{
	...
	m_pStaticReborn->CreateSub ( this, "CHARACTER_REBORN_STATIC", UI_FLAG_DEFAULT );
	m_pStaticReborn->SetFont ( pFont );
	m_pStaticReborn->SetTextAlign ( TEXT_ALIGN_LEFT | TEXT_ALIGN_CENTER_Y );	
	m_pStaticReborn->AddText( ID2GAMEWORD( "CHARACTER_SOCIAL_STATIC2", 3), NS_UITEXTCOLOR::WHITE );
	RegisterControl ( m_pStaticReborn );

	m_pTextReborn = new CBasicTextBox;
	m_pTextReborn->CreateSub ( this, "CHARACTER_REBORN_TEXT", UI_FLAG_DEFAULT );
	m_pTextReborn->SetFont ( pFont );
	...
	m_pStaticVIP->CreateSub ( this, "CHARACTER_VIP_STATIC", UI_FLAG_DEFAULT );
	m_pStaticVIP->SetFont ( pFont );
	m_pStaticVIP->SetTextAlign ( TEXT_ALIGN_LEFT | TEXT_ALIGN_CENTER_Y );	
	m_pStaticVIP->AddText( ID2GAMEWORD( "CHARACTER_SOCIAL_STATIC2", 4), NS_UITEXTCOLOR::WHITE );
	RegisterControl ( m_pStaticVIP );

	m_pTextVIP = new CBasicTextBox;
	m_pTextVIP->CreateSub ( this, "CHARACTER_VIP_TEXT", UI_FLAG_DEFAULT );
	m_pTextVIP->SetFont ( pFont );
