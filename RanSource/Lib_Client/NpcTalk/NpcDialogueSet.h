...
public:
	...
	{ 
		...
		ENCODE_VER_BYTE_CRYPT_2021_NPC_TALK_V1	= 0x0207,

		ENCODE_VER_BYTE_CRYPT3	= 0x0205,
		ENCODE_VER_BYTE_CRYPT2	= 0x0204,
...
protected:
	...
	BOOL LOAD_0204 ( basestream &SFile );
	BOOL LOAD_0205 ( basestream &SFile );
	BOOL LOAD_0206 ( basestream &SFile );
	BOOL LOAD_0207 ( basestream &SFile );
	BOOL LOAD_0208 ( basestream &SFile );
	BOOL LOAD_0209 ( basestream &SFile );
	BOOL LOAD_0210 ( basestream &SFile ); // Self buff via NPC
...
private:
	...
	bool		m_bCurrencyShop;
	bool		m_bChaosMachine;		/* chaos machine, Juver, 2021/07/07 */
	bool		m_bContributionShop;

		/*self buff via NPC, DevArt22, 2023/03/18 */
	bool		m_bSelfBuffBAOnly;
	bool		m_bSelfBuffFull;
	bool		m_bSelfBuffFullNoBA;
	VECTALK		m_vecTALK;
...
public:
	...
	bool IsHireAnimal()		{ return m_bHireAnimal; }
	...
	bool IsCurrencyShop()	{ return m_bCurrencyShop; }
	bool IsChaosMachine()	{ return m_bChaosMachine; }			/* chaos machine, Juver, 2021/07/07 */
	bool IsContributionShop()	{ return m_bContributionShop; }

		/*self buff via NPC, DevArt22, 2023/03/18 */
	bool IsSelfBuffBAOnly ()	{ return m_bSelfBuffBAOnly; }
	bool IsSelfBuffFull ()		{ return m_bSelfBuffFull; }
	bool IsSelfBuffFullNoBA ()	{ return m_bSelfBuffFullNoBA; }
