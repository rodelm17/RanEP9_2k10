...
HRESULT MOVEROTATE_PROPERTY::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "MOVEROTATE_PROPERTY::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT MOVEROTATE_PROPERTY::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
