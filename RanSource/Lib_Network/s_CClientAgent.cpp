...
bool CClientAgent::GetUserAccountPageInit(DWORD dwClient)
{
	if (dwClient >= (DWORD) m_nMaxClient)   return m_pClient[dwClient-m_nMaxClient].GetUserAccountPageInit();
	else                                    return m_pClient[dwClient].GetUserAccountPageInit();
}

/* user account page, Juver, 2020/11/05 */
void CClientAgent::SetUserAccountPageInit(DWORD dwClient, bool bSet )
{
	if (dwClient >= (DWORD) m_nMaxClient)	m_pClient[dwClient-m_nMaxClient].SetUserAccountPageInit(bSet);
	else                                    m_pClient[dwClient].SetUserAccountPageInit(bSet);
}


/* user account page, Juver, 2020/11/05 */
bool CClientAgent::GetUserAccountPageWait(DWORD dwClient)
{
	if (dwClient >= (DWORD) m_nMaxClient)   return m_pClient[dwClient-m_nMaxClient].GetUserAccountPageWait();
	else                                    return m_pClient[dwClient].GetUserAccountPageWait();
}

/* user account page, Juver, 2020/11/05 */
void CClientAgent::SetUserAccountPageWait(DWORD dwClient, bool bSet )
{
	if (dwClient >= (DWORD) m_nMaxClient)	m_pClient[dwClient-m_nMaxClient].SetUserAccountPageWait(bSet);
	else                                    m_pClient[dwClient].SetUserAccountPageWait(bSet);
}


/* login device check, Juver, 2020/11/06 */
bool CClientAgent::GetUserLoginDeviceCheck(DWORD dwClient)
{
	if (dwClient >= (DWORD) m_nMaxClient)   return m_pClient[dwClient-m_nMaxClient].GetUserLoginDeviceCheck();
	else                                    return m_pClient[dwClient].GetUserLoginDeviceCheck();
}

/* login device check, Juver, 2020/11/06 */
void CClientAgent::SetUserLoginDeviceCheck(DWORD dwClient, bool bSet )
{
	if (dwClient >= (DWORD) m_nMaxClient)	m_pClient[dwClient-m_nMaxClient].SetUserLoginDeviceCheck(bSet);
	else                                    m_pClient[dwClient].SetUserLoginDeviceCheck(bSet);
}


/* login device check, Juver, 2020/11/07 */
bool CClientAgent::GetUserLoginDeviceCheckVerifyRequestInit(DWORD dwClient)
{
	if (dwClient >= (DWORD) m_nMaxClient)   return m_pClient[dwClient-m_nMaxClient].GetUserLoginDeviceCheckVerifyRequestInit();
	else                                    return m_pClient[dwClient].GetUserLoginDeviceCheckVerifyRequestInit();
}

/* login device check, Juver, 2020/11/07 */
void CClientAgent::SetUserLoginDeviceCheckVerifyRequestInit(DWORD dwClient, bool bSet )
{
	if (dwClient >= (DWORD) m_nMaxClient)	m_pClient[dwClient-m_nMaxClient].SetUserLoginDeviceCheckVerifyRequestInit(bSet);
	else                                    m_pClient[dwClient].SetUserLoginDeviceCheckVerifyRequestInit(bSet);
}

/* login device check, Juver, 2020/11/07 */
bool CClientAgent::GetUserLoginDeviceCheckVerifyRequestWait(DWORD dwClient)
{
	if (dwClient >= (DWORD) m_nMaxClient)   return m_pClient[dwClient-m_nMaxClient].GetUserLoginDeviceCheckVerifyRequestWait();
	else                                    return m_pClient[dwClient].GetUserLoginDeviceCheckVerifyRequestWait();
}

/* login device check, Juver, 2020/11/07 */
void CClientAgent::SetUserLoginDeviceCheckVerifyRequestWait(DWORD dwClient, bool bSet )
{
	if (dwClient >= (DWORD) m_nMaxClient)	m_pClient[dwClient-m_nMaxClient].SetUserLoginDeviceCheckVerifyRequestWait(bSet);
	else                                    m_pClient[dwClient].SetUserLoginDeviceCheckVerifyRequestWait(bSet);
}