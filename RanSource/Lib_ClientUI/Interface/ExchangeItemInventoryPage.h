/*!
 * \file ExchangeItemInventoryPage.h
 *
 * \author Juver
 * \date 2022/04/28
 *
...
#ifndef EXCHANGEITEMINVENTORYPAGE_H_INCLUDED__
#define EXCHANGEITEMINVENTORYPAGE_H_INCLUDED__
...
class CExchangeItemInventoryPage : public CUIGroup	
{
private:
...
public:
	CExchangeItemInventoryPage();
	virtual	~CExchangeItemInventoryPage();
...
#endif // EXCHANGEITEMINVENTORYPAGE_H_INCLUDED__