...
public:
	...
	afx_msg void OnBnClickedButtonItemgen2();
	afx_msg void OnBnClickedButtonItemgen3();
	afx_msg void OnBnClickedButtonItemgen4();
	afx_msg void OnBnClickedButtonItemgen5();
	afx_msg void OnBnClickedButtonItemgen6();
	afx_msg void OnBnClickedButtonItemgen7();
	afx_msg void OnBnClickedButtonItemgen8();
	afx_msg void OnBnClickedButtonItemgenq();
	afx_msg void OnBnClickedButtonItemgenq2();
	afx_msg void OnBnClickedButtonItemgenq3();
	afx_msg void OnBnClickedButtonItemgenq4();
	...
	afx_msg void OnBnClickedButtonNpcCurrencyShop();
	afx_msg void OnBnClickedButtonNpcContributionShop();
};
