...
public:
	void IPFilterMsgBlockAdd( MSG_LIST* pMsg );
	void IPFilterMsgBlockDel( MSG_LIST* pMsg );
	void IPFilterMsgKnownAdd( MSG_LIST* pMsg );
	void IPFilterMsgKnownDel( MSG_LIST* pMsg );
	...
	/*dmk14 whitelist*/
	void MsgServerBroadCastIPFilterWhiteListAdd( MSG_LIST* _pMsg );
	void MsgServerBroadCastIPFilterWhiteListDel( MSG_LIST* _pMsg );
	void MsgServerBroadCastIPFilterWhiteListAddSelf( std::string _strIP );
	void MsgServerBroadCastIPFilterWhiteListDelSelf( std::string _strIP );
};
