...
#define S_HEURISTIC_NUM			8 // IOCP Worker thread number per CPU 
...
#define SESSION_CHECK_TIME		 25000	// 1000 * 60 * 5 Session ���� üũ 5��
...
public :
	...
	BOOL bRPCIDHashValid;

	int CheckRPCIDHash();
	BOOL isRPCIDHashValid() { return bRPCIDHashValid; }
