...
namespace COMMENT
{
	...
	std::string ITEMTYPE[ITEM_NSIZE] =
	{
		...
		"Personal Lock Enable",				/* personal lock system, Juver, 2019/12/06 */
		"Personal Lock Reset",				/* personal lock system, Juver, 2019/12/06 */
		...
		"Sealed Card",						/*item random option rebuild, Juver, 2018/07/02 */
		"Random Option Rebuild",			/*item random option rebuild, Juver, 2018/07/02 */
		"ItemBox Specific",					/*specific item box, Juver, 2018/09/02 */
		"Personal Lock Change Pin",			/* personal lock system, Juver, 2020/01/24 */
		"Personal Lock Recover Pin",		/* personal lock system, Juver, 2020/01/31 */

		"Set Option Insert",				//ITEM_SET_OPTION_INSERT
		"Set Option Re-roll",				//ITEM_SET_OPTION_REROLL
		"RebornCard-A",
		"RebornCard-B",
		"Exhange Item",
		"Exhange Item Point",
	...
	//adjust gameword ITEM_ADDON_INFO
	std::string ITEMADDON[EMADD_SIZE] =
	{
		...
		"Missile",
		"Energy",
		"Max CP",		/*item max CP, Juver, 2018/07/09 */
	};
	...
	//note adjust also gameword ITEM_RANDOM_OPTION
	...
	bool isRandomValueScale( EMRANDOM_OPT emOpt )
	{
		...
		case EMR_OPT_EX_MAX_CP:			/*item max CP, Juver, 2018/07/09 */
		default:
			{	
				return false;
			}break;
