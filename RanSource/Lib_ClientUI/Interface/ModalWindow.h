...
public:
	...
	void	GetCodexModalData ( SNATIVEID* nData1, DWORD* nData2, WORD* nData3, WORD* nData4);
...
/* Codex, Archie 02/16/24 */
void SetCodexModalData ( SNATIVEID nData1, DWORD nData2, WORD nData, WORD nData4);