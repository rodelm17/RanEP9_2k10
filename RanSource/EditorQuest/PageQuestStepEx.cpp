...
void CPageQuestStep::StepShowControls ( BOOL bSHOW )
{
	...
	DWORD dwITEMS[] =
	{
		...
		, IDC_EDIT_STEP_DUMMY_1
		, IDC_EDIT_STEP_DUMMY_2
		, IDC_EDIT_STEP_DUMMY_3
		, IDC_EDIT_STEP_DUMMY_4
		, IDC_EDIT_STEP_DUMMY_5
		, IDC_EDIT_STEP_DUMMY_6
		, IDC_EDIT_STEP_DUMMY_7
		, IDC_EDIT_STEP_DUMMY_8
		, IDC_EDIT_STEP_DUMMY_9
		, IDC_EDIT_STEP_DUMMY_10
		, IDC_EDIT_STEP_DUMMY_11
		, IDC_EDIT_STEP_DUMMY_12
		, IDC_EDIT_STEP_DUMMY_13
		, IDC_EDIT_STEP_DUMMY_14
		, IDC_EDIT_STEP_DUMMY_15
	};
...
void CPageQuestStep::StepShow()
{
	...
	//unknown data
	SetWin_Text ( this, IDC_EDIT_STEP_DUMMY_1, sSTEP.m_dummy_var2.c_str() );
	SetWin_Text ( this, IDC_EDIT_STEP_DUMMY_2, sSTEP.m_dummy_var6.c_str() );
	SetWin_Text ( this, IDC_EDIT_STEP_DUMMY_3, sSTEP.m_dummy_var11.c_str() );
	SetWin_Text ( this, IDC_EDIT_STEP_DUMMY_4, sSTEP.m_dummy_var14.c_str() );
	SetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_5, sSTEP.m_dummy_var1 );
	SetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_6, sSTEP.m_dummy_var3 );
	SetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_7, sSTEP.m_dummy_var4 );
	SetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_8, sSTEP.m_dummy_var5 );
	SetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_9, sSTEP.m_dummy_var7 );
	SetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_10, sSTEP.m_dummy_var8 );
	SetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_11, sSTEP.m_dummy_var9 );
	SetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_12, sSTEP.m_dummy_var10 );
	SetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_13, sSTEP.m_dummy_var12 );
	SetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_14, sSTEP.m_dummy_var13 );
	SetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_15, sSTEP.m_dummy_var15 );
}
...
void CPageQuestStep::StepSave()
{
	...
	//unknown data
	sSTEP.m_dummy_var2 = GetWin_Text ( this, IDC_EDIT_STEP_DUMMY_1 ).GetString();
	sSTEP.m_dummy_var6 = GetWin_Text ( this, IDC_EDIT_STEP_DUMMY_2 ).GetString();
	sSTEP.m_dummy_var11 = GetWin_Text ( this, IDC_EDIT_STEP_DUMMY_3 ).GetString();
	sSTEP.m_dummy_var14 = GetWin_Text ( this, IDC_EDIT_STEP_DUMMY_4 ).GetString();
	sSTEP.m_dummy_var1 = GetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_5 );
	sSTEP.m_dummy_var3 = GetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_6 );
	sSTEP.m_dummy_var4 = GetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_7 );
	sSTEP.m_dummy_var5 = GetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_8 );
	sSTEP.m_dummy_var7 = GetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_9 );
	sSTEP.m_dummy_var8 = GetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_10 );
	sSTEP.m_dummy_var9 = GetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_11 );
	sSTEP.m_dummy_var10 = GetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_12 );
	sSTEP.m_dummy_var12 = GetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_13 );
	sSTEP.m_dummy_var13 = GetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_14 );
	sSTEP.m_dummy_var15 = GetWin_Num_int( this, IDC_EDIT_STEP_DUMMY_15 );
}