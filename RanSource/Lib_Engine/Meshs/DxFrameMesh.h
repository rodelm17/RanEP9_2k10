...
public:
	...
	BOOL		LoadFile_BETA ( CSerialFile &SFile, LPDIRECT3DDEVICEQ pd3dDevice );
...
public:
	...
	BOOL		LoadFile_BETA ( CSerialFile &SFile, LPDIRECT3DDEVICEQ pd3dDevice, PDXEFFECTBASE &pEffGlobalHead, PDXFRAME &pAlphaMapHead );
