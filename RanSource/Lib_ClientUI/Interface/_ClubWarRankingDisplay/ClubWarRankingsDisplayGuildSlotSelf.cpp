...
CClubWarRankingsDisplayGuildSlotSelf::CClubWarRankingsDisplayGuildSlotSelf ()
: m_pTextRank(NULL)
, m_pTextClub(NULL)
...
void CClubWarRankingsDisplayGuildSlotSelf::CreateSubControl ()
{
...
void CClubWarRankingsDisplayGuildSlotSelf::ResetData()
{
...
HRESULT CClubWarRankingsDisplayGuildSlotSelf::Render(LPDIRECT3DDEVICEQ pd3dDevice)
{
...
void CClubWarRankingsDisplayGuildSlotSelf::SetData( int nRank, std::string strClub, DWORD dwClubID, WORD wKill, WORD wDeath , WORD wResu )
{
	ResetData();
