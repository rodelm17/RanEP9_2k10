...
*/
	...
	_snprintf( szTemp, 512, "{call sp_logitemexchange_insert(%d,%d,%d,%d,%d,%d,%I64d,%d,%d,%d,"
							...
							(short) sEXCHANGE.m_cOptTYPE1, sEXCHANGE.m_nOptVALUE1, (short) sEXCHANGE.m_cOptTYPE2, sEXCHANGE.m_nOptVALUE2,
							(short) sEXCHANGE.m_cOptTYPE3, sEXCHANGE.m_nOptVALUE3, (short) sEXCHANGE.m_cOptTYPE4, sEXCHANGE.m_nOptVALUE4 );
...
*/
	...
	_snprintf( szTemp, 256, "{call sp_logitemexchange_insert(%d,%d,%d,%d,%d,"
															...
															"%d,%d,%d,%d,%d,"
															"%d,%d,%d,%d,%d,"
															"%d,%d,%I64d,%d,%d,%d,%d,%d,%d,%d,%d,?)}",temp, temp, _sLOG.m_nSGNum,
											...
											temp, temp, _sLOG.m_lnPrice, temp, temp, temp, temp, temp, temp, temp, temp );
...
*/
	...
	_snprintf( szTemp, 256, "{call sp_logitemexchange_insert(%d,%d,%d,%d,%d,"
										...
										(short) _sLOG.m_cOptTYPE1, _sLOG.m_nOptVALUE1, (short) _sLOG.m_cOptTYPE2, _sLOG.m_nOptVALUE2,
										(short) _sLOG.m_cOptTYPE3, _sLOG.m_nOptVALUE3, (short) _sLOG.m_cOptTYPE4, _sLOG.m_nOptVALUE4 );
