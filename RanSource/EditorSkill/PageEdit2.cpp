...
void CPageEdit2::OnBnClickedButtonLevelAdd()
{
	LevelSave();
	m_nLevel ++;
	if ( m_nLevel >= SKILL::MAX_SKILL_LEVEL )
		m_nLevel --;
	LevelShow();
}
...
void CPageEdit2::InitSpec()
{
	...
	BOOL bUSEACTION  = ( emSPEC == EMSPECA_SKILL_DASH );
	...
	BOOL position_shift = ( emSPEC == EMSPECA_POSITION_SHIFT );
	SetWin_Enable( this, IDC_STATIC_POSITION_SHIFT, position_shift );
	SetWin_Enable( this, IDC_COMBO_POSITION_SHIFT_TYPE, position_shift );

	/*skill transform, Juver, 2018/09/07 */
	BOOL transform = ( emSPEC == EMSPECA_TRANSFORM );
	SetWin_Enable( this, IDC_CHECK_TRANSFORM_CHANGE_SKIN, transform );
	SetWin_Enable( this, IDC_CHECK_TRANSFORM_FORCE_ANIM, transform );

	/* skill turn/find invisible, Juver, 2020/04/28 */
	BOOL bTurnInvisible = ( emSPEC == EMSPECA_TURN_INVISIBLE );
	SetWin_Enable( this, IDC_STATIC_TURN_INVISIBLE, bTurnInvisible );
	SetWin_Enable( this, IDC_COMBO_TURN_INVISIBLE_ANIMATION_TYPE, bTurnInvisible );
	SetWin_Enable( this, IDC_CHECK_TURN_INVISIBLE_DISABLE_IN_COMBAT, bTurnInvisible );

	/* skill delay addition, Juver, 2020/12/08 */
	BOOL bSkillDelay = ( emSPEC == EMSPECA_SKILLDELAY );
	SetWin_Enable( this, IDC_CHECK_SKILL_DELAY_TYPE_A, bSkillDelay );
	SetWin_Enable( this, IDC_CHECK_SKILL_DELAY_TYPE_B, bSkillDelay );

	/* skill amplify, Juver, 2020/12/09 */
	BOOL bSkillAmplify = ( emSPEC == EMSPECA_AMPLIFY );
	SetWin_Enable( this, IDC_CHECK_SKILL_AMPLIFY_TYPE_A, bSkillAmplify );
	SetWin_Enable( this, IDC_CHECK_SKILL_AMPLIFY_TYPE_B, bSkillAmplify );
	SetWin_Enable( this, IDC_CHECK_SKILL_AMPLIFY_TYPE_C, bSkillAmplify );

	/* skill stigma, Juver, 2020/12/11 */
	BOOL bSkillStigma = ( emSPEC == EMSPECA_STIGMA );
	SetWin_Enable( this, IDC_CHECK_SKILL_STIGMA_TYPE_A, bSkillStigma );
	SetWin_Enable( this, IDC_CHECK_SKILL_STIGMA_TYPE_B, bSkillStigma );
	SetWin_Enable( this, IDC_CHECK_SKILL_STIGMA_TYPE_C, bSkillStigma );
	SetWin_Enable( this, IDC_CHECK_SKILL_STIGMA_TYPE_D, bSkillStigma );
	SetWin_Enable( this, IDC_CHECK_SKILL_STIGMA_TYPE_E, bSkillStigma );

	/* skill buff duration change, Juver, 2020/12/16 */
	BOOL bDurationChange = ( emSPEC == EMSPECA_DURATION_CHANGE );
	SetWin_Enable( this, IDC_CHECK_SKILL_DURATION_CHANGE_TYPE_A, bDurationChange );
	SetWin_Enable( this, IDC_CHECK_SKILL_DURATION_CHANGE_TYPE_B, bDurationChange );
	SetWin_Enable( this, IDC_CHECK_SKILL_DURATION_CHANGE_TYPE_C, bDurationChange );
	SetWin_Enable( this, IDC_CHECK_SKILL_DURATION_CHANGE_TYPE_D, bDurationChange );

	/* immune skill logic, Juver, 2020/12/24 */
	BOOL bImmune = ( emSPEC == EMSPECA_IMMUNE);
	SetWin_Enable( this, IDC_CHECK_SKILL_IMMUNE__VAR_1_TYPE_A, bImmune );
	SetWin_Enable( this, IDC_CHECK_SKILL_IMMUNE__VAR_1_TYPE_B, bImmune );
	SetWin_Enable( this, IDC_CHECK_SKILL_IMMUNE__VAR_1_TYPE_C, bImmune );

	SetWin_Enable( this, IDC_CHECK_SKILL_IMMUNE__VAR_2_TYPE_A, bImmune );
	SetWin_Enable( this, IDC_CHECK_SKILL_IMMUNE__VAR_2_TYPE_B, bImmune );
	SetWin_Enable( this, IDC_CHECK_SKILL_IMMUNE__VAR_2_TYPE_C, bImmune );
	SetWin_Enable( this, IDC_CHECK_SKILL_IMMUNE__VAR_2_TYPE_D, bImmune );
}
