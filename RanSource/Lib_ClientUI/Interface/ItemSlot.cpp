...
void CItemSlot::CreateSubControl ( int nMaxColumn, BOOL bNumberUse )
{
	...
	{
		"MODERN_ITEM_SLOT_BLOCK_X0",
		"MODERN_ITEM_SLOT_BLOCK_X1",
		"MODERN_ITEM_SLOT_BLOCK_X2",
		"MODERN_ITEM_SLOT_BLOCK_X3",
		"MODERN_ITEM_SLOT_BLOCK_X4",
		"MODERN_ITEM_SLOT_BLOCK_X5"
	};
	...
	case ITEM_IMAGE9:
		{
			if ( CHECK_MOUSE_IN ( dwMsg ) )
			{
				...
				if ( m_bBLOCK && m_pItemImageArray[m_nIndex]->GetItem () == NATIVEID_NULL () )
				{
					CInnerInterface::GetInstance().InfoDisplayShowCommonSingleLine( "Locked", NS_UITEXTCOLOR::DISABLE );
				}
