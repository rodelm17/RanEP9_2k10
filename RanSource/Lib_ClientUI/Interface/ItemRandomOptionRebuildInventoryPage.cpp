...
const INT CItemRandomOptionRebuildInventoryPage::nSTARTLINE = 0;	
const INT CItemRandomOptionRebuildInventoryPage::nOUTOFRANGE = -1;

CItemRandomOptionRebuildInventoryPage::CItemRandomOptionRebuildInventoryPage()
	: m_pScrollBar( NULL )
...
void CItemRandomOptionRebuildInventoryPage::CreateSubControl()
{
	CString strSlotKeyword[ nMAX_ONE_VIEW_SLOT ] =
	{
		"ITEM_RANDOM_OPTION_REBUILD_INVENSLOT_ITEM_SLOT0",
		"ITEM_RANDOM_OPTION_REBUILD_INVENSLOT_ITEM_SLOT1",
		"ITEM_RANDOM_OPTION_REBUILD_INVENSLOT_ITEM_SLOT2",
		"ITEM_RANDOM_OPTION_REBUILD_INVENSLOT_ITEM_SLOT3",
		"ITEM_RANDOM_OPTION_REBUILD_INVENSLOT_ITEM_SLOT4",
		"ITEM_RANDOM_OPTION_REBUILD_INVENSLOT_ITEM_SLOT5",
		"ITEM_RANDOM_OPTION_REBUILD_INVENSLOT_ITEM_SLOT6",
		"ITEM_RANDOM_OPTION_REBUILD_INVENSLOT_ITEM_SLOT7",
		"ITEM_RANDOM_OPTION_REBUILD_INVENSLOT_ITEM_SLOT8",
		"ITEM_RANDOM_OPTION_REBUILD_INVENSLOT_ITEM_SLOT9",
	};
...

	{
		...
		m_pScrollBar->CreateBaseScrollBar( "ITEM_RANDOM_OPTION_REBUILD_INVENTORY_PAGE_SCROLL" );
...
CItemSlotEx* CItemRandomOptionRebuildInventoryPage::CreateItemSlot( CString strKeyword, UIGUID ControlID )
{
...
CUIControl*	CItemRandomOptionRebuildInventoryPage::CreateControl( const TCHAR* szControl )
{
...
void CItemRandomOptionRebuildInventoryPage::Update( INT x, INT y, BYTE LB, BYTE MB, BYTE RB, INT nScroll, FLOAT fElapsedTime, BOOL bFirstControl )
{
...
void CItemRandomOptionRebuildInventoryPage::TranslateUIMessage( UIGUID ControlID, DWORD dwMsg )
{
...
void CItemRandomOptionRebuildInventoryPage::ResetAllItemSlotRender( INT nTotal )
{
	if( nTotal < 0 )
		return;
...
void CItemRandomOptionRebuildInventoryPage::SetItemSlotRender( INT nStartIndex, INT nTotal )
{
	if( nTotal < 0 )
		return;
...
void CItemRandomOptionRebuildInventoryPage::SetItemIndex( INT nPosX, INT nPosY )
{
	m_nPosX = nPosX;
	m_nPosY = nPosY;
}

void CItemRandomOptionRebuildInventoryPage::GetItemIndex( INT* pnPosX, INT* pnPosY )
{
	*pnPosX = m_nPosX;
	*pnPosY = m_nPosY;
}

void CItemRandomOptionRebuildInventoryPage::LoadItemPage( GLInventory &ItemData )
{
...
void CItemRandomOptionRebuildInventoryPage::LoadItem( SINVENITEM& ref_InvenItem )
{	
...
void CItemRandomOptionRebuildInventoryPage::UnLoadItemPage()
{
...
void CItemRandomOptionRebuildInventoryPage::UnLoadItem( INT nPosX, INT nPosY )
{
	m_pItemSlotArray[ nPosY ]->ResetItemImage( nPosX );
}

void CItemRandomOptionRebuildInventoryPage::ResetAllFlipItem()
{
	for( WORD y=0; y<EM_INVENSIZE_Y; ++y )
		for( WORD x=0; x<EM_INVENSIZE_X; ++x )
...
void CItemRandomOptionRebuildInventoryPage::UpdateFlipItem( GLInventory& ref_Inventory )
{
	ResetAllFlipItem();
...
void CItemRandomOptionRebuildInventoryPage::UpdateFlipItem( SINVEN_POS& ref_GarbageItem )
{
...
void CItemRandomOptionRebuildInventoryPage::UpdateBLOCK()
{
...
SINVENITEM& CItemRandomOptionRebuildInventoryPage::GetItem( INT nPosX, INT nPosY )
{
	return m_pItemSlotArray[ nPosY ]->GetItemImage( nPosX );
}

void CItemRandomOptionRebuildInventoryPage::SetOneViewSlot( const INT& nMAX_ONE_VIEW )
{
