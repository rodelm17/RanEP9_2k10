...
class CBasicTextBox;
class CClubWarRankingsDisplayResuSlot;
class CClubWarRankingsDisplayResuSlotSelf;

class CClubWarRankingsDisplayResu : public CUIGroup
{
	enum
	{
...
private:
	...
	CClubWarRankingsDisplayResuSlot*		m_pSlot[CLUBWAR_RANKING_NUM];
	CClubWarRankingsDisplayResuSlotSelf*	m_pSlotOwn;

	int		m_nStart;
	int		m_nTotal;

public:
	CClubWarRankingsDisplayResu();
	~CClubWarRankingsDisplayResu();
...
public:	
	void	RefreshClubWarRankingResu();
	void	ShowData();
};