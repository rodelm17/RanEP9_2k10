/*!
 * \file ModernExchangeItemInventoryPage.h
 *
 * \author Juver
 * \date 2022/04/27
 *
...
#ifndef MODERNEXCHANGEITEMINVENTORYPAGE_H_INCLUDED__
#define MODERNEXCHANGEITEMINVENTORYPAGE_H_INCLUDED__
...
class CModernExchangeItemInventoryPage : public CUIGroup	
{
private:
...
public:
	CModernExchangeItemInventoryPage();
	virtual	~CModernExchangeItemInventoryPage();
...
#endif // MODERNEXCHANGEITEMINVENTORYPAGE_H_INCLUDED__