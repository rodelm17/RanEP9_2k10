...
BOOL	DxAnimationMan::LoadFile_BETA ( CSerialFile &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	BOOL	bExist = FALSE;
	...
	{
		m_pDxFrameRoot = new DxFrame;
		m_pDxFrameRoot->LoadFile_BETA ( SFile, pd3dDevice, m_pEffectHead, m_pDxAlphaFrameHead );
	}
	...
	{
		m_pNext = new DxAnimationMan;
		m_pNext->LoadFile_BETA ( SFile, pd3dDevice );
	}
