...
struct EFFCHAR_PROPERTY_DOT3 : public EFFCHAR_PROPERTY
{
		...
		m_dwColorOP(D3DTOP_MODULATE)
	{
		...
		SecureZeroMemory( m_szDot3Tex_1, sizeof(char)*MAX_PATH );
		SecureZeroMemory( m_szDot3Tex_2, sizeof(char)*MAX_PATH );
		SecureZeroMemory( m_szDot3Tex_3, sizeof(char)*MAX_PATH );
