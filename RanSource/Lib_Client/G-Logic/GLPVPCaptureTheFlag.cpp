...
bool GLPVPCaptureTheFlag::Load( std::string strFile )
{
	...
	cFILE.getflag( "EVENT", "CONTRI_REQ", 0, 1, m_dwContributionReq );
	...
	cFILE.getflag( "EVENT", "DISABLE_OTHER_TEAM_RESU", 0, 1, m_bDisableOtherTeamResu );
...
BOOL GLPVPCaptureTheFlag::SetContributionPointMultiplier( float fMulti )
{
	m_fContributionPointMultiplier = fMulti;
	return TRUE;
}

float GLPVPCaptureTheFlag::GetContributionPointMultiplier()
{
