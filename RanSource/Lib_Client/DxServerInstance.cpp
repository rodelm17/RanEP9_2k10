...
#include "./G-Logic/GLAgentServer.h"
...
#include "./G-Logic/GLGuidance.h"
#include "./G-Logic/GLClubDeathMatch.h"
#include "../Lib_Engine/G-Logic/DxConsoleMsg.h"
#include "../Lib_Engine/G-Logic/DxMsgServer.h"
#include "./G-Logic/GLAutoLevelMan.h"
...
#include "./G-Logic/GLPVPTyrannyField.h"
#include "./G-Logic/GLPVPTyrannyAgent.h"

/*school wars, Juver, 2018/01/19 */
#include "./G-Logic/GLPVPSchoolWarsField.h"
#include "./G-Logic/GLPVPSchoolWarsAgent.h"

/*pvp capture the flag, Juver, 2018/01/24 */
#include "./G-Logic/GLPVPCaptureTheFlagField.h"
#include "./G-Logic/GLPVPCaptureTheFlagAgent.h"

/* pvp club death match, Juver, 2020/11/26 */
#include "./G-Logic/PVPClubDeathMatchField.h"
#include "./G-Logic/PVPClubDeathMatchAgent.h"

#include "./G-Logic/PVPPartyBattleGroundsAgent.h"
#include "./G-Logic/PVPPartyBattleGroundsField.h"

#include "./G-Logic/GMCommandPass.h"

#include "../Lib_Engine/Core/NSRParam.h"

/*woe Arc Development 08-06-2024*/
#include "../Lib_Client/G-Logic/GLPVPWoeField.h"
#include "../Lib_Client/G-Logic/GLPVPWoeAgent.h"
#ifdef _DEBUG
...
namespace DxFieldInstance
{
	HRESULT Create ( const char *_szAppPath, DxMsgServer *pMsgServer, DxConsoleMsg* pConsoleMsg, GLDBMan *pDBMan, int nServiceProvider, 
					 const char* szMapList, DWORD dwFieldSID, DWORD dwMaxClient, bool bPK_MODE, int nChannel, BOOL bPKLess, DWORD dwLangSet )
	{
		HRESULT hr = S_OK;
		...
		StringCchCat ( szFullPath, MAX_PATH, RPARAM::strServerText.GetString() );
		...
		/* pvp club death match, Juver, 2020/11/26 */
		PVPClubDeathMatchField::GetInstance().LoadEvent( GLCONST_CHAR::strClubDeathMatchFile );

		PVPPBG::ManagerField::GetInstance().LoadEvent( GLCONST_CHAR::strPVPPBGFile );

		/*woe Arc Development 08-06-2024*/
		GLPVPWoeField::GetInstance().LoadEvent(GLCONST_CHAR::strWoeFile);
		//	Note : pk 모드 설정.
		...
		CGMCommandPass::GetInstance().LoadFile();
	...
	HRESULT FrameMove ()
	{
		...
		/* pvp club death match, Juver, 2020/11/26 */
		PVPClubDeathMatchField::GetInstance().FrameMove ( fElapsedAppTime );

		PVPPBG::ManagerField::GetInstance().FrameMove ( fElapsedAppTime );

		/*woe Arc Development 08-06-2024*/
		GLPVPWoeField::GetInstance().FrameMove(fElapsedAppTime);
		//	Note : 가이아 갱신.
...
namespace DxAgentInstance
{
					 ...
					 DWORD dwLangSet )
	{
		...
		/* pvp club death match, Juver, 2020/11/26 */
		PVPClubDeathMatchAgent::GetInstance().LoadEvent( GLCONST_CHAR::strClubDeathMatchFile );

		PVPPBG::ManagerAgent::GetInstance().LoadEvent( GLCONST_CHAR::strPVPPBGFile );

		/*woe Arc Development 08-06-2024*/
		GLPVPWoeAgent::GetInstance().LoadEvent(GLCONST_CHAR::strWoeFile);
		// Note : 자동 레벨 설정 파일 로드
		//
	...
	HRESULT FrameMove()
	{
		...
		/*woe Arc Development 08-06-2024*/
		GLPVPWoeAgent::GetInstance().FrameMove(fElapsedAppTime);

		/* pvp club death match, Juver, 2020/11/26 */
		PVPClubDeathMatchAgent::GetInstance().FrameMove ( fElapsedAppTime );

		PVPPBG::ManagerAgent::GetInstance().FrameMove ( fElapsedAppTime );
