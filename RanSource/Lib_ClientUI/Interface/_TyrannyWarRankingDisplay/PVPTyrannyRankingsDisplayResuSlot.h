...
class CPVPTyrannyRankingsDisplayResuSlot : public CUIGroup
{
private:
	enum
	{
...
public:
	CPVPTyrannyRankingsDisplayResuSlot ();
	virtual	~CPVPTyrannyRankingsDisplayResuSlot ();
...
private:
	STYRANNY_RANK_RESU	m_sTyrannyRank;
...
public:
	void	ResetData();
	void	SetData( STYRANNY_RANK_RESU sTyrannyRank, int nRank, std::string strName, DWORD dwCharID, int nChaClass,
