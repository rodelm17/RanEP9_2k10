...
class CPVPTyrannyRankingsDisplayResuSlotSelf : public CUIGroup
{
private:
	enum
	{
...
public:
	CPVPTyrannyRankingsDisplayResuSlotSelf ();
	virtual	~CPVPTyrannyRankingsDisplayResuSlotSelf ();
...
public:
	void	ResetData();
	void	SetData( int nRank, std::string strName, DWORD dwCharID, int nChaClass,
		WORD wKill, WORD wDeath, WORD wResuNum, WORD wSchool );
