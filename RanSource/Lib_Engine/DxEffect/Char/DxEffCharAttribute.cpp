...
char		DxEffCharAttribute::NAME[MAX_PATH]	= "DxEffCharAttribute";
...
HRESULT	DxEffCharAttribute::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharAttribute::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT	DxEffCharAttribute::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharAttribute::R2LoadFile", SFile.GetFileName(), dwVer );
