...
CPVPTyrannyRankingsDisplaySlot::CPVPTyrannyRankingsDisplaySlot ()
: m_pTextRank(NULL)
, m_pTextName(NULL)
...
void CPVPTyrannyRankingsDisplaySlot::CreateSubControl ()
{
...
void CPVPTyrannyRankingsDisplaySlot::ResetData()
{
	m_sTyrannyRank	= STYRANNY_RANK();
...
HRESULT CPVPTyrannyRankingsDisplaySlot::Render(LPDIRECT3DDEVICEQ pd3dDevice)
{
...
void CPVPTyrannyRankingsDisplaySlot::SetData( STYRANNY_RANK sTyrannyRank, int nRank, std::string strName, DWORD dwCharID, int nClass,
