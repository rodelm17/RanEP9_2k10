...
char		DxEffCharDot3::NAME[MAX_PATH]	= "DxEffCharDot3";
...
HRESULT	DxEffCharDot3::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharDot3::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT	DxEffCharDot3::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharDot3::R2LoadFile", SFile.GetFileName(), dwVer );
