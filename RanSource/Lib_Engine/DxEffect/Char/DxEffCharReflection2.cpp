...
DWORD		DxEffCharReflection2::VERSION			= 0x0105;
char		DxEffCharReflection2::NAME[MAX_PATH]	= "DxEffCharReflection2";
...
HRESULT	DxEffCharReflection2::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	else if ( dwVer == 0x0104 )
	{
		//	Note : 이팩트의 Property 를 저장.
		//
		EFFCHAR_PROPERTY_REFLECTION2_102	sProp;
		SFile.ReadBuffer ( &sProp, sizeof(EFFCHAR_PROPERTY_REFLECTION2_102) );
	...
	{
		EFFCHAR_PROPERTY_REFLECTION2_101	sProp;

		//	Note : 이팩트의 Property 를 저장.
		//
		SFile.ReadBuffer ( &sProp, sizeof(EFFCHAR_PROPERTY_REFLECTION2_101) );
	...
	{
		EFFCHAR_PROPERTY_REFLECTION2_100	sProp;

		//	Note : 이팩트의 Property 를 저장.
		//
		SFile.ReadBuffer ( &sProp, sizeof(EFFCHAR_PROPERTY_REFLECTION2_100) );
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharReflection2::LoadFile", SFile.GetFileName(), dwVer );
...
HRESULT	DxEffCharReflection2::R2LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
	...
	{
		CDebugSet::ErrorVersion( "DxEffCharReflection2::R2LoadFile", SFile.GetFileName(), dwVer );
