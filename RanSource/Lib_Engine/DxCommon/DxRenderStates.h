...
protected:
	...
	LPDIRECT3DSTATEBLOCK9 m_pSavedLightMapSB;
	LPDIRECT3DSTATEBLOCK9 m_pDrawLightMapSB;

	LPDIRECT3DSTATEBLOCK9 m_pSavedBlendRenderSB;
	LPDIRECT3DSTATEBLOCK9 m_pDrawBlendRenderSB;
...
public:
	...
	void SetLightMapSB ( LPDIRECT3DDEVICEQ pd3dDevice );
	void ReSetLightMapSB ( LPDIRECT3DDEVICEQ pd3dDevice );

	void SetBlendRenderSB ( LPDIRECT3DDEVICEQ pd3dDevice );
	void ReSetBlendRenderSB ( LPDIRECT3DDEVICEQ pd3dDevice );
