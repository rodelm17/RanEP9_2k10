...
#ifndef __RIJNDAEL_GS_H__
#define __RIJNDAEL_GS_H__
...
#define GS_RANSEDIT_VERSION 0x0005

class CRijndaelGS : public IMethod
{
public:
	//Key Lengths
	...
	enum { VERSION = GS_RANSEDIT_VERSION, VERSION_DATE = 20171011 };
