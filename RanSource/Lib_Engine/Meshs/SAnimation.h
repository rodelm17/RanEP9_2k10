...
public:
	...
	{ 
		...
		ENCODE_VER_BYTE_CRYPT_2021_ANI_BIN_V1	= 0x0201,
...
public:
	...
	HRESULT  Load_0201( CSerialFile &SFile );
	...
	static HRESULT  Load_0201( CSerialFile &SFile, const DxSkeleton* pSkeleton, SANILIST &listANI, SANILIST &listANIUPBODY );
