...
public:
	...
	void	Load_100 ( CSerialFile	&SFile, LPDIRECT3DDEVICEQ pd3dDevice=NULL );

	BOOL	Load_File ( const TCHAR* path_name, LPDIRECT3DDEVICEQ pd3dDevice=NULL );
	BOOL	Save_File ( const TCHAR* path_name );
...
public:
	...
	HRESULT	CopyNaviToShadow ( LPDIRECT3DDEVICEQ pd3dDevice, SCOPYMESHDATA& copy_mesh_data );
};
